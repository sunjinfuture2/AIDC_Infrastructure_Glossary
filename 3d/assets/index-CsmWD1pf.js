 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(I,se){var re=I.length;I.push(se);e:for(;0<re;){var ve=re-1>>>1,Fe=I[ve];if(0<r(Fe,se))I[ve]=se,I[re]=Fe,re=ve;else break e}}function n(I){return I.length===0?null:I[0]}function i(I){if(I.length===0)return null;var se=I[0],re=I.pop();if(re!==se){I[0]=re;e:for(var ve=0,Fe=I.length,Qe=Fe>>>1;ve<Qe;){var te=2*(ve+1)-1,he=I[te],Te=te+1,we=I[Te];if(0>r(he,re))Te<Fe&&0>r(we,he)?(I[ve]=we,I[Te]=re,ve=Te):(I[ve]=he,I[te]=re,ve=te);else if(Te<Fe&&0>r(we,re))I[ve]=we,I[Te]=re,ve=Te;else break e}}return se}function r(I,se){var re=I.sortIndex-se.sortIndex;return re!==0?re:I.id-se.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],c=[],f=1,d=null,h=3,p=!1,_=!1,x=!1,m=typeof setTimeout=="function"?setTimeout:null,u=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(I){for(var se=n(c);se!==null;){if(se.callback===null)i(c);else if(se.startTime<=I)i(c),se.sortIndex=se.expirationTime,e(l,se);else break;se=n(c)}}function M(I){if(x=!1,v(I),!_)if(n(l)!==null)_=!0,K(P);else{var se=n(c);se!==null&&ce(M,se.startTime-I)}}function P(I,se){_=!1,x&&(x=!1,u(b),b=-1),p=!0;var re=h;try{for(v(se),d=n(l);d!==null&&(!(d.expirationTime>se)||I&&!w());){var ve=d.callback;if(typeof ve=="function"){d.callback=null,h=d.priorityLevel;var Fe=ve(d.expirationTime<=se);se=t.unstable_now(),typeof Fe=="function"?d.callback=Fe:d===n(l)&&i(l),v(se)}else i(l);d=n(l)}if(d!==null)var Qe=!0;else{var te=n(c);te!==null&&ce(M,te.startTime-se),Qe=!1}return Qe}finally{d=null,h=re,p=!1}}var R=!1,A=null,b=-1,Q=5,y=-1;function w(){return!(t.unstable_now()-y<Q)}function X(){if(A!==null){var I=t.unstable_now();y=I;var se=!0;try{se=A(!0,I)}finally{se?Y():(R=!1,A=null)}}else R=!1}var Y;if(typeof g=="function")Y=function(){g(X)};else if(typeof MessageChannel<"u"){var ee=new MessageChannel,oe=ee.port2;ee.port1.onmessage=X,Y=function(){oe.postMessage(null)}}else Y=function(){m(X,0)};function K(I){A=I,R||(R=!0,Y())}function ce(I,se){b=m(function(){I(t.unstable_now())},se)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(I){I.callback=null},t.unstable_continueExecution=function(){_||p||(_=!0,K(P))},t.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Q=0<I?Math.floor(1e3/I):5},t.unstable_getCurrentPriorityLevel=function(){return h},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(I){switch(h){case 1:case 2:case 3:var se=3;break;default:se=h}var re=h;h=se;try{return I()}finally{h=re}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(I,se){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var re=h;h=I;try{return se()}finally{h=re}},t.unstable_scheduleCallback=function(I,se,re){var ve=t.unstable_now();switch(typeof re=="object"&&re!==null?(re=re.delay,re=typeof re=="number"&&0<re?ve+re:ve):re=ve,I){case 1:var Fe=-1;break;case 2:Fe=250;break;case 5:Fe=1073741823;break;case 4:Fe=1e4;break;default:Fe=5e3}return Fe=re+Fe,I={id:f++,callback:se,priorityLevel:I,startTime:re,expirationTime:Fe,sortIndex:-1},re>ve?(I.sortIndex=re,e(c,I),n(l)===null&&I===n(c)&&(x?(u(b),b=-1):x=!0,ce(M,re-ve))):(I.sortIndex=Fe,e(l,I),_||p||(_=!0,K(P))),I},t.unstable_shouldYield=w,t.unstable_wrapCallback=function(I){var se=h;return function(){var re=h;h=se;try{return I.apply(this,arguments)}finally{h=re}}}})(rg);ig.exports=rg;var av=ig.exports;/**
 * @license React
...
`)+`
`+u);const v=g+m+o,M=g+u+a,P=wm(r,r.VERTEX_SHADER,v),R=wm(r,r.FRAGMENT_SHADER,M);r.attachShader(x,P),r.attachShader(x,R),n.index0AttributeName!==void 0?r.bindAttribLocation(x,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function A(w){if(t.debug.checkShaderErrors){const X=r.getProgramInfoLog(x).trim(),Y=r.getShaderInfoLog(P).trim(),ee=r.getShaderInfoLog(R).trim();let oe=!0,K=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(oe=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,x,P,R);else{const ce=Tm(r,P,"vertex"),I=Tm(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
...
Program Info Log: `+X+`
`+ce+`
`+I)}else X!==""?console.warn("THREE.WebGLProgram: Program Info Log:",X):(Y===""||ee==="")&&(K=!1);K&&(w.diagnostics={runnable:oe,programLog:X,vertexShader:{log:Y,prefix:m},fragmentShader:{log:ee,prefix:u}})}r.deleteShader(P),r.deleteShader(R),b=new Pl(r,x),Q=Uw(r,x)}let b;this.getUniforms=function(){return b===void 0&&A(this),b};let Q;this.getAttributes=function(){return Q===void 0&&A(this),Q};let y=n.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return y===!1&&(y=r.getProgramParameter(x,ww)),y},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(x),this.program=void 0},this.type=n.shaderType,this.name=n.shaderName,this.id=Tw++,this.cacheKey=e,this.usedTimes=1,this.program=x,this.vertexShader=P,this.fragmentShader=R,this}let Xw=0;class jw{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const n=e.vertexShader,i=e.fragmentShader,r=this._getShaderStage(n),s=this._getShaderStage(i),o=this._getShaderCacheForMaterial(e);return o.has(r)===!1&&(o.add(r),r.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){const n=this.materialCache.get(e);for(const i of n)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const n=this.materialCache;let i=n.get(e);return i===void 0&&(i=new Set,n.set(e,i)),i}_getShaderStage(e){const n=this.shaderCache;let i=n.get(e);return i===void 0&&(i=new Yw(e),n.set(e,i)),i}}class Yw{constructor(e){this.id=Xw++,this.code=e,this.usedTimes=0}}function qw(t,e,n,i,r,s,o){const a=new Eh,l=new jw,c=new Set,f=[],d=r.logarithmicDepthBuffer,h=r.reverseDepthBuffer,p=r.vertexTextures;let _=r.precision;const x={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function m(y){return c.add(y),y===0?"uv":`uv${y}`}function u(y,w,X,Y,ee){const oe=Y.fog,K=ee.geometry,ce=y.isMeshStandardMaterial?Y.environment:null,I=(y.isMeshStandardMaterial?n:e).get(y.envMap||ce),se=I&&I.mapping===Ec?I.image.height:null,re=x[y.type];y.precision!==null&&(_=r.getMaxPrecision(y.precision),_!==y.precision&&console.warn("THREE.WebGLProgram.getParameters:",y.precision,"not supported, using",_,"instead."));const ve=K.morphAttributes.position||K.morphAttributes.normal||K.morphAttributes.color,Fe=ve!==void 0?ve.length:0;let Qe=0;K.morphAttributes.position!==void 0&&(Qe=1),K.morphAttributes.normal!==void 0&&(Qe=2),K.morphAttributes.color!==void 0&&(Qe=3);let te,he,Te,we;if(re){const Rt=gi[re];te=Rt.vertexShader,he=Rt.fragmentShader}else te=y.vertexShader,he=y.fragmentShader,l.update(y),Te=l.getVertexShaderID(y),we=l.getFragmentShaderID(y);const Xe=t.getRenderTarget(),Oe=ee.isInstancedMesh===!0,ot=ee.isBatchedMesh===!0,ct=!!y.map,tt=!!y.matcap,U=!!I,zt=!!y.aoMap,qe=!!y.lightMap,nt=!!y.bumpMap,Be=!!y.normalMap,ut=!!y.displacementMap,Ge=!!y.emissiveMap,C=!!y.metalnessMap,S=!!y.roughnessMap,G=y.anisotropy>0,ie=y.clearcoat>0,fe=y.dispersion>0,ne=y.iridescence>0,Ue=y.sheen>0,ye=y.transmission>0,Ae=G&&!!y.anisotropyMap,it=ie&&!!y.clearcoatMap,_e=ie&&!!y.clearcoatNormalMap,Ce=ie&&!!y.clearcoatRoughnessMap,He=ne&&!!y.iridescenceMap,Ve=ne&&!!y.iridescenceThicknessMap,D=Ue&&!!y.sheenColorMap,z=Ue&&!!y.sheenRoughnessMap,H=!!y.specularMap,j=!!y.specularColorMap,T=!!y.specularIntensityMap,N=ye&&!!y.transmissionMap,L=ye&&!!y.thicknessMap,V=!!y.gradientMap,ae=!!y.alphaMap,xe=y.alphaTest>0,ke=!!y.alphaHash,at=!!y.extensions;let gt=Mr;y.toneMapped&&(Xe===null||Xe.isXRRenderTarget===!0)&&(gt=t.toneMapping);const $e={shaderID:re,shaderType:y.type,shaderName:y.name,vertexShader:te,fragmentShader:he,defines:y.defines,customVertexShaderID:Te,customFragmentShaderID:we,isRawShaderMaterial:y.isRawShaderMaterial===!0,glslVersion:y.glslVersion,precision:_,batching:ot,batchingColor:ot&&ee._colorsTexture!==null,instancing:Oe,instancingColor:Oe&&ee.instanceColor!==null,instancingMorph:Oe&&ee.morphTexture!==null,supportsVertexTextures:p,outputColorSpace:Xe===null?t.outputColorSpace:Xe.isXRRenderTarget===!0?Xe.texture.colorSpace:br,alphaToCoverage:!!y.alphaToCoverage,map:ct,matcap:tt,envMap:U,envMapMode:U&&I.mapping,envMapCubeUVHeight:se,aoMap:zt,lightMap:qe,bumpMap:nt,normalMap:Be,displacementMap:p&&ut,emissiveMap:Ge,normalMapObjectSpace:Be&&y.normalMapType===tS,normalMapTangentSpace:Be&&y.normalMapType===m_,metalnessMap:C,roughnessMap:S,anisotropy:G,anisotropyMap:Ae,clearcoat:ie,clearcoatMap:it,clearcoatNormalMap:_e,clearcoatRoughnessMap:Ce,dispersion:fe,iridescence:ne,iridescenceMap:He,iridescenceThicknessMap:Ve,sheen:Ue,sheenColorMap:D,sheenRoughnessMap:z,specularMap:H,specularColorMap:j,specularIntensityMap:T,transmission:ye,transmissionMap:N,thicknessMap:L,gradientMap:V,opaque:y.transparent===!1&&y.blending===Gs&&y.alphaToCoverage===!1,alphaMap:ae,alphaTest:xe,alphaHash:ke,combine:y.combine,mapUv:ct&&m(y.map.channel),aoMapUv:zt&&m(y.aoMap.channel),lightMapUv:qe&&m(y.lightMap.channel),bumpMapUv:nt&&m(y.bumpMap.channel),normalMapUv:Be&&m(y.normalMap.channel),displacementMapUv:ut&&m(y.displacementMap.channel),emissiveMapUv:Ge&&m(y.emissiveMap.channel),metalnessMapUv:C&&m(y.metalnessMap.channel),roughnessMapUv:S&&m(y.roughnessMap.channel),anisotropyMapUv:Ae&&m(y.anisotropyMap.channel),clearcoatMapUv:it&&m(y.clearcoatMap.channel),clearcoatNormalMapUv:_e&&m(y.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Ce&&m(y.clearcoatRoughnessMap.channel),iridescenceMapUv:He&&m(y.iridescenceMap.channel),iridescenceThicknessMapUv:Ve&&m(y.iridescenceThicknessMap.channel),sheenColorMapUv:D&&m(y.sheenColorMap.channel),sheenRoughnessMapUv:z&&m(y.sheenRoughnessMap.channel),specularMapUv:H&&m(y.specularMap.channel),specularColorMapUv:j&&m(y.specularColorMap.channel),specularIntensityMapUv:T&&m(y.specularIntensityMap.channel),transmissionMapUv:N&&m(y.transmissionMap.channel),thicknessMapUv:L&&m(y.thicknessMap.channel),alphaMapUv:ae&&m(y.alphaMap.channel),vertexTangents:!!K.attributes.tangent&&(Be||G),vertexColors:y.vertexColors,vertexAlphas:y.vertexColors===!0&&!!K.attributes.color&&K.attributes.color.itemSize===4,pointsUvs:ee.isPoints===!0&&!!K.attributes.uv&&(ct||ae),fog:!!oe,useFog:y.fog===!0,fogExp2:!!oe&&oe.isFogExp2,flatShading:y.flatShading===!0,sizeAttenuation:y.sizeAttenuation===!0,logarithmicDepthBuffer:d,reverseDepthBuffer:h,skinning:ee.isSkinnedMesh===!0,morphTargets:K.morphAttributes.position!==void 0,morphNormals:K.morphAttributes.normal!==void 0,morphColors:K.morphAttributes.color!==void 0,morphTargetsCount:Fe,morphTextureStride:Qe,numDirLights:w.directional.length,numPointLights:w.point.length,numSpotLights:w.spot.length,numSpotLightMaps:w.spotLightMap.length,numRectAreaLights:w.rectArea.length,numHemiLights:w.hemi.length,numDirLightShadows:w.directionalShadowMap.length,numPointLightShadows:w.pointShadowMap.length,numSpotLightShadows:w.spotShadowMap.length,numSpotLightShadowsWithMaps:w.numSpotLightShadowsWithMaps,numLightProbes:w.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:y.dithering,shadowMapEnabled:t.shadowMap.enabled&&X.length>0,shadowMapType:t.shadowMap.type,toneMapping:gt,decodeVideoTexture:ct&&y.map.isVideoTexture===!0&&ht.getTransfer(y.map.colorSpace)===Et,premultipliedAlpha:y.premultipliedAlpha,doubleSided:y.side===ri,flipSided:y.side===Tn,useDepthPacking:y.depthPacking>=0,depthPacking:y.depthPacking||0,index0AttributeName:y.index0AttributeName,extensionClipCullDistance:at&&y.extensions.clipCullDistance===!0&&i.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(at&&y.extensions.multiDraw===!0||ot)&&i.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:i.has("KHR_parallel_shader_compile"),customProgramCacheKey:y.customProgramCacheKey()};return $e.vertexUv1s=c.has(1),$e.vertexUv2s=c.has(2),$e.vertexUv3s=c.has(3),c.clear(),$e}function g(y){const w=[];if(y.shaderID?w.push(y.shaderID):(w.push(y.customVertexShaderID),w.push(y.customFragmentShaderID)),y.defines!==void 0)for(const X in y.defines)w.push(X),w.push(y.defines[X]);return y.isRawShaderMaterial===!1&&(v(w,y),M(w,y),w.push(t.outputColorSpace)),w.push(y.customProgramCacheKey),w.join()}function v(y,w){y.push(w.precision),y.push(w.outputColorSpace),y.push(w.envMapMode),y.push(w.envMapCubeUVHeight),y.push(w.mapUv),y.push(w.alphaMapUv),y.push(w.lightMapUv),y.push(w.aoMapUv),y.push(w.bumpMapUv),y.push(w.normalMapUv),y.push(w.displacementMapUv),y.push(w.emissiveMapUv),y.push(w.metalnessMapUv),y.push(w.roughnessMapUv),y.push(w.anisotropyMapUv),y.push(w.clearcoatMapUv),y.push(w.clearcoatNormalMapUv),y.push(w.clearcoatRoughnessMapUv),y.push(w.iridescenceMapUv),y.push(w.iridescenceThicknessMapUv),y.push(w.sheenColorMapUv),y.push(w.sheenRoughnessMapUv),y.push(w.specularMapUv),y.push(w.specularColorMapUv),y.push(w.specularIntensityMapUv),y.push(w.transmissionMapUv),y.push(w.thicknessMapUv),y.push(w.combine),y.push(w.fogExp2),y.push(w.sizeAttenuation),y.push(w.morphTargetsCount),y.push(w.morphAttributeCount),y.push(w.numDirLights),y.push(w.numPointLights),y.push(w.numSpotLights),y.push(w.numSpotLightMaps),y.push(w.numHemiLights),y.push(w.numRectAreaLights),y.push(w.numDirLightShadows),y.push(w.numPointLightShadows),y.push(w.numSpotLightShadows),y.push(w.numSpotLightShadowsWithMaps),y.push(w.numLightProbes),y.push(w.shadowMapType),y.push(w.toneMapping),y.push(w.numClippingPlanes),y.push(w.numClipIntersection),y.push(w.depthPacking)}function M(y,w){a.disableAll(),w.supportsVertexTextures&&a.enable(0),w.instancing&&a.enable(1),w.instancingColor&&a.enable(2),w.instancingMorph&&a.enable(3),w.matcap&&a.enable(4),w.envMap&&a.enable(5),w.normalMapObjectSpace&&a.enable(6),w.normalMapTangentSpace&&a.enable(7),w.clearcoat&&a.enable(8),w.iridescence&&a.enable(9),w.alphaTest&&a.enable(10),w.vertexColors&&a.enable(11),w.vertexAlphas&&a.enable(12),w.vertexUv1s&&a.enable(13),w.vertexUv2s&&a.enable(14),w.vertexUv3s&&a.enable(15),w.vertexTangents&&a.enable(16),w.anisotropy&&a.enable(17),w.alphaHash&&a.enable(18),w.batching&&a.enable(19),w.dispersion&&a.enable(20),w.batchingColor&&a.enable(21),y.push(a.mask),a.disableAll(),w.fog&&a.enable(0),w.useFog&&a.enable(1),w.flatShading&&a.enable(2),w.logarithmicDepthBuffer&&a.enable(3),w.reverseDepthBuffer&&a.enable(4),w.skinning&&a.enable(5),w.morphTargets&&a.enable(6),w.morphNormals&&a.enable(7),w.morphColors&&a.enable(8),w.premultipliedAlpha&&a.enable(9),w.shadowMapEnabled&&a.enable(10),w.doubleSided&&a.enable(11),w.flipSided&&a.enable(12),w.useDepthPacking&&a.enable(13),w.dithering&&a.enable(14),w.transmission&&a.enable(15),w.sheen&&a.enable(16),w.opaque&&a.enable(17),w.pointsUvs&&a.enable(18),w.decodeVideoTexture&&a.enable(19),w.alphaToCoverage&&a.enable(20),y.push(a.mask)}function P(y){const w=x[y.type];let X;if(w){const Y=gi[w];X=DS.clone(Y.uniforms)}else X=y.uniforms;return X}function R(y,w){let X;for(let Y=0,ee=f.length;Y<ee;Y++){const oe=f[Y];if(oe.cacheKey===w){X=oe,++X.usedTimes;break}}return X===void 0&&(X=new Ww(t,w,y,s),f.push(X)),X}function A(y){if(--y.usedTimes===0){const w=f.indexOf(y);f[w]=f[f.length-1],f.pop(),y.destroy()}}function b(y){l.remove(y)}function Q(){l.dispose()}return{getParameters:u,getProgramCacheKey:g,getUniforms:P,acquireProgram:R,releaseProgram:A,releaseShaderCache:b,programs:f,dispose:Q}}function $w(){let t=new WeakMap;function e(o){return t.has(o)}function n(o){let a=t.get(o);return a===void 0&&(a={},t.set(o,a)),a}function i(o){t.delete(o)}function r(o,a,l){t.get(o)[a]=l}function s(){t=new WeakMap}return{has:e,get:n,remove:i,update:r,dispose:s}}function Kw(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.material.id!==e.material.id?t.material.id-e.material.id:t.z!==e.z?t.z-e.z:t.id-e.id}function bm(t,e){return t.groupOrder!==e.groupOrder?t.groupOrder-e.groupOrder:t.renderOrder!==e.renderOrder?t.renderOrder-e.renderOrder:t.z!==e.z?e.z-t.z:t.id-e.id}function Dm(){const t=[];let e=0;const n=[],i=[],r=[];function s(){e=0,n.length=0,i.length=0,r.length=0}function o(d,h,p,_,x,m){let u=t[e];return u===void 0?(u={id:d.id,object:d,geometry:h,material:p,groupOrder:_,renderOrder:d.renderOrder,z:x,group:m},t[e]=u):(u.id=d.id,u.object=d,u.geometry=h,u.material=p,u.groupOrder=_,u.renderOrder=d.renderOrder,u.z=x,u.group=m),e++,u}function a(d,h,p,_,x,m){const u=o(d,h,p,_,x,m);p.transmission>0?i.push(u):p.transparent===!0?r.push(u):n.push(u)}function l(d,h,p,_,x,m){const u=o(d,h,p,_,x,m);p.transmission>0?i.unshift(u):p.transparent===!0?r.unshift(u):n.unshift(u)}function c(d,h){n.length>1&&n.sort(d||Kw),i.length>1&&i.sort(h||bm),r.length>1&&r.sort(h||bm)}function f(){for(let d=e,h=t.length;d<h;d++){const p=t[d];if(p.id===null)break;p.id=null,p.object=null,p.geometry=null,p.material=null,p.group=null}}return{opaque:n,transmissive:i,transparent:r,init:s,push:a,unshift:l,finish:f,sort:c}}function Zw(){let t=new WeakMap;function e(i,r){const s=t.get(i);let o;return s===void 0?(o=new Dm,t.set(i,[o])):r>=s.length?(o=new Dm,s.push(o)):o=s[r],o}function n(){t=new WeakMap}return{get:e,dispose:n}}function Qw(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={direction:new k,color:new ze};break;case"SpotLight":n={position:new k,direction:new k,color:new ze,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":n={position:new k,color:new ze,distance:0,decay:0};break;case"HemisphereLight":n={direction:new k,skyColor:new ze,groundColor:new ze};break;case"RectAreaLight":n={color:new ze,position:new k,halfWidth:new k,halfHeight:new k};break}return t[e.id]=n,n}}}function Jw(){const t={};return{get:function(e){if(t[e.id]!==void 0)return t[e.id];let n;switch(e.type){case"DirectionalLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ft};break;case"SpotLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ft};break;case"PointLight":n={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new ft,shadowCameraNear:1,shadowCameraFar:1e3};break}return t[e.id]=n,n}}}let eT=0;function tT(t,e){return(e.castShadow?2:0)-(t.castShadow?2:0)+(e.map?1:0)-(t.map?1:0)}function nT(t){const e=new Qw,n=Jw(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)i.probe.push(new k);const r=new k,s=new Ct,o=new Ct;function a(c){let f=0,d=0,h=0;for(let Q=0;Q<9;Q++)i.probe[Q].set(0,0,0);let p=0,_=0,x=0,m=0,u=0,g=0,v=0,M=0,P=0,R=0,A=0;c.sort(tT);for(let Q=0,y=c.length;Q<y;Q++){const w=c[Q],X=w.color,Y=w.intensity,ee=w.distance,oe=w.shadow&&w.shadow.map?w.shadow.map.texture:null;if(w.isAmbientLight)f+=X.r*Y,d+=X.g*Y,h+=X.b*Y;else if(w.isLightProbe){for(let K=0;K<9;K++)i.probe[K].addScaledVector(w.sh.coefficients[K],Y);A++}else if(w.isDirectionalLight){const K=e.get(w);if(K.color.copy(w.color).multiplyScalar(w.intensity),w.castShadow){const ce=w.shadow,I=n.get(w);I.shadowIntensity=ce.intensity,I.shadowBias=ce.bias,I.shadowNormalBias=ce.normalBias,I.shadowRadius=ce.radius,I.shadowMapSize=ce.mapSize,i.directionalShadow[p]=I,i.directionalShadowMap[p]=oe,i.directionalShadowMatrix[p]=w.shadow.matrix,g++}i.directional[p]=K,p++}else if(w.isSpotLight){const K=e.get(w);K.position.setFromMatrixPosition(w.matrixWorld),K.color.copy(X).multiplyScalar(Y),K.distance=ee,K.coneCos=Math.cos(w.angle),K.penumbraCos=Math.cos(w.angle*(1-w.penumbra)),K.decay=w.decay,i.spot[x]=K;const ce=w.shadow;if(w.map&&(i.spotLightMap[P]=w.map,P++,ce.updateMatrices(w),w.castShadow&&R++),i.spotLightMatrix[x]=ce.matrix,w.castShadow){const I=n.get(w);I.shadowIntensity=ce.intensity,I.shadowBias=ce.bias,I.shadowNormalBias=ce.normalBias,I.shadowRadius=ce.radius,I.shadowMapSize=ce.mapSize,i.spotShadow[x]=I,i.spotShadowMap[x]=oe,M++}x++}else if(w.isRectAreaLight){const K=e.get(w);K.color.copy(X).multiplyScalar(Y),K.halfWidth.set(w.width*.5,0,0),K.halfHeight.set(0,w.height*.5,0),i.rectArea[m]=K,m++}else if(w.isPointLight){const K=e.get(w);if(K.color.copy(w.color).multiplyScalar(w.intensity),K.distance=w.distance,K.decay=w.decay,w.castShadow){const ce=w.shadow,I=n.get(w);I.shadowIntensity=ce.intensity,I.shadowBias=ce.bias,I.shadowNormalBias=ce.normalBias,I.shadowRadius=ce.radius,I.shadowMapSize=ce.mapSize,I.shadowCameraNear=ce.camera.near,I.shadowCameraFar=ce.camera.far,i.pointShadow[_]=I,i.pointShadowMap[_]=oe,i.pointShadowMatrix[_]=w.shadow.matrix,v++}i.point[_]=K,_++}else if(w.isHemisphereLight){const K=e.get(w);K.skyColor.copy(w.color).multiplyScalar(Y),K.groundColor.copy(w.groundColor).multiplyScalar(Y),i.hemi[u]=K,u++}}m>0&&(t.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=Se.LTC_FLOAT_1,i.rectAreaLTC2=Se.LTC_FLOAT_2):(i.rectAreaLTC1=Se.LTC_HALF_1,i.rectAreaLTC2=Se.LTC_HALF_2)),i.ambient[0]=f,i.ambient[1]=d,i.ambient[2]=h;const b=i.hash;(b.directionalLength!==p||b.pointLength!==_||b.spotLength!==x||b.rectAreaLength!==m||b.hemiLength!==u||b.numDirectionalShadows!==g||b.numPointShadows!==v||b.numSpotShadows!==M||b.numSpotMaps!==P||b.numLightProbes!==A)&&(i.directional.length=p,i.spot.length=x,i.rectArea.length=m,i.point.length=_,i.hemi.length=u,i.directionalShadow.length=g,i.directionalShadowMap.length=g,i.pointShadow.length=v,i.pointShadowMap.length=v,i.spotShadow.length=M,i.spotShadowMap.length=M,i.directionalShadowMatrix.length=g,i.pointShadowMatrix.length=v,i.spotLightMatrix.length=M+P-R,i.spotLightMap.length=P,i.numSpotLightShadowsWithMaps=R,i.numLightProbes=A,b.directionalLength=p,b.pointLength=_,b.spotLength=x,b.rectAreaLength=m,b.hemiLength=u,b.numDirectionalShadows=g,b.numPointShadows=v,b.numSpotShadows=M,b.numSpotMaps=P,b.numLightProbes=A,i.version=eT++)}function l(c,f){let d=0,h=0,p=0,_=0,x=0;const m=f.matrixWorldInverse;for(let u=0,g=c.length;u<g;u++){const v=c[u];if(v.isDirectionalLight){const M=i.directional[d];M.direction.setFromMatrixPosition(v.matrixWorld),r.setFromMatrixPosition(v.target.matrixWorld),M.direction.sub(r),M.direction.transformDirection(m),d++}else if(v.isSpotLight){const M=i.spot[p];M.position.setFromMatrixPosition(v.matrixWorld),M.position.applyMatrix4(m),M.direction.setFromMatrixPosition(v.matrixWorld),r.setFromMatrixPosition(v.target.matrixWorld),M.direction.sub(r),M.direction.transformDirection(m),p++}else if(v.isRectAreaLight){const M=i.rectArea[_];M.position.setFromMatrixPosition(v.matrixWorld),M.position.applyMatrix4(m),o.identity(),s.copy(v.matrixWorld),s.premultiply(m),o.extractRotation(s),M.halfWidth.set(v.width*.5,0,0),M.halfHeight.set(0,v.height*.5,0),M.halfWidth.applyMatrix4(o),M.halfHeight.applyMatrix4(o),_++}else if(v.isPointLight){const M=i.point[h];M.position.setFromMatrixPosition(v.matrixWorld),M.position.applyMatrix4(m),h++}else if(v.isHemisphereLight){const M=i.hemi[x];M.direction.setFromMatrixPosition(v.matrixWorld),M.direction.transformDirection(m),x++}}}return{setup:a,setupView:l,state:i}}function Lm(t){const e=new nT(t),n=[],i=[];function r(f){c.camera=f,n.length=0,i.length=0}function s(f){n.push(f)}function o(f){i.push(f)}function a(){e.setup(n)}function l(f){e.setupView(n,f)}const c={lightsArray:n,shadowsArray:i,camera:null,lights:e,transmissionRenderTarget:{}};return{init:r,state:c,setupLights:a,setupLightsView:l,pushLight:s,pushShadow:o}}function iT(t){let e=new WeakMap;function n(r,s=0){const o=e.get(r);let a;return o===void 0?(a=new Lm(t),e.set(r,[a])):s>=o.length?(a=new Lm(t),o.push(a)):a=o[s],a}function i(){e=new WeakMap}return{get:n,dispose:i}}class rT extends po{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=Jy,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class sT extends po{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const oT=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function lT(t,e,n){let i=new wh;const r=new ft,s=new ft,o=new It,a=new rT({depthPacking:eS}),l=new sT,c={},f=n.maxTextureSize,d={[Ar]:Tn,[Tn]:Ar,[ri]:ri},h=new ji({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new ft},radius:{value:4}},vertexShader:oT,fragmentShader:aT}),p=h.clone();p.defines.HORIZONTAL_PASS=1;const _=new fi;_.setAttribute("position",new ci(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new St(_,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=i_;let u=this.type;this.render=function(R,A,b){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||R.length===0)return;const Q=t.getRenderTarget(),y=t.getActiveCubeFace(),w=t.getActiveMipmapLevel(),X=t.state;X.setBlending(Sr),X.buffers.color.setClear(1,1,1,1),X.buffers.depth.setTest(!0),X.setScissorTest(!1);const Y=u!==Li&&this.type===Li,ee=u===Li&&this.type!==Li;for(let oe=0,K=R.length;oe<K;oe++){const ce=R[oe],I=ce.shadow;if(I===void 0){console.warn("THREE.WebGLShadowMap:",ce,"has no shadow.");continue}if(I.autoUpdate===!1&&I.needsUpdate===!1)continue;r.copy(I.mapSize);const se=I.getFrameExtents();if(r.multiply(se),s.copy(I.mapSize),(r.x>f||r.y>f)&&(r.x>f&&(s.x=Math.floor(f/se.x),r.x=s.x*se.x,I.mapSize.x=s.x),r.y>f&&(s.y=Math.floor(f/se.y),r.y=s.y*se.y,I.mapSize.y=s.y)),I.map===null||Y===!0||ee===!0){const ve=this.type!==Li?{minFilter:Xn,magFilter:Xn}:{};I.map!==null&&I.map.dispose(),I.map=new ss(r.x,r.y,ve),I.map.texture.name=ce.name+".shadowMap",I.camera.updateProjectionMatrix()}t.setRenderTarget(I.map),t.clear();const re=I.getViewportCount();for(let ve=0;ve<re;ve++){const Fe=I.getViewport(ve);o.set(s.x*Fe.x,s.y*Fe.y,s.x*Fe.z,s.y*Fe.w),X.viewport(o),I.updateMatrices(ce,ve),i=I.getFrustum(),M(A,b,I.camera,ce,this.type)}I.isPointLightShadow!==!0&&this.type===Li&&g(I,b),I.needsUpdate=!1}u=this.type,m.needsUpdate=!1,t.setRenderTarget(Q,y,w)};function g(R,A){const b=e.update(x);h.defines.VSM_SAMPLES!==R.blurSamples&&(h.defines.VSM_SAMPLES=R.blurSamples,p.defines.VSM_SAMPLES=R.blurSamples,h.needsUpdate=!0,p.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new ss(r.x,r.y)),h.uniforms.shadow_pass.value=R.map.texture,h.uniforms.resolution.value=R.mapSize,h.uniforms.radius.value=R.radius,t.setRenderTarget(R.mapPass),t.clear(),t.renderBufferDirect(A,null,b,h,x,null),p.uniforms.shadow_pass.value=R.mapPass.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,t.setRenderTarget(R.map),t.clear(),t.renderBufferDirect(A,null,b,p,x,null)}function v(R,A,b,Q){let y=null;const w=b.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(w!==void 0)y=w;else if(y=b.isPointLight===!0?l:a,t.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0){const X=y.uuid,Y=A.uuid;let ee=c[X];ee===void 0&&(ee={},c[X]=ee);let oe=ee[Y];oe===void 0&&(oe=y.clone(),ee[Y]=oe,A.addEventListener("dispose",P)),y=oe}if(y.visible=A.visible,y.wireframe=A.wireframe,Q===Li?y.side=A.shadowSide!==null?A.shadowSide:A.side:y.side=A.shadowSide!==null?A.shadowSide:d[A.side],y.alphaMap=A.alphaMap,y.alphaTest=A.alphaTest,y.map=A.map,y.clipShadows=A.clipShadows,y.clippingPlanes=A.clippingPlanes,y.clipIntersection=A.clipIntersection,y.displacementMap=A.displacementMap,y.displacementScale=A.displacementScale,y.displacementBias=A.displacementBias,y.wireframeLinewidth=A.wireframeLinewidth,y.linewidth=A.linewidth,b.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const X=t.properties.get(y);X.light=b}return y}function M(R,A,b,Q,y){if(R.visible===!1)return;if(R.layers.test(A.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&y===Li)&&(!R.frustumCulled||i.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(b.matrixWorldInverse,R.matrixWorld);const Y=e.update(R),ee=R.material;if(Array.isArray(ee)){const oe=Y.groups;for(let K=0,ce=oe.length;K<ce;K++){const I=oe[K],se=ee[I.materialIndex];if(se&&se.visible){const re=v(R,se,Q,y);R.onBeforeShadow(t,R,A,b,Y,re,I),t.renderBufferDirect(b,null,Y,re,R,I),R.onAfterShadow(t,R,A,b,Y,re,I)}}}else if(ee.visible){const oe=v(R,ee,Q,y);R.onBeforeShadow(t,R,A,b,Y,oe,null),t.renderBufferDirect(b,null,Y,oe,R,null),R.onAfterShadow(t,R,A,b,Y,oe,null)}}const X=R.children;for(let Y=0,ee=X.length;Y<ee;Y++)M(X[Y],A,b,Q,y)}function P(R){R.target.removeEventListener("dispose",P);for(const b in c){const Q=c[b],y=R.target.uuid;y in Q&&(Q[y].dispose(),delete Q[y])}}}const cT={[Uf]:If,[Nf]:Bf,[Ff]:kf,[Js]:Of,[If]:Uf,[Bf]:Nf,[kf]:Ff,[Of]:Js};function uT(t){function e(){let T=!1;const N=new It;let L=null;const V=new It(0,0,0,0);return{setMask:function(ae){L!==ae&&!T&&(t.colorMask(ae,ae,ae,ae),L=ae)},setLocked:function(ae){T=ae},setClear:function(ae,xe,ke,at,gt){gt===!0&&(ae*=at,xe*=at,ke*=at),N.set(ae,xe,ke,at),V.equals(N)===!1&&(t.clearColor(ae,xe,ke,at),V.copy(N))},reset:function(){T=!1,L=null,V.set(-1,0,0,0)}}}function n(){let T=!1,N=!1,L=null,V=null,ae=null;return{setReversed:function(xe){N=xe},setTest:function(xe){xe?Te(t.DEPTH_TEST):we(t.DEPTH_TEST)},setMask:function(xe){L!==xe&&!T&&(t.depthMask(xe),L=xe)},setFunc:function(xe){if(N&&(xe=cT[xe]),V!==xe){switch(xe){case Uf:t.depthFunc(t.NEVER);break;case If:t.depthFunc(t.ALWAYS);break;case Nf:t.depthFunc(t.LESS);break;case Js:t.depthFunc(t.LEQUAL);break;case Ff:t.depthFunc(t.EQUAL);break;case Of:t.depthFunc(t.GEQUAL);break;case Bf:t.depthFunc(t.GREATER);break;case kf:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}V=xe}},setLocked:function(xe){T=xe},setClear:function(xe){ae!==xe&&(t.clearDepth(xe),ae=xe)},reset:function(){T=!1,L=null,V=null,ae=null}}}function i(){let T=!1,N=null,L=null,V=null,ae=null,xe=null,ke=null,at=null,gt=null;return{setTest:function($e){T||($e?Te(t.STENCIL_TEST):we(t.STENCIL_TEST))},setMask:function($e){N!==$e&&!T&&(t.stencilMask($e),N=$e)},setFunc:function($e,Rt,dt){(L!==$e||V!==Rt||ae!==dt)&&(t.stencilFunc($e,Rt,dt),L=$e,V=Rt,ae=dt)},setOp:function($e,Rt,dt){(xe!==$e||ke!==Rt||at!==dt)&&(t.stencilOp($e,Rt,dt),xe=$e,ke=Rt,at=dt)},setLocked:function($e){T=$e},setClear:function($e){gt!==$e&&(t.clearStencil($e),gt=$e)},reset:function(){T=!1,N=null,L=null,V=null,ae=null,xe=null,ke=null,at=null,gt=null}}}const r=new e,s=new n,o=new i,a=new WeakMap,l=new WeakMap;let c={},f={},d=new WeakMap,h=[],p=null,_=!1,x=null,m=null,u=null,g=null,v=null,M=null,P=null,R=new ze(0,0,0),A=0,b=!1,Q=null,y=null,w=null,X=null,Y=null;const ee=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let oe=!1,K=0;const ce=t.getParameter(t.VERSION);ce.indexOf("WebGL")!==-1?(K=parseFloat(/^WebGL (\d)/.exec(ce)[1]),oe=K>=1):ce.indexOf("OpenGL ES")!==-1&&(K=parseFloat(/^OpenGL ES (\d)/.exec(ce)[1]),oe=K>=2);let I=null,se={};const re=t.getParameter(t.SCISSOR_BOX),ve=t.getParameter(t.VIEWPORT),Fe=new It().fromArray(re),Qe=new It().fromArray(ve);function te(T,N,L,V){const ae=new Uint8Array(4),xe=t.createTexture();t.bindTexture(T,xe),t.texParameteri(T,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(T,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let ke=0;ke<L;ke++)T===t.TEXTURE_3D||T===t.TEXTURE_2D_ARRAY?t.texImage3D(N,0,t.RGBA,1,1,V,0,t.RGBA,t.UNSIGNED_BYTE,ae):t.texImage2D(N+ke,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,ae);return xe}const he={};he[t.TEXTURE_2D]=te(t.TEXTURE_2D,t.TEXTURE_2D,1),he[t.TEXTURE_CUBE_MAP]=te(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),he[t.TEXTURE_2D_ARRAY]=te(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),he[t.TEXTURE_3D]=te(t.TEXTURE_3D,t.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),o.setClear(0),Te(t.DEPTH_TEST),s.setFunc(Js),qe(!1),nt(zp),Te(t.CULL_FACE),U(Sr);function Te(T){c[T]!==!0&&(t.enable(T),c[T]=!0)}function we(T){c[T]!==!1&&(t.disable(T),c[T]=!1)}function Xe(T,N){return f[T]!==N?(t.bindFramebuffer(T,N),f[T]=N,T===t.DRAW_FRAMEBUFFER&&(f[t.FRAMEBUFFER]=N),T===t.FRAMEBUFFER&&(f[t.DRAW_FRAMEBUFFER]=N),!0):!1}function Oe(T,N){let L=h,V=!1;if(T){L=d.get(N),L===void 0&&(L=[],d.set(N,L));const ae=T.textures;if(L.length!==ae.length||L[0]!==t.COLOR_ATTACHMENT0){for(let xe=0,ke=ae.length;xe<ke;xe++)L[xe]=t.COLOR_ATTACHMENT0+xe;L.length=ae.length,V=!0}}else L[0]!==t.BACK&&(L[0]=t.BACK,V=!0);V&&t.drawBuffers(L)}function ot(T){return p!==T?(t.useProgram(T),p=T,!0):!1}const ct={[Wr]:t.FUNC_ADD,[Ay]:t.FUNC_SUBTRACT,[Cy]:t.FUNC_REVERSE_SUBTRACT};ct[Ry]=t.MIN,ct[Py]=t.MAX;const tt={[by]:t.ZERO,[Dy]:t.ONE,[Ly]:t.SRC_COLOR,[Df]:t.SRC_ALPHA,[By]:t.SRC_ALPHA_SATURATE,[Fy]:t.DST_COLOR,[Iy]:t.DST_ALPHA,[Uy]:t.ONE_MINUS_SRC_COLOR,[Lf]:t.ONE_MINUS_SRC_ALPHA,[Oy]:t.ONE_MINUS_DST_COLOR,[Ny]:t.ONE_MINUS_DST_ALPHA,[ky]:t.CONSTANT_COLOR,[zy]:t.ONE_MINUS_CONSTANT_COLOR,[Hy]:t.CONSTANT_ALPHA,[Vy]:t.ONE_MINUS_CONSTANT_ALPHA};function U(T,N,L,V,ae,xe,ke,at,gt,$e){if(T===Sr){_===!0&&(we(t.BLEND),_=!1);return}if(_===!1&&(Te(t.BLEND),_=!0),T!==Ty){if(T!==x||$e!==b){if((m!==Wr||v!==Wr)&&(t.blendEquation(t.FUNC_ADD),m=Wr,v=Wr),$e)switch(T){case Gs:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Hp:t.blendFunc(t.ONE,t.ONE);break;case Vp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Gp:t.blendFuncSeparate(t.ZERO,t.SRC_COLOR,t.ZERO,t.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",T);break}else switch(T){case Gs:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Hp:t.blendFunc(t.SRC_ALPHA,t.ONE);break;case Vp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Gp:t.blendFunc(t.ZERO,t.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",T);break}u=null,g=null,M=null,P=null,R.set(0,0,0),A=0,x=T,b=$e}return}ae=ae||N,xe=xe||L,ke=ke||V,(N!==m||ae!==v)&&(t.blendEquationSeparate(ct[N],ct[ae]),m=N,v=ae),(L!==u||V!==g||xe!==M||ke!==P)&&(t.blendFuncSeparate(tt[L],tt[V],tt[xe],tt[ke]),u=L,g=V,M=xe,P=ke),(at.equals(R)===!1||gt!==A)&&(t.blendColor(at.r,at.g,at.b,gt),R.copy(at),A=gt),x=T,b=!1}function zt(T,N){T.side===ri?we(t.CULL_FACE):Te(t.CULL_FACE);let L=T.side===Tn;N&&(L=!L),qe(L),T.blending===Gs&&T.transparent===!1?U(Sr):U(T.blending,T.blendEquation,T.blendSrc,T.blendDst,T.blendEquationAlpha,T.blendSrcAlpha,T.blendDstAlpha,T.blendColor,T.blendAlpha,T.premultipliedAlpha),s.setFunc(T.depthFunc),s.setTest(T.depthTest),s.setMask(T.depthWrite),r.setMask(T.colorWrite);const V=T.stencilWrite;o.setTest(V),V&&(o.setMask(T.stencilWriteMask),o.setFunc(T.stencilFunc,T.stencilRef,T.stencilFuncMask),o.setOp(T.stencilFail,T.stencilZFail,T.stencilZPass)),ut(T.polygonOffset,T.polygonOffsetFactor,T.polygonOffsetUnits),T.alphaToCoverage===!0?Te(t.SAMPLE_ALPHA_TO_COVERAGE):we(t.SAMPLE_ALPHA_TO_COVERAGE)}function qe(T){Q!==T&&(T?t.frontFace(t.CW):t.frontFace(t.CCW),Q=T)}function nt(T){T!==My?(Te(t.CULL_FACE),T!==y&&(T===zp?t.cullFace(t.BACK):T===Ey?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):we(t.CULL_FACE),y=T}function Be(T){T!==w&&(oe&&t.lineWidth(T),w=T)}function ut(T,N,L){T?(Te(t.POLYGON_OFFSET_FILL),(X!==N||Y!==L)&&(t.polygonOffset(N,L),X=N,Y=L)):we(t.POLYGON_OFFSET_FILL)}function Ge(T){T?Te(t.SCISSOR_TEST):we(t.SCISSOR_TEST)}function C(T){T===void 0&&(T=t.TEXTURE0+ee-1),I!==T&&(t.activeTexture(T),I=T)}function S(T,N,L){L===void 0&&(I===null?L=t.TEXTURE0+ee-1:L=I);let V=se[L];V===void 0&&(V={type:void 0,texture:void 0},se[L]=V),(V.type!==T||V.texture!==N)&&(I!==L&&(t.activeTexture(L),I=L),t.bindTexture(T,N||he[T]),V.type=T,V.texture=N)}function G(){const T=se[I];T!==void 0&&T.type!==void 0&&(t.bindTexture(T.type,null),T.type=void 0,T.texture=void 0)}function ie(){try{t.compressedTexImage2D.apply(t,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function fe(){try{t.compressedTexImage3D.apply(t,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function ne(){try{t.texSubImage2D.apply(t,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function Ue(){try{t.texSubImage3D.apply(t,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function ye(){try{t.compressedTexSubImage2D.apply(t,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function Ae(){try{t.compressedTexSubImage3D.apply(t,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function it(){try{t.texStorage2D.apply(t,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function _e(){try{t.texStorage3D.apply(t,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function Ce(){try{t.texImage2D.apply(t,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function He(){try{t.texImage3D.apply(t,arguments)}catch(T){console.error("THREE.WebGLState:",T)}}function Ve(T){Fe.equals(T)===!1&&(t.scissor(T.x,T.y,T.z,T.w),Fe.copy(T))}function D(T){Qe.equals(T)===!1&&(t.viewport(T.x,T.y,T.z,T.w),Qe.copy(T))}function z(T,N){let L=l.get(N);L===void 0&&(L=new WeakMap,l.set(N,L));let V=L.get(T);V===void 0&&(V=t.getUniformBlockIndex(N,T.name),L.set(T,V))}function H(T,N){const V=l.get(N).get(T);a.get(N)!==V&&(t.uniformBlockBinding(N,V,T.__bindingPointIndex),a.set(N,V))}function j(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),c={},I=null,se={},f={},d=new WeakMap,h=[],p=null,_=!1,x=null,m=null,u=null,g=null,v=null,M=null,P=null,R=new ze(0,0,0),A=0,b=!1,Q=null,y=null,w=null,X=null,Y=null,Fe.set(0,0,t.canvas.width,t.canvas.height),Qe.set(0,0,t.canvas.width,t.canvas.height),r.reset(),s.reset(),o.reset()}return{buffers:{color:r,depth:s,stencil:o},enable:Te,disable:we,bindFramebuffer:Xe,drawBuffers:Oe,useProgram:ot,setBlending:U,setMaterial:zt,setFlipSided:qe,setCullFace:nt,setLineWidth:Be,setPolygonOffset:ut,setScissorTest:Ge,activeTexture:C,bindTexture:S,unbindTexture:G,compressedTexImage2D:ie,compressedTexImage3D:fe,texImage2D:Ce,texImage3D:He,updateUBOMapping:z,uniformBlockBinding:H,texStorage2D:it,texStorage3D:_e,texSubImage2D:ne,texSubImage3D:Ue,compressedTexSubImage2D:ye,compressedTexSubImage3D:Ae,scissor:Ve,viewport:D,reset:j}}function Um(t,e,n,i){const r=fT(i);switch(n){case l_:return t*e;case u_:return t*e;case f_:return t*e*2;case d_:return t*e/r.components*r.byteLength;case vh:return t*e/r.components*r.byteLength;case h_:return t*e*2/r.components*r.byteLength;case xh:return t*e*2/r.components*r.byteLength;case c_:return t*e*3/r.components*r.byteLength;case oi:return t*e*4/r.components*r.byteLength;case yh:return t*e*4/r.components*r.byteLength;case Ml:case El:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case wl:case Tl:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case Xf:case Yf:return Math.max(t,16)*Math.max(e,8)/4;case Wf:case jf:return Math.max(t,8)*Math.max(e,8)/2;case qf:case $f:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*8;case Kf:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case Zf:return Math.floor((t+3)/4)*Math.floor((e+3)/4)*16;case Qf:return Math.floor((t+4)/5)*Math.floor((e+3)/4)*16;case Jf:return Math.floor((t+4)/5)*Math.floor((e+4)/5)*16;case ed:return Math.floor((t+5)/6)*Math.floor((e+4)/5)*16;case td:return Math.floor((t+5)/6)*Math.floor((e+5)/6)*16;case nd:return Math.floor((t+7)/8)*Math.floor((e+4)/5)*16;case id:return Math.floor((t+7)/8)*Math.floor((e+5)/6)*16;case rd:return Math.floor((t+7)/8)*Math.floor((e+7)/8)*16;case sd:return Math.floor((t+9)/10)*Math.floor((e+4)/5)*16;case od:return Math.floor((t+9)/10)*Math.floor((e+5)/6)*16;case ad:return Math.floor((t+9)/10)*Math.floor((e+7)/8)*16;case ld:return Math.floor((t+9)/10)*Math.floor((e+9)/10)*16;case cd:return Math.floor((t+11)/12)*Math.floor((e+9)/10)*16;case ud:return Math.floor((t+11)/12)*Math.floor((e+11)/12)*16;case Al:case fd:case dd:return Math.ceil(t/4)*Math.ceil(e/4)*16;case p_:case hd:return Math.ceil(t/4)*Math.ceil(e/4)*8;case pd:case md:return Math.ceil(t/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${n} format.`)}function fT(t){switch(t){case Xi:case s_:return{byteLength:1,components:1};case fa:case o_:case _a:return{byteLength:2,components:1};case gh:case _h:return{byteLength:2,components:4};case rs:case mh:case Oi:return{byteLength:4,components:1};case a_:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${t}.`)}function dT(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new ft,f=new WeakMap;let d;const h=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(C,S){return p?new OffscreenCanvas(C,S):rc("canvas")}function x(C,S,G){let ie=1;const fe=Ge(C);if((fe.width>G||fe.height>G)&&(ie=G/Math.max(fe.width,fe.height)),ie<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const ne=Math.floor(ie*fe.width),Ue=Math.floor(ie*fe.height);d===void 0&&(d=_(ne,Ue));const ye=S?_(ne,Ue):d;return ye.width=ne,ye.height=Ue,ye.getContext("2d").drawImage(C,0,0,ne,Ue),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+fe.width+"x"+fe.height+") to ("+ne+"x"+Ue+")."),ye}else return"data"in C&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+fe.width+"x"+fe.height+")."),C;return C}function m(C){return C.generateMipmaps&&C.minFilter!==Xn&&C.minFilter!==si}function u(C){t.generateMipmap(C)}function g(C,S,G,ie,fe=!1){if(C!==null){if(t[C]!==void 0)return t[C];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let ne=S;if(S===t.RED&&(G===t.FLOAT&&(ne=t.R32F),G===t.HALF_FLOAT&&(ne=t.R16F),G===t.UNSIGNED_BYTE&&(ne=t.R8)),S===t.RED_INTEGER&&(G===t.UNSIGNED_BYTE&&(ne=t.R8UI),G===t.UNSIGNED_SHORT&&(ne=t.R16UI),G===t.UNSIGNED_INT&&(ne=t.R32UI),G===t.BYTE&&(ne=t.R8I),G===t.SHORT&&(ne=t.R16I),G===t.INT&&(ne=t.R32I)),S===t.RG&&(G===t.FLOAT&&(ne=t.RG32F),G===t.HALF_FLOAT&&(ne=t.RG16F),G===t.UNSIGNED_BYTE&&(ne=t.RG8)),S===t.RG_INTEGER&&(G===t.UNSIGNED_BYTE&&(ne=t.RG8UI),G===t.UNSIGNED_SHORT&&(ne=t.RG16UI),G===t.UNSIGNED_INT&&(ne=t.RG32UI),G===t.BYTE&&(ne=t.RG8I),G===t.SHORT&&(ne=t.RG16I),G===t.INT&&(ne=t.RG32I)),S===t.RGB_INTEGER&&(G===t.UNSIGNED_BYTE&&(ne=t.RGB8UI),G===t.UNSIGNED_SHORT&&(ne=t.RGB16UI),G===t.UNSIGNED_INT&&(ne=t.RGB32UI),G===t.BYTE&&(ne=t.RGB8I),G===t.SHORT&&(ne=t.RGB16I),G===t.INT&&(ne=t.RGB32I)),S===t.RGBA_INTEGER&&(G===t.UNSIGNED_BYTE&&(ne=t.RGBA8UI),G===t.UNSIGNED_SHORT&&(ne=t.RGBA16UI),G===t.UNSIGNED_INT&&(ne=t.RGBA32UI),G===t.BYTE&&(ne=t.RGBA8I),G===t.SHORT&&(ne=t.RGBA16I),G===t.INT&&(ne=t.RGBA32I)),S===t.RGB&&G===t.UNSIGNED_INT_5_9_9_9_REV&&(ne=t.RGB9_E5),S===t.RGBA){const Ue=fe?ec:ht.getTransfer(ie);G===t.FLOAT&&(ne=t.RGBA32F),G===t.HALF_FLOAT&&(ne=t.RGBA16F),G===t.UNSIGNED_BYTE&&(ne=Ue===Et?t.SRGB8_ALPHA8:t.RGBA8),G===t.UNSIGNED_SHORT_4_4_4_4&&(ne=t.RGBA4),G===t.UNSIGNED_SHORT_5_5_5_1&&(ne=t.RGB5_A1)}return(ne===t.R16F||ne===t.R32F||ne===t.RG16F||ne===t.RG32F||ne===t.RGBA16F||ne===t.RGBA32F)&&e.get("EXT_color_buffer_float"),ne}function v(C,S){let G;return C?S===null||S===rs||S===no?G=t.DEPTH24_STENCIL8:S===Oi?G=t.DEPTH32F_STENCIL8:S===fa&&(G=t.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===rs||S===no?G=t.DEPTH_COMPONENT24:S===Oi?G=t.DEPTH_COMPONENT32F:S===fa&&(G=t.DEPTH_COMPONENT16),G}function M(C,S){return m(C)===!0||C.isFramebufferTexture&&C.minFilter!==Xn&&C.minFilter!==si?Math.log2(Math.max(S.width,S.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?S.mipmaps.length:1}function P(C){const S=C.target;S.removeEventListener("dispose",P),A(S),S.isVideoTexture&&f.delete(S)}function R(C){const S=C.target;S.removeEventListener("dispose",R),Q(S)}function A(C){const S=i.get(C);if(S.__webglInit===void 0)return;const G=C.source,ie=h.get(G);if(ie){const fe=ie[S.__cacheKey];fe.usedTimes--,fe.usedTimes===0&&b(C),Object.keys(ie).length===0&&h.delete(G)}i.remove(C)}function b(C){const S=i.get(C);t.deleteTexture(S.__webglTexture);const G=C.source,ie=h.get(G);delete ie[S.__cacheKey],o.memory.textures--}function Q(C){const S=i.get(C);if(C.depthTexture&&C.depthTexture.dispose(),C.isWebGLCubeRenderTarget)for(let ie=0;ie<6;ie++){if(Array.isArray(S.__webglFramebuffer[ie]))for(let fe=0;fe<S.__webglFramebuffer[ie].length;fe++)t.deleteFramebuffer(S.__webglFramebuffer[ie][fe]);else t.deleteFramebuffer(S.__webglFramebuffer[ie]);S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer[ie])}else{if(Array.isArray(S.__webglFramebuffer))for(let ie=0;ie<S.__webglFramebuffer.length;ie++)t.deleteFramebuffer(S.__webglFramebuffer[ie]);else t.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&t.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let ie=0;ie<S.__webglColorRenderbuffer.length;ie++)S.__webglColorRenderbuffer[ie]&&t.deleteRenderbuffer(S.__webglColorRenderbuffer[ie]);S.__webglDepthRenderbuffer&&t.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const G=C.textures;for(let ie=0,fe=G.length;ie<fe;ie++){const ne=i.get(G[ie]);ne.__webglTexture&&(t.deleteTexture(ne.__webglTexture),o.memory.textures--),i.remove(G[ie])}i.remove(C)}let y=0;function w(){y=0}function X(){const C=y;return C>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+r.maxTextures),y+=1,C}function Y(C){const S=[];return S.push(C.wrapS),S.push(C.wrapT),S.push(C.wrapR||0),S.push(C.magFilter),S.push(C.minFilter),S.push(C.anisotropy),S.push(C.internalFormat),S.push(C.format),S.push(C.type),S.push(C.generateMipmaps),S.push(C.premultiplyAlpha),S.push(C.flipY),S.push(C.unpackAlignment),S.push(C.colorSpace),S.join()}function ee(C,S){const G=i.get(C);if(C.isVideoTexture&&Be(C),C.isRenderTargetTexture===!1&&C.version>0&&G.__version!==C.version){const ie=C.image;if(ie===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ie.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Qe(G,C,S);return}}n.bindTexture(t.TEXTURE_2D,G.__webglTexture,t.TEXTURE0+S)}function oe(C,S){const G=i.get(C);if(C.version>0&&G.__version!==C.version){Qe(G,C,S);return}n.bindTexture(t.TEXTURE_2D_ARRAY,G.__webglTexture,t.TEXTURE0+S)}function K(C,S){const G=i.get(C);if(C.version>0&&G.__version!==C.version){Qe(G,C,S);return}n.bindTexture(t.TEXTURE_3D,G.__webglTexture,t.TEXTURE0+S)}function ce(C,S){const G=i.get(C);if(C.version>0&&G.__version!==C.version){te(G,C,S);return}n.bindTexture(t.TEXTURE_CUBE_MAP,G.__webglTexture,t.TEXTURE0+S)}const I={[Vf]:t.REPEAT,[$r]:t.CLAMP_TO_EDGE,[Gf]:t.MIRRORED_REPEAT},se={[Xn]:t.NEAREST,[Qy]:t.NEAREST_MIPMAP_NEAREST,[Ba]:t.NEAREST_MIPMAP_LINEAR,[si]:t.LINEAR,[ru]:t.LINEAR_MIPMAP_NEAREST,[Kr]:t.LINEAR_MIPMAP_LINEAR},re={[nS]:t.NEVER,[lS]:t.ALWAYS,[iS]:t.LESS,[g_]:t.LEQUAL,[rS]:t.EQUAL,[aS]:t.GEQUAL,[sS]:t.GREATER,[oS]:t.NOTEQUAL};function ve(C,S){if(S.type===Oi&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===si||S.magFilter===ru||S.magFilter===Ba||S.magFilter===Kr||S.minFilter===si||S.minFilter===ru||S.minFilter===Ba||S.minFilter===Kr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(C,t.TEXTURE_WRAP_S,I[S.wrapS]),t.texParameteri(C,t.TEXTURE_WRAP_T,I[S.wrapT]),(C===t.TEXTURE_3D||C===t.TEXTURE_2D_ARRAY)&&t.texParameteri(C,t.TEXTURE_WRAP_R,I[S.wrapR]),t.texParameteri(C,t.TEXTURE_MAG_FILTER,se[S.magFilter]),t.texParameteri(C,t.TEXTURE_MIN_FILTER,se[S.minFilter]),S.compareFunction&&(t.texParameteri(C,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(C,t.TEXTURE_COMPARE_FUNC,re[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===Xn||S.minFilter!==Ba&&S.minFilter!==Kr||S.type===Oi&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||i.get(S).__currentAnisotropy){const G=e.get("EXT_texture_filter_anisotropic");t.texParameterf(C,G.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,r.getMaxAnisotropy())),i.get(S).__currentAnisotropy=S.anisotropy}}}function Fe(C,S){let G=!1;C.__webglInit===void 0&&(C.__webglInit=!0,S.addEventListener("dispose",P));const ie=S.source;let fe=h.get(ie);fe===void 0&&(fe={},h.set(ie,fe));const ne=Y(S);if(ne!==C.__cacheKey){fe[ne]===void 0&&(fe[ne]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,G=!0),fe[ne].usedTimes++;const Ue=fe[C.__cacheKey];Ue!==void 0&&(fe[C.__cacheKey].usedTimes--,Ue.usedTimes===0&&b(S)),C.__cacheKey=ne,C.__webglTexture=fe[ne].texture}return G}function Qe(C,S,G){let ie=t.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(ie=t.TEXTURE_2D_ARRAY),S.isData3DTexture&&(ie=t.TEXTURE_3D);const fe=Fe(C,S),ne=S.source;n.bindTexture(ie,C.__webglTexture,t.TEXTURE0+G);const Ue=i.get(ne);if(ne.version!==Ue.__version||fe===!0){n.activeTexture(t.TEXTURE0+G);const ye=ht.getPrimaries(ht.workingColorSpace),Ae=S.colorSpace===cr?null:ht.getPrimaries(S.colorSpace),it=S.colorSpace===cr||ye===Ae?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,it);let _e=x(S.image,!1,r.maxTextureSize);_e=ut(S,_e);const Ce=s.convert(S.format,S.colorSpace),He=s.convert(S.type);let Ve=g(S.internalFormat,Ce,He,S.colorSpace,S.isVideoTexture);ve(ie,S);let D;const z=S.mipmaps,H=S.isVideoTexture!==!0,j=Ue.__version===void 0||fe===!0,T=ne.dataReady,N=M(S,_e);if(S.isDepthTexture)Ve=v(S.format===io,S.type),j&&(H?n.texStorage2D(t.TEXTURE_2D,1,Ve,_e.width,_e.height):n.texImage2D(t.TEXTURE_2D,0,Ve,_e.width,_e.height,0,Ce,He,null));else if(S.isDataTexture)if(z.length>0){H&&j&&n.texStorage2D(t.TEXTURE_2D,N,Ve,z[0].width,z[0].height);for(let L=0,V=z.length;L<V;L++)D=z[L],H?T&&n.texSubImage2D(t.TEXTURE_2D,L,0,0,D.width,D.height,Ce,He,D.data):n.texImage2D(t.TEXTURE_2D,L,Ve,D.width,D.height,0,Ce,He,D.data);S.generateMipmaps=!1}else H?(j&&n.texStorage2D(t.TEXTURE_2D,N,Ve,_e.width,_e.height),T&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,_e.width,_e.height,Ce,He,_e.data)):n.texImage2D(t.TEXTURE_2D,0,Ve,_e.width,_e.height,0,Ce,He,_e.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){H&&j&&n.texStorage3D(t.TEXTURE_2D_ARRAY,N,Ve,z[0].width,z[0].height,_e.depth);for(let L=0,V=z.length;L<V;L++)if(D=z[L],S.format!==oi)if(Ce!==null)if(H){if(T)if(S.layerUpdates.size>0){const ae=Um(D.width,D.height,S.format,S.type);for(const xe of S.layerUpdates){const ke=D.data.subarray(xe*ae/D.data.BYTES_PER_ELEMENT,(xe+1)*ae/D.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,L,0,0,xe,D.width,D.height,1,Ce,ke,0,0)}S.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,L,0,0,0,D.width,D.height,_e.depth,Ce,D.data,0,0)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,L,Ve,D.width,D.height,_e.depth,0,D.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else H?T&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,L,0,0,0,D.width,D.height,_e.depth,Ce,He,D.data):n.texImage3D(t.TEXTURE_2D_ARRAY,L,Ve,D.width,D.height,_e.depth,0,Ce,He,D.data)}else{H&&j&&n.texStorage2D(t.TEXTURE_2D,N,Ve,z[0].width,z[0].height);for(let L=0,V=z.length;L<V;L++)D=z[L],S.format!==oi?Ce!==null?H?T&&n.compressedTexSubImage2D(t.TEXTURE_2D,L,0,0,D.width,D.height,Ce,D.data):n.compressedTexImage2D(t.TEXTURE_2D,L,Ve,D.width,D.height,0,D.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):H?T&&n.texSubImage2D(t.TEXTURE_2D,L,0,0,D.width,D.height,Ce,He,D.data):n.texImage2D(t.TEXTURE_2D,L,Ve,D.width,D.height,0,Ce,He,D.data)}else if(S.isDataArrayTexture)if(H){if(j&&n.texStorage3D(t.TEXTURE_2D_ARRAY,N,Ve,_e.width,_e.height,_e.depth),T)if(S.layerUpdates.size>0){const L=Um(_e.width,_e.height,S.format,S.type);for(const V of S.layerUpdates){const ae=_e.data.subarray(V*L/_e.data.BYTES_PER_ELEMENT,(V+1)*L/_e.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,V,_e.width,_e.height,1,Ce,He,ae)}S.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,_e.width,_e.height,_e.depth,Ce,He,_e.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,Ve,_e.width,_e.height,_e.depth,0,Ce,He,_e.data);else if(S.isData3DTexture)H?(j&&n.texStorage3D(t.TEXTURE_3D,N,Ve,_e.width,_e.height,_e.depth),T&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,_e.width,_e.height,_e.depth,Ce,He,_e.data)):n.texImage3D(t.TEXTURE_3D,0,Ve,_e.width,_e.height,_e.depth,0,Ce,He,_e.data);else if(S.isFramebufferTexture){if(j)if(H)n.texStorage2D(t.TEXTURE_2D,N,Ve,_e.width,_e.height);else{let L=_e.width,V=_e.height;for(let ae=0;ae<N;ae++)n.texImage2D(t.TEXTURE_2D,ae,Ve,L,V,0,Ce,He,null),L>>=1,V>>=1}}else if(z.length>0){if(H&&j){const L=Ge(z[0]);n.texStorage2D(t.TEXTURE_2D,N,Ve,L.width,L.height)}for(let L=0,V=z.length;L<V;L++)D=z[L],H?T&&n.texSubImage2D(t.TEXTURE_2D,L,0,0,Ce,He,D):n.texImage2D(t.TEXTURE_2D,L,Ve,Ce,He,D);S.generateMipmaps=!1}else if(H){if(j){const L=Ge(_e);n.texStorage2D(t.TEXTURE_2D,N,Ve,L.width,L.height)}T&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,Ce,He,_e)}else n.texImage2D(t.TEXTURE_2D,0,Ve,Ce,He,_e);m(S)&&u(ie),Ue.__version=ne.version,S.onUpdate&&S.onUpdate(S)}C.__version=S.version}function te(C,S,G){if(S.image.length!==6)return;const ie=Fe(C,S),fe=S.source;n.bindTexture(t.TEXTURE_CUBE_MAP,C.__webglTexture,t.TEXTURE0+G);const ne=i.get(fe);if(fe.version!==ne.__version||ie===!0){n.activeTexture(t.TEXTURE0+G);const Ue=ht.getPrimaries(ht.workingColorSpace),ye=S.colorSpace===cr?null:ht.getPrimaries(S.colorSpace),Ae=S.colorSpace===cr||Ue===ye?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ae);const it=S.isCompressedTexture||S.image[0].isCompressedTexture,_e=S.image[0]&&S.image[0].isDataTexture,Ce=[];for(let V=0;V<6;V++)!it&&!_e?Ce[V]=x(S.image[V],!0,r.maxCubemapSize):Ce[V]=_e?S.image[V].image:S.image[V],Ce[V]=ut(S,Ce[V]);const He=Ce[0],Ve=s.convert(S.format,S.colorSpace),D=s.convert(S.type),z=g(S.internalFormat,Ve,D,S.colorSpace),H=S.isVideoTexture!==!0,j=ne.__version===void 0||ie===!0,T=fe.dataReady;let N=M(S,He);ve(t.TEXTURE_CUBE_MAP,S);let L;if(it){H&&j&&n.texStorage2D(t.TEXTURE_CUBE_MAP,N,z,He.width,He.height);for(let V=0;V<6;V++){L=Ce[V].mipmaps;for(let ae=0;ae<L.length;ae++){const xe=L[ae];S.format!==oi?Ve!==null?H?T&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+V,ae,0,0,xe.width,xe.height,Ve,xe.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+V,ae,z,xe.width,xe.height,0,xe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):H?T&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+V,ae,0,0,xe.width,xe.height,Ve,D,xe.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+V,ae,z,xe.width,xe.height,0,Ve,D,xe.data)}}}else{if(L=S.mipmaps,H&&j){L.length>0&&N++;const V=Ge(Ce[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,N,z,V.width,V.height)}for(let V=0;V<6;V++)if(_e){H?T&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+V,0,0,0,Ce[V].width,Ce[V].height,Ve,D,Ce[V].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+V,0,z,Ce[V].width,Ce[V].height,0,Ve,D,Ce[V].data);for(let ae=0;ae<L.length;ae++){const ke=L[ae].image[V].image;H?T&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+V,ae+1,0,0,ke.width,ke.height,Ve,D,ke.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+V,ae+1,z,ke.width,ke.height,0,Ve,D,ke.data)}}else{H?T&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+V,0,0,0,Ve,D,Ce[V]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+V,0,z,Ve,D,Ce[V]);for(let ae=0;ae<L.length;ae++){const xe=L[ae];H?T&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+V,ae+1,0,0,Ve,D,xe.image[V]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+V,ae+1,z,Ve,D,xe.image[V])}}}m(S)&&u(t.TEXTURE_CUBE_MAP),ne.__version=fe.version,S.onUpdate&&S.onUpdate(S)}C.__version=S.version}function he(C,S,G,ie,fe,ne){const Ue=s.convert(G.format,G.colorSpace),ye=s.convert(G.type),Ae=g(G.internalFormat,Ue,ye,G.colorSpace);if(!i.get(S).__hasExternalTextures){const _e=Math.max(1,S.width>>ne),Ce=Math.max(1,S.height>>ne);fe===t.TEXTURE_3D||fe===t.TEXTURE_2D_ARRAY?n.texImage3D(fe,ne,Ae,_e,Ce,S.depth,0,Ue,ye,null):n.texImage2D(fe,ne,Ae,_e,Ce,0,Ue,ye,null)}n.bindFramebuffer(t.FRAMEBUFFER,C),nt(S)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,ie,fe,i.get(G).__webglTexture,0,qe(S)):(fe===t.TEXTURE_2D||fe>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&fe<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,ie,fe,i.get(G).__webglTexture,ne),n.bindFramebuffer(t.FRAMEBUFFER,null)}function Te(C,S,G){if(t.bindRenderbuffer(t.RENDERBUFFER,C),S.depthBuffer){const ie=S.depthTexture,fe=ie&&ie.isDepthTexture?ie.type:null,ne=v(S.stencilBuffer,fe),Ue=S.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ye=qe(S);nt(S)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,ye,ne,S.width,S.height):G?t.renderbufferStorageMultisample(t.RENDERBUFFER,ye,ne,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,ne,S.width,S.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,Ue,t.RENDERBUFFER,C)}else{const ie=S.textures;for(let fe=0;fe<ie.length;fe++){const ne=ie[fe],Ue=s.convert(ne.format,ne.colorSpace),ye=s.convert(ne.type),Ae=g(ne.internalFormat,Ue,ye,ne.colorSpace),it=qe(S);G&&nt(S)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,it,Ae,S.width,S.height):nt(S)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,it,Ae,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,Ae,S.width,S.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function we(C,S){if(S&&S.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,C),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(S.depthTexture).__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),ee(S.depthTexture,0);const ie=i.get(S.depthTexture).__webglTexture,fe=qe(S);if(S.depthTexture.format===Ws)nt(S)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ie,0,fe):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ie,0);else if(S.depthTexture.format===io)nt(S)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ie,0,fe):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ie,0);else throw new Error("Unknown depthTexture format")}function Xe(C){const S=i.get(C),G=C.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==C.depthTexture){const ie=C.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),ie){const fe=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,ie.removeEventListener("dispose",fe)};ie.addEventListener("dispose",fe),S.__depthDisposeCallback=fe}S.__boundDepthTexture=ie}if(C.depthTexture&&!S.__autoAllocateDepthBuffer){if(G)throw new Error("target.depthTexture not supported in Cube render targets");we(S.__webglFramebuffer,C)}else if(G){S.__webglDepthbuffer=[];for(let ie=0;ie<6;ie++)if(n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer[ie]),S.__webglDepthbuffer[ie]===void 0)S.__webglDepthbuffer[ie]=t.createRenderbuffer(),Te(S.__webglDepthbuffer[ie],C,!1);else{const fe=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ne=S.__webglDepthbuffer[ie];t.bindRenderbuffer(t.RENDERBUFFER,ne),t.framebufferRenderbuffer(t.FRAMEBUFFER,fe,t.RENDERBUFFER,ne)}}else if(n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=t.createRenderbuffer(),Te(S.__webglDepthbuffer,C,!1);else{const ie=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,fe=S.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,fe),t.framebufferRenderbuffer(t.FRAMEBUFFER,ie,t.RENDERBUFFER,fe)}n.bindFramebuffer(t.FRAMEBUFFER,null)}function Oe(C,S,G){const ie=i.get(C);S!==void 0&&he(ie.__webglFramebuffer,C,C.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),G!==void 0&&Xe(C)}function ot(C){const S=C.texture,G=i.get(C),ie=i.get(S);C.addEventListener("dispose",R);const fe=C.textures,ne=C.isWebGLCubeRenderTarget===!0,Ue=fe.length>1;if(Ue||(ie.__webglTexture===void 0&&(ie.__webglTexture=t.createTexture()),ie.__version=S.version,o.memory.textures++),ne){G.__webglFramebuffer=[];for(let ye=0;ye<6;ye++)if(S.mipmaps&&S.mipmaps.length>0){G.__webglFramebuffer[ye]=[];for(let Ae=0;Ae<S.mipmaps.length;Ae++)G.__webglFramebuffer[ye][Ae]=t.createFramebuffer()}else G.__webglFramebuffer[ye]=t.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){G.__webglFramebuffer=[];for(let ye=0;ye<S.mipmaps.length;ye++)G.__webglFramebuffer[ye]=t.createFramebuffer()}else G.__webglFramebuffer=t.createFramebuffer();if(Ue)for(let ye=0,Ae=fe.length;ye<Ae;ye++){const it=i.get(fe[ye]);it.__webglTexture===void 0&&(it.__webglTexture=t.createTexture(),o.memory.textures++)}if(C.samples>0&&nt(C)===!1){G.__webglMultisampledFramebuffer=t.createFramebuffer(),G.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,G.__webglMultisampledFramebuffer);for(let ye=0;ye<fe.length;ye++){const Ae=fe[ye];G.__webglColorRenderbuffer[ye]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,G.__webglColorRenderbuffer[ye]);const it=s.convert(Ae.format,Ae.colorSpace),_e=s.convert(Ae.type),Ce=g(Ae.internalFormat,it,_e,Ae.colorSpace,C.isXRRenderTarget===!0),He=qe(C);t.renderbufferStorageMultisample(t.RENDERBUFFER,He,Ce,C.width,C.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ye,t.RENDERBUFFER,G.__webglColorRenderbuffer[ye])}t.bindRenderbuffer(t.RENDERBUFFER,null),C.depthBuffer&&(G.__webglDepthRenderbuffer=t.createRenderbuffer(),Te(G.__webglDepthRenderbuffer,C,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(ne){n.bindTexture(t.TEXTURE_CUBE_MAP,ie.__webglTexture),ve(t.TEXTURE_CUBE_MAP,S);for(let ye=0;ye<6;ye++)if(S.mipmaps&&S.mipmaps.length>0)for(let Ae=0;Ae<S.mipmaps.length;Ae++)he(G.__webglFramebuffer[ye][Ae],C,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ye,Ae);else he(G.__webglFramebuffer[ye],C,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ye,0);m(S)&&u(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Ue){for(let ye=0,Ae=fe.length;ye<Ae;ye++){const it=fe[ye],_e=i.get(it);n.bindTexture(t.TEXTURE_2D,_e.__webglTexture),ve(t.TEXTURE_2D,it),he(G.__webglFramebuffer,C,it,t.COLOR_ATTACHMENT0+ye,t.TEXTURE_2D,0),m(it)&&u(t.TEXTURE_2D)}n.unbindTexture()}else{let ye=t.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(ye=C.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(ye,ie.__webglTexture),ve(ye,S),S.mipmaps&&S.mipmaps.length>0)for(let Ae=0;Ae<S.mipmaps.length;Ae++)he(G.__webglFramebuffer[Ae],C,S,t.COLOR_ATTACHMENT0,ye,Ae);else he(G.__webglFramebuffer,C,S,t.COLOR_ATTACHMENT0,ye,0);m(S)&&u(ye),n.unbindTexture()}C.depthBuffer&&Xe(C)}function ct(C){const S=C.textures;for(let G=0,ie=S.length;G<ie;G++){const fe=S[G];if(m(fe)){const ne=C.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:t.TEXTURE_2D,Ue=i.get(fe).__webglTexture;n.bindTexture(ne,Ue),u(ne),n.unbindTexture()}}}const tt=[],U=[];function zt(C){if(C.samples>0){if(nt(C)===!1){const S=C.textures,G=C.width,ie=C.height;let fe=t.COLOR_BUFFER_BIT;const ne=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Ue=i.get(C),ye=S.length>1;if(ye)for(let Ae=0;Ae<S.length;Ae++)n.bindFramebuffer(t.FRAMEBUFFER,Ue.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,Ue.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,Ue.__webglMultisampledFramebuffer),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Ue.__webglFramebuffer);for(let Ae=0;Ae<S.length;Ae++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(fe|=t.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(fe|=t.STENCIL_BUFFER_BIT)),ye){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,Ue.__webglColorRenderbuffer[Ae]);const it=i.get(S[Ae]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,it,0)}t.blitFramebuffer(0,0,G,ie,0,0,G,ie,fe,t.NEAREST),l===!0&&(tt.length=0,U.length=0,tt.push(t.COLOR_ATTACHMENT0+Ae),C.depthBuffer&&C.resolveDepthBuffer===!1&&(tt.push(ne),U.push(ne),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,U)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,tt))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),ye)for(let Ae=0;Ae<S.length;Ae++){n.bindFramebuffer(t.FRAMEBUFFER,Ue.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.RENDERBUFFER,Ue.__webglColorRenderbuffer[Ae]);const it=i.get(S[Ae]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,Ue.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.TEXTURE_2D,it,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Ue.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){const S=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[S])}}}function qe(C){return Math.min(r.maxSamples,C.samples)}function nt(C){const S=i.get(C);return C.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function Be(C){const S=o.render.frame;f.get(C)!==S&&(f.set(C,S),C.update())}function ut(C,S){const G=C.colorSpace,ie=C.format,fe=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||G!==br&&G!==cr&&(ht.getTransfer(G)===Et?(ie!==oi||fe!==Xi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",G)),S}function Ge(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(c.width=C.naturalWidth||C.width,c.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(c.width=C.displayWidth,c.height=C.displayHeight):(c.width=C.width,c.height=C.height),c}this.allocateTextureUnit=X,this.resetTextureUnits=w,this.setTexture2D=ee,this.setTexture2DArray=oe,this.setTexture3D=K,this.setTextureCube=ce,this.rebindTextures=Oe,this.setupRenderTarget=ot,this.updateRenderTargetMipmap=ct,this.updateMultisampleRenderTarget=zt,this.setupDepthRenderbuffer=Xe,this.setupFrameBufferTexture=he,this.useMultisampledRTT=nt}function hT(t,e){function n(i,r=cr){let s;const o=ht.getTransfer(r);if(i===Xi)return t.UNSIGNED_BYTE;if(i===gh)return t.UNSIGNED_SHORT_4_4_4_4;if(i===_h)return t.UNSIGNED_SHORT_5_5_5_1;if(i===a_)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===s_)return t.BYTE;if(i===o_)return t.SHORT;if(i===fa)return t.UNSIGNED_SHORT;if(i===mh)return t.INT;if(i===rs)return t.UNSIGNED_INT;if(i===Oi)return t.FLOAT;if(i===_a)return t.HALF_FLOAT;if(i===l_)return t.ALPHA;if(i===c_)return t.RGB;if(i===oi)return t.RGBA;if(i===u_)return t.LUMINANCE;if(i===f_)return t.LUMINANCE_ALPHA;if(i===Ws)return t.DEPTH_COMPONENT;if(i===io)return t.DEPTH_STENCIL;if(i===d_)return t.RED;if(i===vh)return t.RED_INTEGER;if(i===h_)return t.RG;if(i===xh)return t.RG_INTEGER;if(i===yh)return t.RGBA_INTEGER;if(i===Ml||i===El||i===wl||i===Tl)if(o===Et)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Ml)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===El)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===wl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Tl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Ml)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===El)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===wl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Tl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Wf||i===Xf||i===jf||i===Yf)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===Wf)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Xf)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===jf)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Yf)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===qf||i===$f||i===Kf)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===qf||i===$f)return o===Et?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Kf)return o===Et?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Zf||i===Qf||i===Jf||i===ed||i===td||i===nd||i===id||i===rd||i===sd||i===od||i===ad||i===ld||i===cd||i===ud)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Zf)return o===Et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Qf)return o===Et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Jf)return o===Et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===ed)return o===Et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===td)return o===Et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===nd)return o===Et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===id)return o===Et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===rd)return o===Et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===sd)return o===Et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===od)return o===Et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===ad)return o===Et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===ld)return o===Et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===cd)return o===Et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===ud)return o===Et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Al||i===fd||i===dd)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Al)return o===Et?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===fd)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===dd)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===p_||i===hd||i===pd||i===md)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===Al)return s.COMPRESSED_RED_RGTC1_EXT;if(i===hd)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===pd)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===md)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===no?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}class pT extends Hn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Bo extends qt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const mT={type:"move"};class Uu{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Bo,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Bo,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new k,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new k),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Bo,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new k,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new k),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const n=this._hand;if(n)for(const i of e.hand.values())this._getHandJoint(n,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,n,i){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&n.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const x of e.hand.values()){const m=n.getJointPose(x,i),u=this._getHandJoint(c,x);m!==null&&(u.matrix.fromArray(m.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=m.radius),u.visible=m!==null}const f=c.joints["index-finger-tip"],d=c.joints["thumb-tip"],h=f.position.distanceTo(d.position),p=.02,_=.005;c.inputState.pinching&&h>p+_?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&h<=p-_&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=n.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=n.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(mT)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,n){if(e.joints[n.jointName]===void 0){const i=new Bo;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[n.jointName]=i,e.add(i)}return e.joints[n.jointName]}}const gT=`
void main() {
...
}`;class vT{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n,i){if(this.texture===null){const r=new An,s=e.properties.get(r);s.__webglTexture=n.texture,(n.depthNear!=i.depthNear||n.depthFar!=i.depthFar)&&(this.depthNear=n.depthNear,this.depthFar=n.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,i=new ji({vertexShader:gT,fragmentShader:_T,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new St(new mo(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class xT extends fo{constructor(e,n){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,f=null,d=null,h=null,p=null,_=null;const x=new vT,m=n.getContextAttributes();let u=null,g=null;const v=[],M=[],P=new ft;let R=null;const A=new Hn;A.layers.enable(1),A.viewport=new It;const b=new Hn;b.layers.enable(2),b.viewport=new It;const Q=[A,b],y=new pT;y.layers.enable(1),y.layers.enable(2);let w=null,X=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(te){let he=v[te];return he===void 0&&(he=new Uu,v[te]=he),he.getTargetRaySpace()},this.getControllerGrip=function(te){let he=v[te];return he===void 0&&(he=new Uu,v[te]=he),he.getGripSpace()},this.getHand=function(te){let he=v[te];return he===void 0&&(he=new Uu,v[te]=he),he.getHandSpace()};function Y(te){const he=M.indexOf(te.inputSource);if(he===-1)return;const Te=v[he];Te!==void 0&&(Te.update(te.inputSource,te.frame,c||o),Te.dispatchEvent({type:te.type,data:te.inputSource}))}function ee(){r.removeEventListener("select",Y),r.removeEventListener("selectstart",Y),r.removeEventListener("selectend",Y),r.removeEventListener("squeeze",Y),r.removeEventListener("squeezestart",Y),r.removeEventListener("squeezeend",Y),r.removeEventListener("end",ee),r.removeEventListener("inputsourceschange",oe);for(let te=0;te<v.length;te++){const he=M[te];he!==null&&(M[te]=null,v[te].disconnect(he))}w=null,X=null,x.reset(),e.setRenderTarget(u),p=null,h=null,d=null,r=null,g=null,Qe.stop(),i.isPresenting=!1,e.setPixelRatio(R),e.setSize(P.width,P.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(te){s=te,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(te){a=te,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(te){c=te},this.getBaseLayer=function(){return h!==null?h:p},this.getBinding=function(){return d},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(te){if(r=te,r!==null){if(u=e.getRenderTarget(),r.addEventListener("select",Y),r.addEventListener("selectstart",Y),r.addEventListener("selectend",Y),r.addEventListener("squeeze",Y),r.addEventListener("squeezestart",Y),r.addEventListener("squeezeend",Y),r.addEventListener("end",ee),r.addEventListener("inputsourceschange",oe),m.xrCompatible!==!0&&await n.makeXRCompatible(),R=e.getPixelRatio(),e.getSize(P),r.renderState.layers===void 0){const he={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,n,he),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),g=new ss(p.framebufferWidth,p.framebufferHeight,{format:oi,type:Xi,colorSpace:e.outputColorSpace,stencilBuffer:m.stencil})}else{let he=null,Te=null,we=null;m.depth&&(we=m.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,he=m.stencil?io:Ws,Te=m.stencil?no:rs);const Xe={colorFormat:n.RGBA8,depthFormat:we,scaleFactor:s};d=new XRWebGLBinding(r,n),h=d.createProjectionLayer(Xe),r.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),g=new ss(h.textureWidth,h.textureHeight,{format:oi,type:Xi,depthTexture:new R_(h.textureWidth,h.textureHeight,Te,void 0,void 0,void 0,void 0,void 0,void 0,he),stencilBuffer:m.stencil,colorSpace:e.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1})}g.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),Qe.setContext(r),Qe.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return x.getDepthTexture()};function oe(te){for(let he=0;he<te.removed.length;he++){const Te=te.removed[he],we=M.indexOf(Te);we>=0&&(M[we]=null,v[we].disconnect(Te))}for(let he=0;he<te.added.length;he++){const Te=te.added[he];let we=M.indexOf(Te);if(we===-1){for(let Oe=0;Oe<v.length;Oe++)if(Oe>=M.length){M.push(Te),we=Oe;break}else if(M[Oe]===null){M[Oe]=Te,we=Oe;break}if(we===-1)break}const Xe=v[we];Xe&&Xe.connect(Te)}}const K=new k,ce=new k;function I(te,he,Te){K.setFromMatrixPosition(he.matrixWorld),ce.setFromMatrixPosition(Te.matrixWorld);const we=K.distanceTo(ce),Xe=he.projectionMatrix.elements,Oe=Te.projectionMatrix.elements,ot=Xe[14]/(Xe[10]-1),ct=Xe[14]/(Xe[10]+1),tt=(Xe[9]+1)/Xe[5],U=(Xe[9]-1)/Xe[5],zt=(Xe[8]-1)/Xe[0],qe=(Oe[8]+1)/Oe[0],nt=ot*zt,Be=ot*qe,ut=we/(-zt+qe),Ge=ut*-zt;if(he.matrixWorld.decompose(te.position,te.quaternion,te.scale),te.translateX(Ge),te.translateZ(ut),te.matrixWorld.compose(te.position,te.quaternion,te.scale),te.matrixWorldInverse.copy(te.matrixWorld).invert(),Xe[10]===-1)te.projectionMatrix.copy(he.projectionMatrix),te.projectionMatrixInverse.copy(he.projectionMatrixInverse);else{const C=ot+ut,S=ct+ut,G=nt-Ge,ie=Be+(we-Ge),fe=tt*ct/S*C,ne=U*ct/S*C;te.projectionMatrix.makePerspective(G,ie,fe,ne,C,S),te.projectionMatrixInverse.copy(te.projectionMatrix).invert()}}function se(te,he){he===null?te.matrixWorld.copy(te.matrix):te.matrixWorld.multiplyMatrices(he.matrixWorld,te.matrix),te.matrixWorldInverse.copy(te.matrixWorld).invert()}this.updateCamera=function(te){if(r===null)return;let he=te.near,Te=te.far;x.texture!==null&&(x.depthNear>0&&(he=x.depthNear),x.depthFar>0&&(Te=x.depthFar)),y.near=b.near=A.near=he,y.far=b.far=A.far=Te,(w!==y.near||X!==y.far)&&(r.updateRenderState({depthNear:y.near,depthFar:y.far}),w=y.near,X=y.far);const we=te.parent,Xe=y.cameras;se(y,we);for(let Oe=0;Oe<Xe.length;Oe++)se(Xe[Oe],we);Xe.length===2?I(y,A,b):y.projectionMatrix.copy(A.projectionMatrix),re(te,y,we)};function re(te,he,Te){Te===null?te.matrix.copy(he.matrixWorld):(te.matrix.copy(Te.matrixWorld),te.matrix.invert(),te.matrix.multiply(he.matrixWorld)),te.matrix.decompose(te.position,te.quaternion,te.scale),te.updateMatrixWorld(!0),te.projectionMatrix.copy(he.projectionMatrix),te.projectionMatrixInverse.copy(he.projectionMatrixInverse),te.isPerspectiveCamera&&(te.fov=gd*2*Math.atan(1/te.projectionMatrix.elements[5]),te.zoom=1)}this.getCamera=function(){return y},this.getFoveation=function(){if(!(h===null&&p===null))return l},this.setFoveation=function(te){l=te,h!==null&&(h.fixedFoveation=te),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=te)},this.hasDepthSensing=function(){return x.texture!==null},this.getDepthSensingMesh=function(){return x.getMesh(y)};let ve=null;function Fe(te,he){if(f=he.getViewerPose(c||o),_=he,f!==null){const Te=f.views;p!==null&&(e.setRenderTargetFramebuffer(g,p.framebuffer),e.setRenderTarget(g));let we=!1;Te.length!==y.cameras.length&&(y.cameras.length=0,we=!0);for(let Oe=0;Oe<Te.length;Oe++){const ot=Te[Oe];let ct=null;if(p!==null)ct=p.getViewport(ot);else{const U=d.getViewSubImage(h,ot);ct=U.viewport,Oe===0&&(e.setRenderTargetTextures(g,U.colorTexture,h.ignoreDepthValues?void 0:U.depthStencilTexture),e.setRenderTarget(g))}let tt=Q[Oe];tt===void 0&&(tt=new Hn,tt.layers.enable(Oe),tt.viewport=new It,Q[Oe]=tt),tt.matrix.fromArray(ot.transform.matrix),tt.matrix.decompose(tt.position,tt.quaternion,tt.scale),tt.projectionMatrix.fromArray(ot.projectionMatrix),tt.projectionMatrixInverse.copy(tt.projectionMatrix).invert(),tt.viewport.set(ct.x,ct.y,ct.width,ct.height),Oe===0&&(y.matrix.copy(tt.matrix),y.matrix.decompose(y.position,y.quaternion,y.scale)),we===!0&&y.cameras.push(tt)}const Xe=r.enabledFeatures;if(Xe&&Xe.includes("depth-sensing")){const Oe=d.getDepthInformation(Te[0]);Oe&&Oe.isValid&&Oe.texture&&x.init(e,Oe,r.renderState)}}for(let Te=0;Te<v.length;Te++){const we=M[Te],Xe=v[Te];we!==null&&Xe!==void 0&&Xe.update(we,he,c||o)}ve&&ve(te,he),he.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:he}),_=null}const Qe=new A_;Qe.setAnimationLoop(Fe),this.setAnimationLoop=function(te){ve=te},this.dispose=function(){}}}const Br=new Mi,yT=new Ct;function ST(t,e){function n(m,u){m.matrixAutoUpdate===!0&&m.updateMatrix(),u.value.copy(m.matrix)}function i(m,u){u.color.getRGB(m.fogColor.value,E_(t)),u.isFog?(m.fogNear.value=u.near,m.fogFar.value=u.far):u.isFogExp2&&(m.fogDensity.value=u.density)}function r(m,u,g,v,M){u.isMeshBasicMaterial||u.isMeshLambertMaterial?s(m,u):u.isMeshToonMaterial?(s(m,u),d(m,u)):u.isMeshPhongMaterial?(s(m,u),f(m,u)):u.isMeshStandardMaterial?(s(m,u),h(m,u),u.isMeshPhysicalMaterial&&p(m,u,M)):u.isMeshMatcapMaterial?(s(m,u),_(m,u)):u.isMeshDepthMaterial?s(m,u):u.isMeshDistanceMaterial?(s(m,u),x(m,u)):u.isMeshNormalMaterial?s(m,u):u.isLineBasicMaterial?(o(m,u),u.isLineDashedMaterial&&a(m,u)):u.isPointsMaterial?l(m,u,g,v):u.isSpriteMaterial?c(m,u):u.isShadowMaterial?(m.color.value.copy(u.color),m.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function s(m,u){m.opacity.value=u.opacity,u.color&&m.diffuse.value.copy(u.color),u.emissive&&m.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(m.map.value=u.map,n(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,n(u.alphaMap,m.alphaMapTransform)),u.bumpMap&&(m.bumpMap.value=u.bumpMap,n(u.bumpMap,m.bumpMapTransform),m.bumpScale.value=u.bumpScale,u.side===Tn&&(m.bumpScale.value*=-1)),u.normalMap&&(m.normalMap.value=u.normalMap,n(u.normalMap,m.normalMapTransform),m.normalScale.value.copy(u.normalScale),u.side===Tn&&m.normalScale.value.negate()),u.displacementMap&&(m.displacementMap.value=u.displacementMap,n(u.displacementMap,m.displacementMapTransform),m.displacementScale.value=u.displacementScale,m.displacementBias.value=u.displacementBias),u.emissiveMap&&(m.emissiveMap.value=u.emissiveMap,n(u.emissiveMap,m.emissiveMapTransform)),u.specularMap&&(m.specularMap.value=u.specularMap,n(u.specularMap,m.specularMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest);const g=e.get(u),v=g.envMap,M=g.envMapRotation;v&&(m.envMap.value=v,Br.copy(M),Br.x*=-1,Br.y*=-1,Br.z*=-1,v.isCubeTexture&&v.isRenderTargetTexture===!1&&(Br.y*=-1,Br.z*=-1),m.envMapRotation.value.setFromMatrix4(yT.makeRotationFromEuler(Br)),m.flipEnvMap.value=v.isCubeTexture&&v.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=u.reflectivity,m.ior.value=u.ior,m.refractionRatio.value=u.refractionRatio),u.lightMap&&(m.lightMap.value=u.lightMap,m.lightMapIntensity.value=u.lightMapIntensity,n(u.lightMap,m.lightMapTransform)),u.aoMap&&(m.aoMap.value=u.aoMap,m.aoMapIntensity.value=u.aoMapIntensity,n(u.aoMap,m.aoMapTransform))}function o(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,u.map&&(m.map.value=u.map,n(u.map,m.mapTransform))}function a(m,u){m.dashSize.value=u.dashSize,m.totalSize.value=u.dashSize+u.gapSize,m.scale.value=u.scale}function l(m,u,g,v){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.size.value=u.size*g,m.scale.value=v*.5,u.map&&(m.map.value=u.map,n(u.map,m.uvTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,n(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function c(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.rotation.value=u.rotation,u.map&&(m.map.value=u.map,n(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,n(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function f(m,u){m.specular.value.copy(u.specular),m.shininess.value=Math.max(u.shininess,1e-4)}function d(m,u){u.gradientMap&&(m.gradientMap.value=u.gradientMap)}function h(m,u){m.metalness.value=u.metalness,u.metalnessMap&&(m.metalnessMap.value=u.metalnessMap,n(u.metalnessMap,m.metalnessMapTransform)),m.roughness.value=u.roughness,u.roughnessMap&&(m.roughnessMap.value=u.roughnessMap,n(u.roughnessMap,m.roughnessMapTransform)),u.envMap&&(m.envMapIntensity.value=u.envMapIntensity)}function p(m,u,g){m.ior.value=u.ior,u.sheen>0&&(m.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),m.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(m.sheenColorMap.value=u.sheenColorMap,n(u.sheenColorMap,m.sheenColorMapTransform)),u.sheenRoughnessMap&&(m.sheenRoughnessMap.value=u.sheenRoughnessMap,n(u.sheenRoughnessMap,m.sheenRoughnessMapTransform))),u.clearcoat>0&&(m.clearcoat.value=u.clearcoat,m.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(m.clearcoatMap.value=u.clearcoatMap,n(u.clearcoatMap,m.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,n(u.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(m.clearcoatNormalMap.value=u.clearcoatNormalMap,n(u.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===Tn&&m.clearcoatNormalScale.value.negate())),u.dispersion>0&&(m.dispersion.value=u.dispersion),u.iridescence>0&&(m.iridescence.value=u.iridescence,m.iridescenceIOR.value=u.iridescenceIOR,m.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(m.iridescenceMap.value=u.iridescenceMap,n(u.iridescenceMap,m.iridescenceMapTransform)),u.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=u.iridescenceThicknessMap,n(u.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),u.transmission>0&&(m.transmission.value=u.transmission,m.transmissionSamplerMap.value=g.texture,m.transmissionSamplerSize.value.set(g.width,g.height),u.transmissionMap&&(m.transmissionMap.value=u.transmissionMap,n(u.transmissionMap,m.transmissionMapTransform)),m.thickness.value=u.thickness,u.thicknessMap&&(m.thicknessMap.value=u.thicknessMap,n(u.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=u.attenuationDistance,m.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(m.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(m.anisotropyMap.value=u.anisotropyMap,n(u.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=u.specularIntensity,m.specularColor.value.copy(u.specularColor),u.specularColorMap&&(m.specularColorMap.value=u.specularColorMap,n(u.specularColorMap,m.specularColorMapTransform)),u.specularIntensityMap&&(m.specularIntensityMap.value=u.specularIntensityMap,n(u.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,u){u.matcap&&(m.matcap.value=u.matcap)}function x(m,u){const g=e.get(u).light;m.referencePosition.value.setFromMatrixPosition(g.matrixWorld),m.nearDistance.value=g.shadow.camera.near,m.farDistance.value=g.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function MT(t,e,n,i){let r={},s={},o=[];const a=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(g,v){const M=v.program;i.uniformBlockBinding(g,M)}function c(g,v){let M=r[g.id];M===void 0&&(_(g),M=f(g),r[g.id]=M,g.addEventListener("dispose",m));const P=v.program;i.updateUBOMapping(g,P);const R=e.render.frame;s[g.id]!==R&&(h(g),s[g.id]=R)}function f(g){const v=d();g.__bindingPointIndex=v;const M=t.createBuffer(),P=g.__size,R=g.usage;return t.bindBuffer(t.UNIFORM_BUFFER,M),t.bufferData(t.UNIFORM_BUFFER,P,R),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,v,M),M}function d(){for(let g=0;g<a;g++)if(o.indexOf(g)===-1)return o.push(g),g;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(g){const v=r[g.id],M=g.uniforms,P=g.__cache;t.bindBuffer(t.UNIFORM_BUFFER,v);for(let R=0,A=M.length;R<A;R++){const b=Array.isArray(M[R])?M[R]:[M[R]];for(let Q=0,y=b.length;Q<y;Q++){const w=b[Q];if(p(w,R,Q,P)===!0){const X=w.__offset,Y=Array.isArray(w.value)?w.value:[w.value];let ee=0;for(let oe=0;oe<Y.length;oe++){const K=Y[oe],ce=x(K);typeof K=="number"||typeof K=="boolean"?(w.__data[0]=K,t.bufferSubData(t.UNIFORM_BUFFER,X+ee,w.__data)):K.isMatrix3?(w.__data[0]=K.elements[0],w.__data[1]=K.elements[1],w.__data[2]=K.elements[2],w.__data[3]=0,w.__data[4]=K.elements[3],w.__data[5]=K.elements[4],w.__data[6]=K.elements[5],w.__data[7]=0,w.__data[8]=K.elements[6],w.__data[9]=K.elements[7],w.__data[10]=K.elements[8],w.__data[11]=0):(K.toArray(w.__data,ee),ee+=ce.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,X,w.__data)}}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function p(g,v,M,P){const R=g.value,A=v+"_"+M;if(P[A]===void 0)return typeof R=="number"||typeof R=="boolean"?P[A]=R:P[A]=R.clone(),!0;{const b=P[A];if(typeof R=="number"||typeof R=="boolean"){if(b!==R)return P[A]=R,!0}else if(b.equals(R)===!1)return b.copy(R),!0}return!1}function _(g){const v=g.uniforms;let M=0;const P=16;for(let A=0,b=v.length;A<b;A++){const Q=Array.isArray(v[A])?v[A]:[v[A]];for(let y=0,w=Q.length;y<w;y++){const X=Q[y],Y=Array.isArray(X.value)?X.value:[X.value];for(let ee=0,oe=Y.length;ee<oe;ee++){const K=Y[ee],ce=x(K),I=M%P,se=I%ce.boundary,re=I+se;M+=se,re!==0&&P-re<ce.storage&&(M+=P-re),X.__data=new Float32Array(ce.storage/Float32Array.BYTES_PER_ELEMENT),X.__offset=M,M+=ce.storage}}}const R=M%P;return R>0&&(M+=P-R),g.__size=M,g.__cache={},this}function x(g){const v={boundary:0,storage:0};return typeof g=="number"||typeof g=="boolean"?(v.boundary=4,v.storage=4):g.isVector2?(v.boundary=8,v.storage=8):g.isVector3||g.isColor?(v.boundary=16,v.storage=12):g.isVector4?(v.boundary=16,v.storage=16):g.isMatrix3?(v.boundary=48,v.storage=48):g.isMatrix4?(v.boundary=64,v.storage=64):g.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",g),v}function m(g){const v=g.target;v.removeEventListener("dispose",m);const M=o.indexOf(v.__bindingPointIndex);o.splice(M,1),t.deleteBuffer(r[v.id]),delete r[v.id],delete s[v.id]}function u(){for(const g in r)t.deleteBuffer(r[g]);o=[],r={},s={}}return{bind:l,update:c,dispose:u}}class ET{constructor(e={}){const{canvas:n=uS(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:f="default",failIfMajorPerformanceCaveat:d=!1}=e;this.isWebGLRenderer=!0;let h;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");h=i.getContextAttributes().alpha}else h=o;const p=new Uint32Array(4),_=new Int32Array(4);let x=null,m=null;const u=[],g=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=ni,this.toneMapping=Mr,this.toneMappingExposure=1;const v=this;let M=!1,P=0,R=0,A=null,b=-1,Q=null;const y=new It,w=new It;let X=null;const Y=new ze(0);let ee=0,oe=n.width,K=n.height,ce=1,I=null,se=null;const re=new It(0,0,oe,K),ve=new It(0,0,oe,K);let Fe=!1;const Qe=new wh;let te=!1,he=!1;const Te=new Ct,we=new Ct,Xe=new k,Oe=new It,ot={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ct=!1;function tt(){return A===null?ce:1}let U=i;function zt(E,F){return n.getContext(E,F)}try{const E={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:f,failIfMajorPerformanceCaveat:d};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${hh}`),n.addEventListener("webglcontextlost",V,!1),n.addEventListener("webglcontextrestored",ae,!1),n.addEventListener("webglcontextcreationerror",xe,!1),U===null){const F="webgl2";if(U=zt(F,E),U===null)throw zt(F)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(E){throw console.error("THREE.WebGLRenderer: "+E.message),E}let qe,nt,Be,ut,Ge,C,S,G,ie,fe,ne,Ue,ye,Ae,it,_e,Ce,He,Ve,D,z,H,j,T;function N(){qe=new RE(U),qe.init(),H=new hT(U,qe),nt=new ME(U,qe,e,H),Be=new uT(U),nt.reverseDepthBuffer&&Be.buffers.depth.setReversed(!0),ut=new DE(U),Ge=new $w,C=new dT(U,qe,Be,Ge,nt,H,ut),S=new wE(v),G=new CE(v),ie=new BS(U),j=new yE(U,ie),fe=new PE(U,ie,ut,j),ne=new UE(U,fe,ie,ut),Ve=new LE(U,nt,C),_e=new EE(Ge),Ue=new qw(v,S,G,qe,nt,j,_e),ye=new ST(v,Ge),Ae=new Zw,it=new iT(qe),He=new xE(v,S,G,Be,ne,h,l),Ce=new lT(v,ne,nt),T=new MT(U,ut,nt,Be),D=new SE(U,qe,ut),z=new bE(U,qe,ut),ut.programs=Ue.programs,v.capabilities=nt,v.extensions=qe,v.properties=Ge,v.renderLists=Ae,v.shadowMap=Ce,v.state=Be,v.info=ut}N();const L=new xT(v,U);this.xr=L,this.getContext=function(){return U},this.getContextAttributes=function(){return U.getContextAttributes()},this.forceContextLoss=function(){const E=qe.get("WEBGL_lose_context");E&&E.loseContext()},this.forceContextRestore=function(){const E=qe.get("WEBGL_lose_context");E&&E.restoreContext()},this.getPixelRatio=function(){return ce},this.setPixelRatio=function(E){E!==void 0&&(ce=E,this.setSize(oe,K,!1))},this.getSize=function(E){return E.set(oe,K)},this.setSize=function(E,F,O=!0){if(L.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}oe=E,K=F,n.width=Math.floor(E*ce),n.height=Math.floor(F*ce),O===!0&&(n.style.width=E+"px",n.style.height=F+"px"),this.setViewport(0,0,E,F)},this.getDrawingBufferSize=function(E){return E.set(oe*ce,K*ce).floor()},this.setDrawingBufferSize=function(E,F,O){oe=E,K=F,ce=O,n.width=Math.floor(E*O),n.height=Math.floor(F*O),this.setViewport(0,0,E,F)},this.getCurrentViewport=function(E){return E.copy(y)},this.getViewport=function(E){return E.copy(re)},this.setViewport=function(E,F,O,q){E.isVector4?re.set(E.x,E.y,E.z,E.w):re.set(E,F,O,q),Be.viewport(y.copy(re).multiplyScalar(ce).round())},this.getScissor=function(E){return E.copy(ve)},this.setScissor=function(E,F,O,q){E.isVector4?ve.set(E.x,E.y,E.z,E.w):ve.set(E,F,O,q),Be.scissor(w.copy(ve).multiplyScalar(ce).round())},this.getScissorTest=function(){return Fe},this.setScissorTest=function(E){Be.setScissorTest(Fe=E)},this.setOpaqueSort=function(E){I=E},this.setTransparentSort=function(E){se=E},this.getClearColor=function(E){return E.copy(He.getClearColor())},this.setClearColor=function(){He.setClearColor.apply(He,arguments)},this.getClearAlpha=function(){return He.getClearAlpha()},this.setClearAlpha=function(){He.setClearAlpha.apply(He,arguments)},this.clear=function(E=!0,F=!0,O=!0){let q=0;if(E){let B=!1;if(A!==null){const ge=A.texture.format;B=ge===yh||ge===xh||ge===vh}if(B){const ge=A.texture.type,W=ge===Xi||ge===rs||ge===fa||ge===no||ge===gh||ge===_h,$=He.getClearColor(),Z=He.getClearAlpha(),le=$.r,me=$.g,ue=$.b;W?(p[0]=le,p[1]=me,p[2]=ue,p[3]=Z,U.clearBufferuiv(U.COLOR,0,p)):(_[0]=le,_[1]=me,_[2]=ue,_[3]=Z,U.clearBufferiv(U.COLOR,0,_))}else q|=U.COLOR_BUFFER_BIT}F&&(q|=U.DEPTH_BUFFER_BIT,U.clearDepth(this.capabilities.reverseDepthBuffer?0:1)),O&&(q|=U.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),U.clear(q)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",V,!1),n.removeEventListener("webglcontextrestored",ae,!1),n.removeEventListener("webglcontextcreationerror",xe,!1),Ae.dispose(),it.dispose(),Ge.dispose(),S.dispose(),G.dispose(),ne.dispose(),j.dispose(),T.dispose(),Ue.dispose(),L.dispose(),L.removeEventListener("sessionstart",mn),L.removeEventListener("sessionend",Nt),je.stop()};function V(E){E.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),M=!0}function ae(){console.log("THREE.WebGLRenderer: Context Restored."),M=!1;const E=ut.autoReset,F=Ce.enabled,O=Ce.autoUpdate,q=Ce.needsUpdate,B=Ce.type;N(),ut.autoReset=E,Ce.enabled=F,Ce.autoUpdate=O,Ce.needsUpdate=q,Ce.type=B}function xe(E){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",E.statusMessage)}function ke(E){const F=E.target;F.removeEventListener("dispose",ke),at(F)}function at(E){gt(E),Ge.remove(E)}function gt(E){const F=Ge.get(E).programs;F!==void 0&&(F.forEach(function(O){Ue.releaseProgram(O)}),E.isShaderMaterial&&Ue.releaseShaderCache(E))}this.renderBufferDirect=function(E,F,O,q,B,ge){F===null&&(F=ot);const W=B.isMesh&&B.matrixWorld.determinant()<0,$=Ai(E,F,O,q,B);Be.setMaterial(q,W);let Z=O.index,le=1;if(q.wireframe===!0){if(Z=fe.getWireframeAttribute(O),Z===void 0)return;le=2}const me=O.drawRange,ue=O.attributes.position;let Pe=me.start*le,De=(me.start+me.count)*le;ge!==null&&(Pe=Math.max(Pe,ge.start*le),De=Math.min(De,(ge.start+ge.count)*le)),Z!==null?(Pe=Math.max(Pe,0),De=Math.min(De,Z.count)):ue!=null&&(Pe=Math.max(Pe,0),De=Math.min(De,ue.count));const Le=De-Pe;if(Le<0||Le===1/0)return;j.setup(B,q,$,O,Z);let vt,We=D;if(Z!==null&&(vt=ie.get(Z),We=z,We.setIndex(vt)),B.isMesh)q.wireframe===!0?(Be.setLineWidth(q.wireframeLinewidth*tt()),We.setMode(U.LINES)):We.setMode(U.TRIANGLES);else if(B.isLine){let Me=q.linewidth;Me===void 0&&(Me=1),Be.setLineWidth(Me*tt()),B.isLineSegments?We.setMode(U.LINES):B.isLineLoop?We.setMode(U.LINE_LOOP):We.setMode(U.LINE_STRIP)}else B.isPoints?We.setMode(U.POINTS):B.isSprite&&We.setMode(U.TRIANGLES);if(B.isBatchedMesh)if(B._multiDrawInstances!==null)We.renderMultiDrawInstances(B._multiDrawStarts,B._multiDrawCounts,B._multiDrawCount,B._multiDrawInstances);else if(qe.get("WEBGL_multi_draw"))We.renderMultiDraw(B._multiDrawStarts,B._multiDrawCounts,B._multiDrawCount);else{const Me=B._multiDrawStarts,_t=B._multiDrawCounts,Je=B._multiDrawCount,cn=Z?ie.get(Z).bytesPerElement:1,Qt=Ge.get(q).currentProgram.getUniforms();for(let Cn=0;Cn<Je;Cn++)Qt.setValue(U,"_gl_DrawID",Cn),We.render(Me[Cn]/cn,_t[Cn])}else if(B.isInstancedMesh)We.renderInstances(Pe,Le,B.count);else if(O.isInstancedBufferGeometry){const Me=O._maxInstanceCount!==void 0?O._maxInstanceCount:1/0,_t=Math.min(O.instanceCount,Me);We.renderInstances(Pe,Le,_t)}else We.render(Pe,Le)};function $e(E,F,O){E.transparent===!0&&E.side===ri&&E.forceSinglePass===!1?(E.side=Tn,E.needsUpdate=!0,wi(E,F,O),E.side=Ar,E.needsUpdate=!0,wi(E,F,O),E.side=ri):wi(E,F,O)}this.compile=function(E,F,O=null){O===null&&(O=E),m=it.get(O),m.init(F),g.push(m),O.traverseVisible(function(B){B.isLight&&B.layers.test(F.layers)&&(m.pushLight(B),B.castShadow&&m.pushShadow(B))}),E!==O&&E.traverseVisible(function(B){B.isLight&&B.layers.test(F.layers)&&(m.pushLight(B),B.castShadow&&m.pushShadow(B))}),m.setupLights();const q=new Set;return E.traverse(function(B){if(!(B.isMesh||B.isPoints||B.isLine||B.isSprite))return;const ge=B.material;if(ge)if(Array.isArray(ge))for(let W=0;W<ge.length;W++){const $=ge[W];$e($,O,B),q.add($)}else $e(ge,O,B),q.add(ge)}),g.pop(),m=null,q},this.compileAsync=function(E,F,O=null){const q=this.compile(E,F,O);return new Promise(B=>{function ge(){if(q.forEach(function(W){Ge.get(W).currentProgram.isReady()&&q.delete(W)}),q.size===0){B(E);return}setTimeout(ge,10)}qe.get("KHR_parallel_shader_compile")!==null?ge():setTimeout(ge,10)})};let Rt=null;function dt(E){Rt&&Rt(E)}function mn(){je.stop()}function Nt(){je.start()}const je=new A_;je.setAnimationLoop(dt),typeof self<"u"&&je.setContext(self),this.setAnimationLoop=function(E){Rt=E,L.setAnimationLoop(E),E===null?je.stop():je.start()},L.addEventListener("sessionstart",mn),L.addEventListener("sessionend",Nt),this.render=function(E,F){if(F!==void 0&&F.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(M===!0)return;if(E.matrixWorldAutoUpdate===!0&&E.updateMatrixWorld(),F.parent===null&&F.matrixWorldAutoUpdate===!0&&F.updateMatrixWorld(),L.enabled===!0&&L.isPresenting===!0&&(L.cameraAutoUpdate===!0&&L.updateCamera(F),F=L.getCamera()),E.isScene===!0&&E.onBeforeRender(v,E,F,A),m=it.get(E,g.length),m.init(F),g.push(m),we.multiplyMatrices(F.projectionMatrix,F.matrixWorldInverse),Qe.setFromProjectionMatrix(we),he=this.localClippingEnabled,te=_e.init(this.clippingPlanes,he),x=Ae.get(E,u.length),x.init(),u.push(x),L.enabled===!0&&L.isPresenting===!0){const ge=v.xr.getDepthSensingMesh();ge!==null&&gn(ge,F,-1/0,v.sortObjects)}gn(E,F,0,v.sortObjects),x.finish(),v.sortObjects===!0&&x.sort(I,se),ct=L.enabled===!1||L.isPresenting===!1||L.hasDepthSensing()===!1,ct&&He.addToRenderList(x,E),this.info.render.frame++,te===!0&&_e.beginShadows();const O=m.state.shadowsArray;Ce.render(O,E,F),te===!0&&_e.endShadows(),this.info.autoReset===!0&&this.info.reset();const q=x.opaque,B=x.transmissive;if(m.setupLights(),F.isArrayCamera){const ge=F.cameras;if(B.length>0)for(let W=0,$=ge.length;W<$;W++){const Z=ge[W];di(q,B,E,Z)}ct&&He.render(E);for(let W=0,$=ge.length;W<$;W++){const Z=ge[W];ln(x,E,Z,Z.viewport)}}else B.length>0&&di(q,B,E,F),ct&&He.render(E),ln(x,E,F);A!==null&&(C.updateMultisampleRenderTarget(A),C.updateRenderTargetMipmap(A)),E.isScene===!0&&E.onAfterRender(v,E,F),j.resetDefaultState(),b=-1,Q=null,g.pop(),g.length>0?(m=g[g.length-1],te===!0&&_e.setGlobalState(v.clippingPlanes,m.state.camera)):m=null,u.pop(),u.length>0?x=u[u.length-1]:x=null};function gn(E,F,O,q){if(E.visible===!1)return;if(E.layers.test(F.layers)){if(E.isGroup)O=E.renderOrder;else if(E.isLOD)E.autoUpdate===!0&&E.update(F);else if(E.isLight)m.pushLight(E),E.castShadow&&m.pushShadow(E);else if(E.isSprite){if(!E.frustumCulled||Qe.intersectsSprite(E)){q&&Oe.setFromMatrixPosition(E.matrixWorld).applyMatrix4(we);const W=ne.update(E),$=E.material;$.visible&&x.push(E,W,$,O,Oe.z,null)}}else if((E.isMesh||E.isLine||E.isPoints)&&(!E.frustumCulled||Qe.intersectsObject(E))){const W=ne.update(E),$=E.material;if(q&&(E.boundingSphere!==void 0?(E.boundingSphere===null&&E.computeBoundingSphere(),Oe.copy(E.boundingSphere.center)):(W.boundingSphere===null&&W.computeBoundingSphere(),Oe.copy(W.boundingSphere.center)),Oe.applyMatrix4(E.matrixWorld).applyMatrix4(we)),Array.isArray($)){const Z=W.groups;for(let le=0,me=Z.length;le<me;le++){const ue=Z[le],Pe=$[ue.materialIndex];Pe&&Pe.visible&&x.push(E,W,Pe,O,Oe.z,ue)}}else $.visible&&x.push(E,W,$,O,Oe.z,null)}}const ge=E.children;for(let W=0,$=ge.length;W<$;W++)gn(ge[W],F,O,q)}function ln(E,F,O,q){const B=E.opaque,ge=E.transmissive,W=E.transparent;m.setupLightsView(O),te===!0&&_e.setGlobalState(v.clippingPlanes,O),q&&Be.viewport(y.copy(q)),B.length>0&&hi(B,F,O),ge.length>0&&hi(ge,F,O),W.length>0&&hi(W,F,O),Be.buffers.depth.setTest(!0),Be.buffers.depth.setMask(!0),Be.buffers.color.setMask(!0),Be.setPolygonOffset(!1)}function di(E,F,O,q){if((O.isScene===!0?O.overrideMaterial:null)!==null)return;m.state.transmissionRenderTarget[q.id]===void 0&&(m.state.transmissionRenderTarget[q.id]=new ss(1,1,{generateMipmaps:!0,type:qe.has("EXT_color_buffer_half_float")||qe.has("EXT_color_buffer_float")?_a:Xi,minFilter:Kr,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ht.workingColorSpace}));const ge=m.state.transmissionRenderTarget[q.id],W=q.viewport||y;ge.setSize(W.z,W.w);const $=v.getRenderTarget();v.setRenderTarget(ge),v.getClearColor(Y),ee=v.getClearAlpha(),ee<1&&v.setClearColor(16777215,.5),v.clear(),ct&&He.render(O);const Z=v.toneMapping;v.toneMapping=Mr;const le=q.viewport;if(q.viewport!==void 0&&(q.viewport=void 0),m.setupLightsView(q),te===!0&&_e.setGlobalState(v.clippingPlanes,q),hi(E,O,q),C.updateMultisampleRenderTarget(ge),C.updateRenderTargetMipmap(ge),qe.has("WEBGL_multisampled_render_to_texture")===!1){let me=!1;for(let ue=0,Pe=F.length;ue<Pe;ue++){const De=F[ue],Le=De.object,vt=De.geometry,We=De.material,Me=De.group;if(We.side===ri&&Le.layers.test(q.layers)){const _t=We.side;We.side=Tn,We.needsUpdate=!0,_n(Le,O,q,vt,We,Me),We.side=_t,We.needsUpdate=!0,me=!0}}me===!0&&(C.updateMultisampleRenderTarget(ge),C.updateRenderTargetMipmap(ge))}v.setRenderTarget($),v.setClearColor(Y,ee),le!==void 0&&(q.viewport=le),v.toneMapping=Z}function hi(E,F,O){const q=F.isScene===!0?F.overrideMaterial:null;for(let B=0,ge=E.length;B<ge;B++){const W=E[B],$=W.object,Z=W.geometry,le=q===null?W.material:q,me=W.group;$.layers.test(O.layers)&&_n($,F,O,Z,le,me)}}function _n(E,F,O,q,B,ge){E.onBeforeRender(v,F,O,q,B,ge),E.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,E.matrixWorld),E.normalMatrix.getNormalMatrix(E.modelViewMatrix),B.onBeforeRender(v,F,O,q,E,ge),B.transparent===!0&&B.side===ri&&B.forceSinglePass===!1?(B.side=Tn,B.needsUpdate=!0,v.renderBufferDirect(O,F,q,B,E,ge),B.side=Ar,B.needsUpdate=!0,v.renderBufferDirect(O,F,q,B,E,ge),B.side=ri):v.renderBufferDirect(O,F,q,B,E,ge),E.onAfterRender(v,F,O,q,B,ge)}function wi(E,F,O){F.isScene!==!0&&(F=ot);const q=Ge.get(E),B=m.state.lights,ge=m.state.shadowsArray,W=B.state.version,$=Ue.getParameters(E,B.state,ge,F,O),Z=Ue.getProgramCacheKey($);let le=q.programs;q.environment=E.isMeshStandardMaterial?F.environment:null,q.fog=F.fog,q.envMap=(E.isMeshStandardMaterial?G:S).get(E.envMap||q.environment),q.envMapRotation=q.environment!==null&&E.envMap===null?F.environmentRotation:E.envMapRotation,le===void 0&&(E.addEventListener("dispose",ke),le=new Map,q.programs=le);let me=le.get(Z);if(me!==void 0){if(q.currentProgram===me&&q.lightsStateVersion===W)return ls(E,$),me}else $.uniforms=Ue.getUniforms(E),E.onBeforeCompile($,v),me=Ue.acquireProgram($,Z),le.set(Z,me),q.uniforms=$.uniforms;const ue=q.uniforms;return(!E.isShaderMaterial&&!E.isRawShaderMaterial||E.clipping===!0)&&(ue.clippingPlanes=_e.uniform),ls(E,$),q.needsLights=qi(E),q.lightsStateVersion=W,q.needsLights&&(ue.ambientLightColor.value=B.state.ambient,ue.lightProbe.value=B.state.probe,ue.directionalLights.value=B.state.directional,ue.directionalLightShadows.value=B.state.directionalShadow,ue.spotLights.value=B.state.spot,ue.spotLightShadows.value=B.state.spotShadow,ue.rectAreaLights.value=B.state.rectArea,ue.ltc_1.value=B.state.rectAreaLTC1,ue.ltc_2.value=B.state.rectAreaLTC2,ue.pointLights.value=B.state.point,ue.pointLightShadows.value=B.state.pointShadow,ue.hemisphereLights.value=B.state.hemi,ue.directionalShadowMap.value=B.state.directionalShadowMap,ue.directionalShadowMatrix.value=B.state.directionalShadowMatrix,ue.spotShadowMap.value=B.state.spotShadowMap,ue.spotLightMatrix.value=B.state.spotLightMatrix,ue.spotLightMap.value=B.state.spotLightMap,ue.pointShadowMap.value=B.state.pointShadowMap,ue.pointShadowMatrix.value=B.state.pointShadowMatrix),q.currentProgram=me,q.uniformsList=null,me}function Ti(E){if(E.uniformsList===null){const F=E.currentProgram.getUniforms();E.uniformsList=Pl.seqWithValue(F.seq,E.uniforms)}return E.uniformsList}function ls(E,F){const O=Ge.get(E);O.outputColorSpace=F.outputColorSpace,O.batching=F.batching,O.batchingColor=F.batchingColor,O.instancing=F.instancing,O.instancingColor=F.instancingColor,O.instancingMorph=F.instancingMorph,O.skinning=F.skinning,O.morphTargets=F.morphTargets,O.morphNormals=F.morphNormals,O.morphColors=F.morphColors,O.morphTargetsCount=F.morphTargetsCount,O.numClippingPlanes=F.numClippingPlanes,O.numIntersection=F.numClipIntersection,O.vertexAlphas=F.vertexAlphas,O.vertexTangents=F.vertexTangents,O.toneMapping=F.toneMapping}function Ai(E,F,O,q,B){F.isScene!==!0&&(F=ot),C.resetTextureUnits();const ge=F.fog,W=q.isMeshStandardMaterial?F.environment:null,$=A===null?v.outputColorSpace:A.isXRRenderTarget===!0?A.texture.colorSpace:br,Z=(q.isMeshStandardMaterial?G:S).get(q.envMap||W),le=q.vertexColors===!0&&!!O.attributes.color&&O.attributes.color.itemSize===4,me=!!O.attributes.tangent&&(!!q.normalMap||q.anisotropy>0),ue=!!O.morphAttributes.position,Pe=!!O.morphAttributes.normal,De=!!O.morphAttributes.color;let Le=Mr;q.toneMapped&&(A===null||A.isXRRenderTarget===!0)&&(Le=v.toneMapping);const vt=O.morphAttributes.position||O.morphAttributes.normal||O.morphAttributes.color,We=vt!==void 0?vt.length:0,Me=Ge.get(q),_t=m.state.lights;if(te===!0&&(he===!0||E!==Q)){const On=E===Q&&q.id===b;_e.setState(q,E,On)}let Je=!1;q.version===Me.__version?(Me.needsLights&&Me.lightsStateVersion!==_t.state.version||Me.outputColorSpace!==$||B.isBatchedMesh&&Me.batching===!1||!B.isBatchedMesh&&Me.batching===!0||B.isBatchedMesh&&Me.batchingColor===!0&&B.colorTexture===null||B.isBatchedMesh&&Me.batchingColor===!1&&B.colorTexture!==null||B.isInstancedMesh&&Me.instancing===!1||!B.isInstancedMesh&&Me.instancing===!0||B.isSkinnedMesh&&Me.skinning===!1||!B.isSkinnedMesh&&Me.skinning===!0||B.isInstancedMesh&&Me.instancingColor===!0&&B.instanceColor===null||B.isInstancedMesh&&Me.instancingColor===!1&&B.instanceColor!==null||B.isInstancedMesh&&Me.instancingMorph===!0&&B.morphTexture===null||B.isInstancedMesh&&Me.instancingMorph===!1&&B.morphTexture!==null||Me.envMap!==Z||q.fog===!0&&Me.fog!==ge||Me.numClippingPlanes!==void 0&&(Me.numClippingPlanes!==_e.numPlanes||Me.numIntersection!==_e.numIntersection)||Me.vertexAlphas!==le||Me.vertexTangents!==me||Me.morphTargets!==ue||Me.morphNormals!==Pe||Me.morphColors!==De||Me.toneMapping!==Le||Me.morphTargetsCount!==We)&&(Je=!0):(Je=!0,Me.__version=q.version);let cn=Me.currentProgram;Je===!0&&(cn=wi(q,F,B));let Qt=!1,Cn=!1,Rc=!1;const Ft=cn.getUniforms(),$i=Me.uniforms;if(Be.useProgram(cn.program)&&(Qt=!0,Cn=!0,Rc=!0),q.id!==b&&(b=q.id,Cn=!0),Qt||Q!==E){nt.reverseDepthBuffer?(Te.copy(E.projectionMatrix),dS(Te),hS(Te),Ft.setValue(U,"projectionMatrix",Te)):Ft.setValue(U,"projectionMatrix",E.projectionMatrix),Ft.setValue(U,"viewMatrix",E.matrixWorldInverse);const On=Ft.map.cameraPosition;On!==void 0&&On.setValue(U,Xe.setFromMatrixPosition(E.matrixWorld)),nt.logarithmicDepthBuffer&&Ft.setValue(U,"logDepthBufFC",2/(Math.log(E.far+1)/Math.LN2)),(q.isMeshPhongMaterial||q.isMeshToonMaterial||q.isMeshLambertMaterial||q.isMeshBasicMaterial||q.isMeshStandardMaterial||q.isShaderMaterial)&&Ft.setValue(U,"isOrthographic",E.isOrthographicCamera===!0),Q!==E&&(Q=E,Cn=!0,Rc=!0)}if(B.isSkinnedMesh){Ft.setOptional(U,B,"bindMatrix"),Ft.setOptional(U,B,"bindMatrixInverse");const On=B.skeleton;On&&(On.boneTexture===null&&On.computeBoneTexture(),Ft.setValue(U,"boneTexture",On.boneTexture,C))}B.isBatchedMesh&&(Ft.setOptional(U,B,"batchingTexture"),Ft.setValue(U,"batchingTexture",B._matricesTexture,C),Ft.setOptional(U,B,"batchingIdTexture"),Ft.setValue(U,"batchingIdTexture",B._indirectTexture,C),Ft.setOptional(U,B,"batchingColorTexture"),B._colorsTexture!==null&&Ft.setValue(U,"batchingColorTexture",B._colorsTexture,C));const Pc=O.morphAttributes;if((Pc.position!==void 0||Pc.normal!==void 0||Pc.color!==void 0)&&Ve.update(B,O,cn),(Cn||Me.receiveShadow!==B.receiveShadow)&&(Me.receiveShadow=B.receiveShadow,Ft.setValue(U,"receiveShadow",B.receiveShadow)),q.isMeshGouraudMaterial&&q.envMap!==null&&($i.envMap.value=Z,$i.flipEnvMap.value=Z.isCubeTexture&&Z.isRenderTargetTexture===!1?-1:1),q.isMeshStandardMaterial&&q.envMap===null&&F.environment!==null&&($i.envMapIntensity.value=F.environmentIntensity),Cn&&(Ft.setValue(U,"toneMappingExposure",v.toneMappingExposure),Me.needsLights&&ya($i,Rc),ge&&q.fog===!0&&ye.refreshFogUniforms($i,ge),ye.refreshMaterialUniforms($i,q,ce,K,m.state.transmissionRenderTarget[E.id]),Pl.upload(U,Ti(Me),$i,C)),q.isShaderMaterial&&q.uniformsNeedUpdate===!0&&(Pl.upload(U,Ti(Me),$i,C),q.uniformsNeedUpdate=!1),q.isSpriteMaterial&&Ft.setValue(U,"center",B.center),Ft.setValue(U,"modelViewMatrix",B.modelViewMatrix),Ft.setValue(U,"normalMatrix",B.normalMatrix),Ft.setValue(U,"modelMatrix",B.matrixWorld),q.isShaderMaterial||q.isRawShaderMaterial){const On=q.uniformsGroups;for(let bc=0,B_=On.length;bc<B_;bc++){const Rh=On[bc];T.update(Rh,cn),T.bind(Rh,cn)}}return cn}function ya(E,F){E.ambientLightColor.needsUpdate=F,E.lightProbe.needsUpdate=F,E.directionalLights.needsUpdate=F,E.directionalLightShadows.needsUpdate=F,E.pointLights.needsUpdate=F,E.pointLightShadows.needsUpdate=F,E.spotLights.needsUpdate=F,E.spotLightShadows.needsUpdate=F,E.rectAreaLights.needsUpdate=F,E.hemisphereLights.needsUpdate=F}function qi(E){return E.isMeshLambertMaterial||E.isMeshToonMaterial||E.isMeshPhongMaterial||E.isMeshStandardMaterial||E.isShadowMaterial||E.isShaderMaterial&&E.lights===!0}this.getActiveCubeFace=function(){return P},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return A},this.setRenderTargetTextures=function(E,F,O){Ge.get(E.texture).__webglTexture=F,Ge.get(E.depthTexture).__webglTexture=O;const q=Ge.get(E);q.__hasExternalTextures=!0,q.__autoAllocateDepthBuffer=O===void 0,q.__autoAllocateDepthBuffer||qe.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),q.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(E,F){const O=Ge.get(E);O.__webglFramebuffer=F,O.__useDefaultFramebuffer=F===void 0},this.setRenderTarget=function(E,F=0,O=0){A=E,P=F,R=O;let q=!0,B=null,ge=!1,W=!1;if(E){const Z=Ge.get(E);if(Z.__useDefaultFramebuffer!==void 0)Be.bindFramebuffer(U.FRAMEBUFFER,null),q=!1;else if(Z.__webglFramebuffer===void 0)C.setupRenderTarget(E);else if(Z.__hasExternalTextures)C.rebindTextures(E,Ge.get(E.texture).__webglTexture,Ge.get(E.depthTexture).__webglTexture);else if(E.depthBuffer){const ue=E.depthTexture;if(Z.__boundDepthTexture!==ue){if(ue!==null&&Ge.has(ue)&&(E.width!==ue.image.width||E.height!==ue.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");C.setupDepthRenderbuffer(E)}}const le=E.texture;(le.isData3DTexture||le.isDataArrayTexture||le.isCompressedArrayTexture)&&(W=!0);const me=Ge.get(E).__webglFramebuffer;E.isWebGLCubeRenderTarget?(Array.isArray(me[F])?B=me[F][O]:B=me[F],ge=!0):E.samples>0&&C.useMultisampledRTT(E)===!1?B=Ge.get(E).__webglMultisampledFramebuffer:Array.isArray(me)?B=me[O]:B=me,y.copy(E.viewport),w.copy(E.scissor),X=E.scissorTest}else y.copy(re).multiplyScalar(ce).floor(),w.copy(ve).multiplyScalar(ce).floor(),X=Fe;if(Be.bindFramebuffer(U.FRAMEBUFFER,B)&&q&&Be.drawBuffers(E,B),Be.viewport(y),Be.scissor(w),Be.setScissorTest(X),ge){const Z=Ge.get(E.texture);U.framebufferTexture2D(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,U.TEXTURE_CUBE_MAP_POSITIVE_X+F,Z.__webglTexture,O)}else if(W){const Z=Ge.get(E.texture),le=F||0;U.framebufferTextureLayer(U.FRAMEBUFFER,U.COLOR_ATTACHMENT0,Z.__webglTexture,O||0,le)}b=-1},this.readRenderTargetPixels=function(E,F,O,q,B,ge,W){if(!(E&&E.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let $=Ge.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&W!==void 0&&($=$[W]),$){Be.bindFramebuffer(U.FRAMEBUFFER,$);try{const Z=E.texture,le=Z.format,me=Z.type;if(!nt.textureFormatReadable(le)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!nt.textureTypeReadable(me)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}F>=0&&F<=E.width-q&&O>=0&&O<=E.height-B&&U.readPixels(F,O,q,B,H.convert(le),H.convert(me),ge)}finally{const Z=A!==null?Ge.get(A).__webglFramebuffer:null;Be.bindFramebuffer(U.FRAMEBUFFER,Z)}}},this.readRenderTargetPixelsAsync=async function(E,F,O,q,B,ge,W){if(!(E&&E.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let $=Ge.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&W!==void 0&&($=$[W]),$){const Z=E.texture,le=Z.format,me=Z.type;if(!nt.textureFormatReadable(le))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!nt.textureTypeReadable(me))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(F>=0&&F<=E.width-q&&O>=0&&O<=E.height-B){Be.bindFramebuffer(U.FRAMEBUFFER,$);const ue=U.createBuffer();U.bindBuffer(U.PIXEL_PACK_BUFFER,ue),U.bufferData(U.PIXEL_PACK_BUFFER,ge.byteLength,U.STREAM_READ),U.readPixels(F,O,q,B,H.convert(le),H.convert(me),0);const Pe=A!==null?Ge.get(A).__webglFramebuffer:null;Be.bindFramebuffer(U.FRAMEBUFFER,Pe);const De=U.fenceSync(U.SYNC_GPU_COMMANDS_COMPLETE,0);return U.flush(),await fS(U,De,4),U.bindBuffer(U.PIXEL_PACK_BUFFER,ue),U.getBufferSubData(U.PIXEL_PACK_BUFFER,0,ge),U.deleteBuffer(ue),U.deleteSync(De),ge}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(E,F=null,O=0){E.isTexture!==!0&&(Rl("WebGLRenderer: copyFramebufferToTexture function signature has changed."),F=arguments[0]||null,E=arguments[1]);const q=Math.pow(2,-O),B=Math.floor(E.image.width*q),ge=Math.floor(E.image.height*q),W=F!==null?F.x:0,$=F!==null?F.y:0;C.setTexture2D(E,0),U.copyTexSubImage2D(U.TEXTURE_2D,O,0,0,W,$,B,ge),Be.unbindTexture()},this.copyTextureToTexture=function(E,F,O=null,q=null,B=0){E.isTexture!==!0&&(Rl("WebGLRenderer: copyTextureToTexture function signature has changed."),q=arguments[0]||null,E=arguments[1],F=arguments[2],B=arguments[3]||0,O=null);let ge,W,$,Z,le,me;O!==null?(ge=O.max.x-O.min.x,W=O.max.y-O.min.y,$=O.min.x,Z=O.min.y):(ge=E.image.width,W=E.image.height,$=0,Z=0),q!==null?(le=q.x,me=q.y):(le=0,me=0);const ue=H.convert(F.format),Pe=H.convert(F.type);C.setTexture2D(F,0),U.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,F.flipY),U.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,F.premultiplyAlpha),U.pixelStorei(U.UNPACK_ALIGNMENT,F.unpackAlignment);const De=U.getParameter(U.UNPACK_ROW_LENGTH),Le=U.getParameter(U.UNPACK_IMAGE_HEIGHT),vt=U.getParameter(U.UNPACK_SKIP_PIXELS),We=U.getParameter(U.UNPACK_SKIP_ROWS),Me=U.getParameter(U.UNPACK_SKIP_IMAGES),_t=E.isCompressedTexture?E.mipmaps[B]:E.image;U.pixelStorei(U.UNPACK_ROW_LENGTH,_t.width),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,_t.height),U.pixelStorei(U.UNPACK_SKIP_PIXELS,$),U.pixelStorei(U.UNPACK_SKIP_ROWS,Z),E.isDataTexture?U.texSubImage2D(U.TEXTURE_2D,B,le,me,ge,W,ue,Pe,_t.data):E.isCompressedTexture?U.compressedTexSubImage2D(U.TEXTURE_2D,B,le,me,_t.width,_t.height,ue,_t.data):U.texSubImage2D(U.TEXTURE_2D,B,le,me,ge,W,ue,Pe,_t),U.pixelStorei(U.UNPACK_ROW_LENGTH,De),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,Le),U.pixelStorei(U.UNPACK_SKIP_PIXELS,vt),U.pixelStorei(U.UNPACK_SKIP_ROWS,We),U.pixelStorei(U.UNPACK_SKIP_IMAGES,Me),B===0&&F.generateMipmaps&&U.generateMipmap(U.TEXTURE_2D),Be.unbindTexture()},this.copyTextureToTexture3D=function(E,F,O=null,q=null,B=0){E.isTexture!==!0&&(Rl("WebGLRenderer: copyTextureToTexture3D function signature has changed."),O=arguments[0]||null,q=arguments[1]||null,E=arguments[2],F=arguments[3],B=arguments[4]||0);let ge,W,$,Z,le,me,ue,Pe,De;const Le=E.isCompressedTexture?E.mipmaps[B]:E.image;O!==null?(ge=O.max.x-O.min.x,W=O.max.y-O.min.y,$=O.max.z-O.min.z,Z=O.min.x,le=O.min.y,me=O.min.z):(ge=Le.width,W=Le.height,$=Le.depth,Z=0,le=0,me=0),q!==null?(ue=q.x,Pe=q.y,De=q.z):(ue=0,Pe=0,De=0);const vt=H.convert(F.format),We=H.convert(F.type);let Me;if(F.isData3DTexture)C.setTexture3D(F,0),Me=U.TEXTURE_3D;else if(F.isDataArrayTexture||F.isCompressedArrayTexture)C.setTexture2DArray(F,0),Me=U.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}U.pixelStorei(U.UNPACK_FLIP_Y_WEBGL,F.flipY),U.pixelStorei(U.UNPACK_PREMULTIPLY_ALPHA_WEBGL,F.premultiplyAlpha),U.pixelStorei(U.UNPACK_ALIGNMENT,F.unpackAlignment);const _t=U.getParameter(U.UNPACK_ROW_LENGTH),Je=U.getParameter(U.UNPACK_IMAGE_HEIGHT),cn=U.getParameter(U.UNPACK_SKIP_PIXELS),Qt=U.getParameter(U.UNPACK_SKIP_ROWS),Cn=U.getParameter(U.UNPACK_SKIP_IMAGES);U.pixelStorei(U.UNPACK_ROW_LENGTH,Le.width),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,Le.height),U.pixelStorei(U.UNPACK_SKIP_PIXELS,Z),U.pixelStorei(U.UNPACK_SKIP_ROWS,le),U.pixelStorei(U.UNPACK_SKIP_IMAGES,me),E.isDataTexture||E.isData3DTexture?U.texSubImage3D(Me,B,ue,Pe,De,ge,W,$,vt,We,Le.data):F.isCompressedArrayTexture?U.compressedTexSubImage3D(Me,B,ue,Pe,De,ge,W,$,vt,Le.data):U.texSubImage3D(Me,B,ue,Pe,De,ge,W,$,vt,We,Le),U.pixelStorei(U.UNPACK_ROW_LENGTH,_t),U.pixelStorei(U.UNPACK_IMAGE_HEIGHT,Je),U.pixelStorei(U.UNPACK_SKIP_PIXELS,cn),U.pixelStorei(U.UNPACK_SKIP_ROWS,Qt),U.pixelStorei(U.UNPACK_SKIP_IMAGES,Cn),B===0&&F.generateMipmaps&&U.generateMipmap(Me),Be.unbindTexture()},this.initRenderTarget=function(E){Ge.get(E).__webglFramebuffer===void 0&&C.setupRenderTarget(E)},this.initTexture=function(E){E.isCubeTexture?C.setTextureCube(E,0):E.isData3DTexture?C.setTexture3D(E,0):E.isDataArrayTexture||E.isCompressedArrayTexture?C.setTexture2DArray(E,0):C.setTexture2D(E,0),Be.unbindTexture()},this.resetState=function(){P=0,R=0,A=null,Be.reset(),j.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Bi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=e===Sh?"display-p3":"srgb",n.unpackColorSpace=ht.workingColorSpace===wc?"display-p3":"srgb"}}class wT extends qt{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new Mi,this.environmentIntensity=1,this.environmentRotation=new Mi,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,n){return super.copy(e,n),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const n=super.toJSON(e);return this.fog!==null&&(n.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(n.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(n.object.backgroundIntensity=this.backgroundIntensity),n.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(n.object.environmentIntensity=this.environmentIntensity),n.object.environmentRotation=this.environmentRotation.toArray(),n}}class Ah extends po{constructor(e){super(),this.isLineBasicMaterial=!0,this.type="LineBasicMaterial",this.color=new ze(16777215),this.map=null,this.linewidth=1,this.linecap="round",this.linejoin="round",this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.linewidth=e.linewidth,this.linecap=e.linecap,this.linejoin=e.linejoin,this.fog=e.fog,this}}const sc=new k,oc=new k,Im=new Ct,Do=new Mh,sl=new Tc,Iu=new k,Nm=new k;class TT extends qt{constructor(e=new fi,n=new Ah){super(),this.isLine=!0,this.type="Line",this.geometry=e,this.material=n,this.updateMorphTargets()}copy(e,n){return super.copy(e,n),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}computeLineDistances(){const e=this.geometry;if(e.index===null){const n=e.attributes.position,i=[0];for(let r=1,s=n.count;r<s;r++)sc.fromBufferAttribute(n,r-1),oc.fromBufferAttribute(n,r),i[r]=i[r-1],i[r]+=sc.distanceTo(oc);e.setAttribute("lineDistance",new on(i,1))}else console.warn("THREE.Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}raycast(e,n){const i=this.geometry,r=this.matrixWorld,s=e.params.Line.threshold,o=i.drawRange;if(i.boundingSphere===null&&i.computeBoundingSphere(),sl.copy(i.boundingSphere),sl.applyMatrix4(r),sl.radius+=s,e.ray.intersectsSphere(sl)===!1)return;Im.copy(r).invert(),Do.copy(e.ray).applyMatrix4(Im);const a=s/((this.scale.x+this.scale.y+this.scale.z)/3),l=a*a,c=this.isLineSegments?2:1,f=i.index,h=i.attributes.position;if(f!==null){const p=Math.max(0,o.start),_=Math.min(f.count,o.start+o.count);for(let x=p,m=_-1;x<m;x+=c){const u=f.getX(x),g=f.getX(x+1),v=ol(this,e,Do,l,u,g);v&&n.push(v)}if(this.isLineLoop){const x=f.getX(_-1),m=f.getX(p),u=ol(this,e,Do,l,x,m);u&&n.push(u)}}else{const p=Math.max(0,o.start),_=Math.min(h.count,o.start+o.count);for(let x=p,m=_-1;x<m;x+=c){const u=ol(this,e,Do,l,x,x+1);u&&n.push(u)}if(this.isLineLoop){const x=ol(this,e,Do,l,_-1,p);x&&n.push(x)}}}updateMorphTargets(){const n=this.geometry.morphAttributes,i=Object.keys(n);if(i.length>0){const r=n[i[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,o=r.length;s<o;s++){const a=r[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=s}}}}}function ol(t,e,n,i,r,s){const o=t.geometry.attributes.position;if(sc.fromBufferAttribute(o,r),oc.fromBufferAttribute(o,s),n.distanceSqToSegment(sc,oc,Iu,Nm)>i)return;Iu.applyMatrix4(t.matrixWorld);const l=e.ray.origin.distanceTo(Iu);if(!(l<e.near||l>e.far))return{distance:l,point:Nm.clone().applyMatrix4(t.matrixWorld),index:r,face:null,faceIndex:null,barycoord:null,object:t}}const Fm=new k,Om=new k;class U_ extends TT{constructor(e,n){super(e,n),this.isLineSegments=!0,this.type="LineSegments"}computeLineDistances(){const e=this.geometry;if(e.index===null){const n=e.attributes.position,i=[];for(let r=0,s=n.count;r<s;r+=2)Fm.fromBufferAttribute(n,r),Om.fromBufferAttribute(n,r+1),i[r]=r===0?0:i[r-1],i[r+1]=i[r]+Fm.distanceTo(Om);e.setAttribute("lineDistance",new on(i,1))}else console.warn("THREE.LineSegments.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}}class Er extends fi{constructor(e=1,n=1,i=1,r=32,s=1,o=!1,a=0,l=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:e,radiusBottom:n,height:i,radialSegments:r,heightSegments:s,openEnded:o,thetaStart:a,thetaLength:l};const c=this;r=Math.floor(r),s=Math.floor(s);const f=[],d=[],h=[],p=[];let _=0;const x=[],m=i/2;let u=0;g(),o===!1&&(e>0&&v(!0),n>0&&v(!1)),this.setIndex(f),this.setAttribute("position",new on(d,3)),this.setAttribute("normal",new on(h,3)),this.setAttribute("uv",new on(p,2));function g(){const M=new k,P=new k;let R=0;const A=(n-e)/i;for(let b=0;b<=s;b++){const Q=[],y=b/s,w=y*(n-e)+e;for(let X=0;X<=r;X++){const Y=X/r,ee=Y*l+a,oe=Math.sin(ee),K=Math.cos(ee);P.x=w*oe,P.y=-y*i+m,P.z=w*K,d.push(P.x,P.y,P.z),M.set(oe,A,K).normalize(),h.push(M.x,M.y,M.z),p.push(Y,1-y),Q.push(_++)}x.push(Q)}for(let b=0;b<r;b++)for(let Q=0;Q<s;Q++){const y=x[Q][b],w=x[Q+1][b],X=x[Q+1][b+1],Y=x[Q][b+1];e>0&&(f.push(y,w,Y),R+=3),n>0&&(f.push(w,X,Y),R+=3)}c.addGroup(u,R,0),u+=R}function v(M){const P=_,R=new ft,A=new k;let b=0;const Q=M===!0?e:n,y=M===!0?1:-1;for(let X=1;X<=r;X++)d.push(0,m*y,0),h.push(0,y,0),p.push(.5,.5),_++;const w=_;for(let X=0;X<=r;X++){const ee=X/r*l+a,oe=Math.cos(ee),K=Math.sin(ee);A.x=Q*K,A.y=m*y,A.z=Q*oe,d.push(A.x,A.y,A.z),h.push(0,y,0),R.x=oe*.5+.5,R.y=K*.5*y+.5,p.push(R.x,R.y),_++}for(let X=0;X<r;X++){const Y=P+X,ee=w+X;M===!0?f.push(ee,ee+1,Y):f.push(ee+1,ee,Y),b+=3}c.addGroup(u,b,M===!0?1:2),u+=b}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new Er(e.radiusTop,e.radiusBottom,e.height,e.radialSegments,e.heightSegments,e.openEnded,e.thetaStart,e.thetaLength)}}const al=new k,ll=new k,Nu=new k,cl=new Vn;class Ch extends fi{constructor(e=null,n=1){if(super(),this.type="EdgesGeometry",this.parameters={geometry:e,thresholdAngle:n},e!==null){const r=Math.pow(10,4),s=Math.cos(Cl*n),o=e.getIndex(),a=e.getAttribute("position"),l=o?o.count:a.count,c=[0,0,0],f=["a","b","c"],d=new Array(3),h={},p=[];for(let _=0;_<l;_+=3){o?(c[0]=o.getX(_),c[1]=o.getX(_+1),c[2]=o.getX(_+2)):(c[0]=_,c[1]=_+1,c[2]=_+2);const{a:x,b:m,c:u}=cl;if(x.fromBufferAttribute(a,c[0]),m.fromBufferAttribute(a,c[1]),u.fromBufferAttribute(a,c[2]),cl.getNormal(Nu),d[0]=`${Math.round(x.x*r)},${Math.round(x.y*r)},${Math.round(x.z*r)}`,d[1]=`${Math.round(m.x*r)},${Math.round(m.y*r)},${Math.round(m.z*r)}`,d[2]=`${Math.round(u.x*r)},${Math.round(u.y*r)},${Math.round(u.z*r)}`,!(d[0]===d[1]||d[1]===d[2]||d[2]===d[0]))for(let g=0;g<3;g++){const v=(g+1)%3,M=d[g],P=d[v],R=cl[f[g]],A=cl[f[v]],b=`${M}_${P}`,Q=`${P}_${M}`;Q in h&&h[Q]?(Nu.dot(h[Q].normal)<=s&&(p.push(R.x,R.y,R.z),p.push(A.x,A.y,A.z)),h[Q]=null):b in h||(h[b]={index0:c[g],index1:c[v],normal:Nu.clone()})}}for(const _ in h)if(h[_]){const{index0:x,index1:m}=h[_];al.fromBufferAttribute(a,x),ll.fromBufferAttribute(a,m),p.push(al.x,al.y,al.z),p.push(ll.x,ll.y,ll.z)}this.setAttribute("position",new on(p,3))}}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}}class so extends fi{constructor(e=1,n=32,i=16,r=0,s=Math.PI*2,o=0,a=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:e,widthSegments:n,heightSegments:i,phiStart:r,phiLength:s,thetaStart:o,thetaLength:a},n=Math.max(3,Math.floor(n)),i=Math.max(2,Math.floor(i));const l=Math.min(o+a,Math.PI);let c=0;const f=[],d=new k,h=new k,p=[],_=[],x=[],m=[];for(let u=0;u<=i;u++){const g=[],v=u/i;let M=0;u===0&&o===0?M=.5/n:u===i&&l===Math.PI&&(M=-.5/n);for(let P=0;P<=n;P++){const R=P/n;d.x=-e*Math.cos(r+R*s)*Math.sin(o+v*a),d.y=e*Math.cos(o+v*a),d.z=e*Math.sin(r+R*s)*Math.sin(o+v*a),_.push(d.x,d.y,d.z),h.copy(d).normalize(),x.push(h.x,h.y,h.z),m.push(R+M,1-v),g.push(c++)}f.push(g)}for(let u=0;u<i;u++)for(let g=0;g<n;g++){const v=f[u][g+1],M=f[u][g],P=f[u+1][g],R=f[u+1][g+1];(u!==0||o>0)&&p.push(v,M,R),(u!==i-1||l<Math.PI)&&p.push(M,P,R)}this.setIndex(p),this.setAttribute("position",new on(_,3)),this.setAttribute("normal",new on(x,3)),this.setAttribute("uv",new on(m,2))}copy(e){return super.copy(e),this.parameters=Object.assign({},e.parameters),this}static fromJSON(e){return new so(e.radius,e.widthSegments,e.heightSegments,e.phiStart,e.phiLength,e.thetaStart,e.thetaLength)}}class I_ extends po{constructor(e){super(),this.isMeshLambertMaterial=!0,this.type="MeshLambertMaterial",this.color=new ze(16777215),this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new ze(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=m_,this.normalScale=new ft(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.specularMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new Mi,this.combine=ph,this.reflectivity=1,this.refractionRatio=.98,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.specularMap=e.specularMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapRotation.copy(e.envMapRotation),this.combine=e.combine,this.reflectivity=e.reflectivity,this.refractionRatio=e.refractionRatio,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class N_ extends qt{constructor(e,n=1){super(),this.isLight=!0,this.type="Light",this.color=new ze(e),this.intensity=n}dispose(){}copy(e,n){return super.copy(e,n),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const n=super.toJSON(e);return n.object.color=this.color.getHex(),n.object.intensity=this.intensity,this.groundColor!==void 0&&(n.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(n.object.distance=this.distance),this.angle!==void 0&&(n.object.angle=this.angle),this.decay!==void 0&&(n.object.decay=this.decay),this.penumbra!==void 0&&(n.object.penumbra=this.penumbra),this.shadow!==void 0&&(n.object.shadow=this.shadow.toJSON()),this.target!==void 0&&(n.object.target=this.target.uuid),n}}class AT extends N_{constructor(e,n,i){super(e,i),this.isHemisphereLight=!0,this.type="HemisphereLight",this.position.copy(qt.DEFAULT_UP),this.updateMatrix(),this.groundColor=new ze(n)}copy(e,n){return super.copy(e,n),this.groundColor.copy(e.groundColor),this}}const Fu=new Ct,Bm=new k,km=new k;class CT{constructor(e){this.camera=e,this.intensity=1,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new ft(512,512),this.map=null,this.mapPass=null,this.matrix=new Ct,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new wh,this._frameExtents=new ft(1,1),this._viewportCount=1,this._viewports=[new It(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const n=this.camera,i=this.matrix;Bm.setFromMatrixPosition(e.matrixWorld),n.position.copy(Bm),km.setFromMatrixPosition(e.target.matrixWorld),n.lookAt(km),n.updateMatrixWorld(),Fu.multiplyMatrices(n.projectionMatrix,n.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Fu),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(Fu)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.intensity=e.intensity,this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.intensity!==1&&(e.intensity=this.intensity),this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class RT extends CT{constructor(){super(new C_(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class zm extends N_{constructor(e,n){super(e,n),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(qt.DEFAULT_UP),this.updateMatrix(),this.target=new qt,this.shadow=new RT}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}const Hm=new Ct;class PT{constructor(e,n,i=0,r=1/0){this.ray=new Mh(e,n),this.near=i,this.far=r,this.camera=null,this.layers=new Eh,this.params={Mesh:{},Line:{threshold:1},LOD:{},Points:{threshold:1},Sprite:{}}}set(e,n){this.ray.set(e,n)}setFromCamera(e,n){n.isPerspectiveCamera?(this.ray.origin.setFromMatrixPosition(n.matrixWorld),this.ray.direction.set(e.x,e.y,.5).unproject(n).sub(this.ray.origin).normalize(),this.camera=n):n.isOrthographicCamera?(this.ray.origin.set(e.x,e.y,(n.near+n.far)/(n.near-n.far)).unproject(n),this.ray.direction.set(0,0,-1).transformDirection(n.matrixWorld),this.camera=n):console.error("THREE.Raycaster: Unsupported camera type: "+n.type)}setFromXRController(e){return Hm.identity().extractRotation(e.matrixWorld),this.ray.origin.setFromMatrixPosition(e.matrixWorld),this.ray.direction.set(0,0,-1).applyMatrix4(Hm),this}intersectObject(e,n=!0,i=[]){return vd(e,this,i,n),i.sort(Vm),i}intersectObjects(e,n=!0,i=[]){for(let r=0,s=e.length;r<s;r++)vd(e[r],this,i,n);return i.sort(Vm),i}}function Vm(t,e){return t.distance-e.distance}function vd(t,e,n,i){let r=!0;if(t.layers.test(e.layers)&&t.raycast(e,n)===!1&&(r=!1),r===!0&&i===!0){const s=t.children;for(let o=0,a=s.length;o<a;o++)vd(s[o],e,n,!0)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:hh}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=hh);const Dr=72,Lr=56;function oo(t,e,n){return new k(t-Dr,n,e-Lr)}const pt={scene:null,groupReg:{},pickables:[],wallsFade:[],flows:[],floorMeshes:{b1:[],f1:[],f2:[],roof:[]},slabs:[],currentFloor:null};function bT(t){pt.scene=t,pt.groupReg={},pt.pickables=[],pt.wallsFade=[],pt.flows=[],pt.floorMeshes={b1:[],f1:[],f2:[],roof:[]},pt.slabs=[],pt.currentFloor=null}function xi(t){pt.currentFloor=t}function $n(t){pt.currentFloor&&pt.floorMeshes[pt.currentFloor]&&(t.userData.floor=pt.currentFloor,pt.floorMeshes[pt.currentFloor].push(t))}function Gm(t){$n(t)}function Ne(t,e){if(t&&pt.groupReg[t])return pt.groupReg[t];const n=new Bo;return n.userData={term:t||null,cat:e||null},pt.scene.add(n),t&&(pt.groupReg[t]=n),n}function DT(t){const e=new ze(t);return e.multiplyScalar(.9),e}function Dn(t,e){const n=new I_({color:new ze(t)});return e!==void 0&&(n.transparent=!0,n.opacity=e),n.userData={baseOp:e===void 0?1:e},n}function F_(t,e,n,i){const r=new U_(new Ch(e),new Ah({color:DT(i),transparent:!0,opacity:1}));return r.material.userData={baseOp:1},r.position.copy(n.position),r.rotation.copy(n.rotation),r.userData.isEdge=!0,t.add(r),$n(r),r}function J(t,e,n,i,r,s,o,a,l){l=l||{};const c=new Ei(r,o,s),f=new St(c,Dn(a,l.op));return f.position.set(e+r/2-Dr,i+o/2,n+s/2-Lr),l.ry&&(f.rotation.y=l.ry),t.add(f),pt.pickables.push(f),$n(f),l.noedge||F_(t,c,f,l.edge||a),f}function rt(t,e,n,i,r,s,o,a){const l=new Ac({color:new ze(o),side:ri,transparent:a!==void 0,opacity:a===void 0?1:a});l.userData={baseOp:a===void 0?1:a};const c=new St(new mo(r,s),l);return c.rotation.x=-Math.PI/2,c.position.set(e+r/2-Dr,i,n+s/2-Lr),c.userData.floorTop=!0,t.add(c),$n(c),c}function LT(t,e,n,i,r,s,o){const a=new ji({uniforms:{uColor:{value:new ze(o)},uAspect:{value:r/s}},vertexShader:"varying vec2 vUv;void main(){vUv=uv;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0);}",fragmentShader:"uniform vec3 uColor;uniform float uAspect;varying vec2 vUv;void main(){vec2 p=(vUv-0.5)*vec2(uAspect,1.0);float radius=0.045;vec2 q=abs(p)-(vec2(uAspect*0.5,0.5)-vec2(radius));float sd=length(max(q,0.0))+min(max(q.x,q.y),0.0)-radius;float inset=max(0.0,-sd);float edgeFade=smoothstep(0.0,0.10,inset);gl_FragColor=vec4(uColor,edgeFade*0.54);}",transparent:!0,depthWrite:!1,side:ri});a.userData={baseOp:1};const l=new St(new mo(r,s),a);return l.rotation.x=-Math.PI/2,l.position.set(e+r/2-Dr,i,n+s/2-Lr),l.renderOrder=-10,l.userData.floorTop=!0,l.userData.groundSurface=!0,t.add(l),l}function Tt(t,e,n,i,r,s,o,a){a=a||{};const l=new Er(a.rTop!==void 0?a.rTop:r,r,s,a.seg||18),c=new St(l,Dn(o,a.op));return c.position.set(e-Dr,i+s/2,n-Lr),t.add(c),pt.pickables.push(c),$n(c),c}function Gn(t,e,n,i,r,s){s=s||{};const o=oo(e[0],e[1],e[2]),a=oo(n[0],n[1],n[2]),l=new k().subVectors(a,o),c=l.length(),f=new Er(i,i,c,s.seg||10),d=new St(f,Dn(r,s.op));return d.position.copy(o).add(a).multiplyScalar(.5),d.quaternion.setFromUnitVectors(new k(0,1,0),l.normalize()),t.add(d),s.pick!==!1&&pt.pickables.push(d),$n(d),d}function UT(t){const e=(t||"").toUpperCase();return e==="#E2793B"||e==="#EF9D76"?"heat":e==="#0FA396"||e==="#57C7BD"?"tcs":e==="#EBB410"||e==="#D9A312"||e==="#F0C744"?"power":e==="#9CC6E4"?"condensate":e==="#3E9CD6"||e==="#42AEE8"?"chilled":null}function IT(t){return t==="condensate"?["#4E98C5","#86BDD8"]:t==="chilled"?["#197EB8","#4AACC9"]:t==="tcs"?["#078A7E","#D47C3E"]:t==="heat"?["#D87631","#B9472C"]:null}function Wm(t){const e={h:0,s:0,l:0};return t.getHSL(e),t.setHSL(e.h,Math.min(1,e.s*1.06+.015),Math.max(.12,e.l*.78)),t}function NT(t,e,n,i,r){const s=t.geometry.attributes.position,o=s.count,a=new Float32Array(o*3);t.geometry.computeBoundingBox();const l=t.geometry.boundingBox.min.y,c=t.geometry.boundingBox.max.y,f=Math.max(.001,c-l),d=new ze(e),h=new ze(n),p=new ze;for(let _=0;_<o;_++){const x=(s.getY(_)-l)/f,m=i+(r-i)*x;p.copy(d).lerp(h,Math.max(0,Math.min(1,m))),a[_*3]=p.r,a[_*3+1]=p.g,a[_*3+2]=p.b}t.geometry.setAttribute("color",new ci(a,3)),t.material.vertexColors=!0,t.material.color.set(16777215),t.material.userData.flowGradient=!0,t.material.needsUpdate=!0}function Lt(t,e,n,i,r){i=i||.32;const s=[],o=[],a=UT(n);for(let p=0;p<e.length;p++)s.push(oo(e[p][0],e[p][1],e[p][2]));const l=IT(a),c=Math.max(1,e.length-1);for(let p=0;p<e.length-1;p++){const _=Gn(t,e[p],e[p+1],i,n,{seg:10});l?NT(_,l[0],l[1],p/c,(p+1)/c):a&&Wm(_.material.color),_.userData.flowPart=!0,o.push(_)}for(let p=1;p<e.length-1;p++){const _=l?new ze(l[0]).lerp(new ze(l[1]),p/c):new ze(n);a&&!l&&Wm(_);const x=new St(new so(i*1.12,10,10),Dn("#ffffff"));x.material.color.copy(_),x.position.copy(s[p]),x.userData.flowPart=!0,t.add(x),$n(x),o.push(x)}if(!a)return;const f=[0];let d=0;for(let p=1;p<s.length;p++)d+=s[p].distanceTo(s[p-1]),f.push(d);const h=[];if(r!==!1||a==="tcs"){const p=Math.max(4,Math.round(d/12)),_=[1,.62,.34,.14];for(let x=0;x<p;x++)for(let m=0;m<_.length;m++){const u=_[m],g=new I_({color:new ze(n),emissive:new ze(n),emissiveIntensity:.55,transparent:!0,opacity:u,depthWrite:!1,depthTest:!0});g.userData={baseOp:u,flowBaseColor:new ze(n)};const v=Math.max(.2,i*(.92-m*.08)),M=new St(new so(v,10,10),g);M.renderOrder=30,M.userData.flowPart=!0,M.userData.flowParticle=!0,M.userData.flowU=x/p-m*.0085,t.add(M),$n(M),h.push(M)}}pt.flows.push({vs:s,lens:f,tot:d,dots:h,parts:o,key:a,off:Math.random(),enabled:!0})}function ir(t,e,n,i,r,s){Tt(t,e,n,i,r+.2,.34,s||"#8A8577",{seg:20}),Tt(t,e,n,i+.17,r*.92,.17,"#F3F4F6",{seg:20});const o=J(t,e-r*.85,n-.2,i+.31,r*1.7,.4,.16,"#6B7280",{noedge:!0});o.rotation.y=.5;const a=J(t,e-r*.85,n-.2,i+.31,r*1.7,.4,.16,"#6B7280",{noedge:!0});a.rotation.y=-1.05,Tt(t,e,n,i+.28,.23,.31,"#4B5563",{seg:10})}function dr(t,e,n,i,r,s){const o=[new St(new Er(r+.17,r+.17,.31,20),Dn("#5B7B95")),new St(new Er(r*.9,r*.9,.16,20),Dn("#EDF1F5")),new St(new Er(.21,.21,.37,10),Dn("#41586C")),new St(new Ei(r*1.65,.2,.34),Dn("#41586C")),new St(new Ei(r*1.65,.2,.34),Dn("#41586C"))];for(let a=0;a<o.length;a++){const l=o[a];l.rotation.x=Math.PI/2,l.position.copy(oo(e,n,i)),t.add(l),$n(l)}o[3].rotation.y=.6,o[4].rotation.y=-.9}function O_(t,e,n,i,r,s){s=s||"#9AA3AD",J(t,e-.34,n,i,.16,.16,r,s,{noedge:!0}),J(t,e+.18,n,i,.16,.16,r,s,{noedge:!0});for(let o=1;o<r/1.3;o++)J(t,e-.34,n,i+o*1.3,.68,.14,.14,s,{noedge:!0})}function et(t,e,n,i,r,s,o,a,l){const c=Ne(null,null),f="#EDEFF2",d=new Ei(i,s,r),h=new St(d,Dn(f,l?.45:.95));h.material.depthWrite=!l,h.position.set(t+i/2-Dr,n+s/2,e+r/2-Lr),c.add(h),$n(h);const p=l?"#DEE2E5":"#C5CBD0",_=new U_(new Ch(d),new Ah({color:new ze(p),transparent:!0,opacity:l?.58:.78,depthTest:!0,depthWrite:!1}));return _.material.userData={baseOp:l?.58:.78},_.position.copy(h.position),_.userData.isEdge=!0,c.add(_),$n(_),l||pt.wallsFade.push({m:h,e:_,n:new k(o,0,a)}),h}function ao(t,e,n,i,r,s,o,a,l,c){const f=c===void 0?.55:c,d=Ne(null,null),h=new Ei(i,s,r),p=new St(h,Dn(a||"#D3D8DC",f));p.material.depthWrite=!1,p.position.set(t+i/2-Dr,n-s/2,e+r/2-Lr),d.add(p),$n(p);const _=F_(d,h,p,"#969EA6"),x=rt(d,t,e,n+.03,i,r,l||"#E8EAEC",Math.min(.6,f));return pt.slabs.push({m:p,e:_,top:x,zTop:n,floor:o,baseOp:f}),p}const de={slab:"#D3D8DC",roof:"#D9DEE2",groundTop:"#EAECED",slabTop:"#E8EAEC",roofTop:"#E9EBED",cream:"#F0EBE1",cream2:"#E7E0D2",rackBody:"#3F2A34",rackDoor:"#5C3B49",tray:"#93AF7B",blue:"#A9BFD3",blueD:"#7E9DB8",cdu:"#7FA7D8",teal:"#8FD0C2",yel:"#EDBE4B",yelD:"#D9A32E",purp:"#ACA2DA",gray:"#CBD1D7",steel:"#B9C2CA",wood:"#C8A87E",rose:"#D8ACA2",zoneElec:"#F2DFAE",zoneMech:"#C9D8EC",zoneHall:"#D6DAF0",zoneCrah:"#EFD9E4",zoneOffice:"#EDE9D8",zoneMeet:"#D8ECEA",zoneCore:"#E2E5E8"},Ee={x0:0,x1:105.3,y0:0,y1:38.6},Ie={x0:2,x1:56,y0:47,y1:104},zi={f1:9,f2:18,roof:27},Ye=5.8;function FT(t){return bT(t),xi(null),function(){const n=Ne(null,null);J(n,-14,-10,-1.2,152,126,1.2,de.slab,{edge:"#969EA6"}),LT(n,-32,-26,-1.15,190,160,de.groundTop),rt(n,-14,-10,.04,152,126,de.slabTop),rt(n,108,0,.06,26,38.6,"#E3E5E7"),rt(n,58,44,.06,50,62,"#E6E8E9"),rt(n,60,70,.07,44,32,"#E2E8DF")}(),OT(),BT(),kT(),zT(),HT(),pt}function OT(){xi("b1"),function(){const e=Ne(null,null);rt(e,7,3,.08,41,24,de.zoneElec),rt(e,48,3,.08,18,13,de.zoneElec),rt(e,48,18,.08,12,10,de.zoneElec),rt(e,70,3,.08,28,13,de.zoneMech),rt(e,70,18,.08,28,15,de.zoneMech),rt(e,0,0,.08,7,38.6,de.zoneCore),rt(e,98.3,0,.08,7,38.6,de.zoneCore)}(),et(Ee.x0,Ee.y0,0,Ee.x1-Ee.x0,1.1,Ye,0,-1,!1),et(Ee.x0,Ee.y1-1.1,0,Ee.x1-Ee.x0,1.1,Ye,0,1,!1),et(Ee.x0,1.1,0,1.1,Ee.y1-2.2,Ye,-1,0,!1),et(Ee.x1-1.1,1.1,0,1.1,Ee.y1-2.2,Ye,1,0,!1),et(7,1.1,0,.7,36.4,Ye*.86,0,0,!0),et(98.3,1.1,0,.7,36.4,Ye*.86,0,0,!0),et(47.2,1.1,0,.7,28,Ye*.86,0,0,!0),et(66.5,1.1,0,.7,36.4,Ye*.86,0,0,!0),et(48,16.2,0,18,.7,Ye*.86,0,0,!0),et(70,16.2,0,28,.7,Ye*.86,0,0,!0),function(){const e=Ne("switchgear","power");for(let n=0;n<3;n++){const i=5.5+n*7;for(let r=0;r<6;r++){const s=10+r*5.6;J(e,s,i,0,4.8,3.1,2.5,de.yel),J(e,s+.4,i+2.95,.8,4,.28,1.4,"#F6E4AE"),J(e,s+.7,i+3.1,2,1.4,.2,.34,"#3A3F45",{noedge:!0}),J(e,s+2.9,i+3.1,2,1.1,.2,.34,"#C3542F",{noedge:!0})}}}(),function(){const e=Ne("transformer","power");for(let n=0;n<3;n++){const i=49.5+n*5.6;J(e,i,5,0,4.4,5,3.2,de.yel);for(let r=0;r<3;r++)J(e,i-.4,5.5+r*1.4,.5,.4,.9,2.2,"#D9A32E",{noedge:!0}),J(e,i+4.4,5.5+r*1.4,.5,.4,.9,2.2,"#D9A32E",{noedge:!0});for(let r=0;r<3;r++){Tt(e,i+.9+r*1.3,7.5,3.2,.28,.9,"#EDE7D8");const s=new St(new so(.24,10,10),Dn("#C9971B"));s.position.copy(oo(i+.9+r*1.3,7.5,4.3)),e.add(s),Gm(s)}J(e,i+.4,11.5,0,3.6,1.6,2.2,"#E4C25C",{noedge:!0})}}(),function(){const e=Ne("battery","power");for(let n=0;n<2;n++)for(let i=0;i<2;i++){const r=49+n*5.6,s=19+i*4.6;J(e,r,s,0,4.8,3.4,2.3,de.yel);for(let o=0;o<3;o++)J(e,r+.3,s+3.25,.35+o*.72,4.2,.24,.42,"#F6E4AE");J(e,r,s+3.25,2.35,4.8,.2,.2,"#C3542F",{noedge:!0})}}(),function(){const e=Ne("chiller","cooling");function n(o,a){J(e,o,a,0,15,4.6,.8,de.steel,{noedge:!0}),Gn(e,[o+.8,a+1.4,2.2],[o+14.2,a+1.4,2.2],1.15,de.blue,{seg:16}),Gn(e,[o+.8,a+3.2,3.8],[o+14.2,a+3.2,3.8],1.15,de.blueD,{seg:16}),Tt(e,o+4.6,a+2.3,4.6,1.1,1.6,"#DCE6EF"),Tt(e,o+9.5,a+2.3,4.6,1.1,1.6,"#DCE6EF"),Lt(e,[[o+4.6,a+2.3,5.7],[o+9.5,a+2.3,5.7]],"#AEC2D4",.3,!1),J(e,o+12.8,a+1,.8,1.6,.4,3.4,"#2E3238")}n(71.5,4),n(71.5,10);const i=Ne("pumps","cooling");function r(o,a){J(i,o-1.1,a-1.1,0,2.2,2.2,.4,de.steel,{noedge:!0}),Tt(i,o,a,.4,.88,.95,"#8FA9C0"),Tt(i,o,a,1.35,.68,1.75,"#DCE6EF"),Tt(i,o,a,3.1,.76,.28,"#8FA9C0"),Lt(i,[[o,a,.7],[o-1.9,a,.7]],"#9FB6CC",.32,!1)}r(90,5),r(90,8.8),r(90,12.6);const s=Ne("water-treatment","cooling");J(s,94,10.5,0,3.4,3,4.2,de.teal),J(s,94.4,13.4,2.6,1.5,.26,1.1,"#2E3238"),Tt(s,95,6.5,0,.65,2.3,"#BFE3DC"),Tt(s,96.8,6.5,0,.65,2.3,"#BFE3DC"),Lt(s,[[94.8,10.5,3.4],[95,7.5,2.6]],"#72B6A8",.22,!1)}(),function(){const e=Ne("tes","cooling");function n(i,r){Tt(e,i,r,0,3.4,6.8,"#E7EDF2",{seg:26});const s=new St(new so(3.4,26,12,0,Math.PI*2,0,Math.PI/2),Dn("#DDE5EB"));s.position.copy(oo(i,r,6.8)),e.add(s),pt.pickables.push(s),Gm(s),Tt(e,i,r,2.2,3.55,.28,"#C5D3DE",{seg:26}),Tt(e,i,r,4.7,3.55,.28,"#C5D3DE",{seg:26}),O_(e,i+3.9,r,0,6.4)}n(76,25.5),n(88,25.5)}(),function(){const e=Ne(null,null);rt(e,Ie.x0+6,52,.08,26,36,de.zoneElec),rt(e,Ie.x0,58,.08,6,18,de.zoneMech),rt(e,36,56,.08,8,12,de.zoneCore),rt(e,26,Ee.y1,.08,4.4,Ie.y0-Ee.y1,de.zoneCore),et(Ie.x0,Ie.y0,0,Ie.x1-Ie.x0,1.1,Ye,0,-1,!1),et(Ie.x0,Ie.y1-1.1,0,Ie.x1-Ie.x0,1.1,Ye,0,1,!1),et(Ie.x0,Ie.y0+1.1,0,1.1,Ie.y1-Ie.y0-2.2,Ye,-1,0,!1),et(Ie.x1-1.1,Ie.y0+1.1,0,1.1,Ie.y1-Ie.y0-2.2,Ye,1,0,!1),et(34.5,Ie.y0+1.1,0,.7,40,Ye*.86,0,0,!0);const n=Ne("gis","power");for(let o=0;o<3;o++){const a=56+o*10;J(n,11,a,0,3.4,6.4,2.6,de.gray),Gn(n,[15.5,a+1.6,1.9],[27,a+1.6,1.9],1.05,"#C9D2DA",{seg:14}),Gn(n,[15.5,a+4.8,1.9],[27,a+4.8,1.9],1.05,"#C9D2DA",{seg:14});for(let l=0;l<3;l++)Tt(n,17.5+l*4,a+3.2,2.6,.75,1.7,"#BEC9D2",{seg:14}),Tt(n,17.5+l*4,a+3.2,4.3,.34,1.1,"#EDE7D8");J(n,27.5,a+.9,0,2.4,4.6,1.7,"#AEB9C2",{noedge:!0})}const i=Ne("fuel","power");for(let o=0;o<2;o++){const a=62+o*6;J(i,3.4,a-1.1,0,2.2,2.2,.4,de.steel,{noedge:!0}),Tt(i,4.5,a,.4,.8,.9,"#C9A94F"),Tt(i,4.5,a,1.3,.6,1.5,"#E3D6BB")}function r(o){Gn(i,[-9,o,2.2],[-9,o+10,2.2],1.9,"#E3D6BB",{seg:16}),J(i,-10.2,o+1.2,0,2.4,.9,1.5,"#B7A88C",{noedge:!0}),J(i,-10.2,o+7.9,0,2.4,.9,1.5,"#B7A88C",{noedge:!0}),Tt(i,-9,o+3.4,4.1,.34,.6,"#B7A88C")}r(52),r(78),Lt(i,[[-9,63,1],[0,63,1],[4.5,63.5,1]],"#C9B98A",.22,!1);const s=Ne(null,null);J(s,37,58,0,2.6,5.6,2.4,"#33383F"),J(s,40.2,58,0,2.6,5.6,2.4,"#33383F"),J(s,37.3,61.2,1.5,2,.22,.6,"#7FD8C8",{noedge:!0})}()}function BT(){xi("f1"),ao(Ee.x0,Ee.y0,zi.f1,Ee.x1-Ee.x0,Ee.y1-Ee.y0,1,"f1"),ao(34,Ie.y0,zi.f1,Ie.x1-34,Ie.y1-Ie.y0,1,"f1");const t=zi.f1;(function(){const n=Ne(null,null);rt(n,7,0,t+.08,91.3,4.2,de.zoneCrah),rt(n,12,6,t+.08,28,13,de.zoneElec),rt(n,42,6,t+.08,16,13,de.zoneElec),rt(n,60,6,t+.08,28,13,de.zoneElec),rt(n,.6,5,t+.08,6.4,11,de.zoneCore),rt(n,98.3,5,t+.08,6.4,11,de.zoneCore),rt(n,20,23,t+.08,14,13,de.zoneCore),rt(n,36,23,t+.08,12,10,de.zoneCore),rt(n,62,23,t+.08,32,13,de.zoneOffice),rt(n,36,58,t+.08,18,32,de.zoneOffice)})(),et(Ee.x0,Ee.y0,t,Ee.x1-Ee.x0,1.1,Ye,0,-1,!1),et(Ee.x0,Ee.y1-1.1,t,Ee.x1-Ee.x0,1.1,Ye,0,1,!1),et(Ee.x0,1.1,t,1.1,Ee.y1-2.2,Ye,-1,0,!1),et(Ee.x1-1.1,1.1,t,1.1,Ee.y1-2.2,Ye,1,0,!1),et(7,4.4,t,91.3,.7,Ye*.86,0,0,!0),et(10.8,4.9,t,.7,15,Ye*.86,0,0,!0),et(41,4.9,t,.7,15,Ye*.86,0,0,!0),et(58.8,4.9,t,.7,15,Ye*.86,0,0,!0),et(12,20.8,t,82,.7,Ye*.86,0,0,!0),et(34.5,Ie.y0,t,.7,46,Ye*.86,0,0,!0),function(){const n=Ne("crah","cooling");for(let i=0;i<8;i++){const r=10+i*11.4;J(n,r,.8,t,6.6,2.8,Ye*.82,de.blue),J(n,r+.3,.95,t+Ye*.82,6,2.5,.55,"#8FA9C0"),dr(n,r+1.8,3.75,t+1.7,1.1),dr(n,r+4.8,3.75,t+1.7,1.1),dr(n,r+1.8,3.75,t+3.9,1.1),dr(n,r+4.8,3.75,t+3.9,1.1)}}(),function(){const n=Ne("ups","power");for(let i=0;i<4;i++){const r=14+i*6.4;J(n,r,7,t,5.4,3.1,2.6,de.yel),J(n,r+.5,10,t+1.9,3.4,.26,.55,"#2E3238"),J(n,r+.8,10.15,t+2.05,1.2,.18,.26,"#57D0A8",{noedge:!0});for(let s=0;s<4;s++)J(n,r+.5,10.1,t+.4+s*.34,3.4,.16,.22,"#C9A94F",{noedge:!0})}for(let i=0;i<4;i++){const r=14+i*6.4;J(n,r,14.5,t,5.4,3.1,2.6,de.yel),J(n,r+.4,17.45,t+.5,4.4,.26,1.5,"#F6E4AE")}}(),function(){const n=Ne("battery","power");for(let i=0;i<2;i++)for(let r=0;r<2;r++){const s=43.5+i*6.8,o=7.5+r*6.4;J(n,s,o,t,5.8,3.6,2.4,de.yel);for(let a=0;a<3;a++)J(n,s+.35,o+3.45,t+.35+a*.75,5.1,.24,.44,"#F6E4AE");J(n,s,o+3.45,t+2.45,5.8,.2,.2,"#C3542F",{noedge:!0})}}(),function(){const n=Ne("switchgear","power");for(let i=0;i<2;i++){const r=7.5+i*7;for(let s=0;s<5;s++){const o=61.5+s*5.3;J(n,o,r,t,4.6,3.1,2.5,de.yel),J(n,o+.4,r+2.95,t+.8,3.8,.26,1.35,"#F6E4AE"),J(n,o+.6,r+3.1,t+1.95,1.3,.2,.33,"#3A3F45",{noedge:!0})}}}(),function(){const n=Ne("mmr","it");for(let i=0;i<3;i++){J(n,1.6,6+i*3.4,t,4.2,2.6,2.5,de.purp);for(let r=0;r<4;r++)J(n,1.75,8.45+i*3.4,t+.4+r*.5,3.9,.2,.3,"#CFC8EE")}for(let i=0;i<2;i++){J(n,99.4,6.5+i*3.8,t,4.2,2.8,2.5,de.purp);for(let r=0;r<3;r++)J(n,99.55,9.15+i*3.8,t+.45+r*.55,3.9,.2,.32,"#CFC8EE")}}(),function(){const n=Ne("bms","mgmt");for(let r=0;r<3;r++){const s=J(n,66+r*7.4,24.2,t+1,6.6,.4,3.6,"#33383F");s.rotation.y=(r-1)*.12,J(n,66.6+r*7.4,24.1,t+1.8,2.1,.22,1.4,r===0?"#7FD8C8":r===1?"#F2C94C":"#E8836A",{noedge:!0,ry:(r-1)*.12}),J(n,69.4+r*7.4,24.1,t+1.6,2.5,.22,1.9,"#8FB4D8",{noedge:!0,ry:(r-1)*.12})}const i=Ne(null,null);J(i,68,30,t+1.05,10,2.6,.4,de.wood),J(i,69,30.6,t,.9,1.4,2.1,de.wood,{noedge:!0}),J(i,76,30.6,t,.9,1.4,2.1,de.wood,{noedge:!0}),J(i,70.4,30.4,t+1.5,1.7,.2,1.1,"#5E7A94"),J(i,73.2,30.4,t+1.5,1.7,.2,1.1,"#5E7A94")}(),function(){const n=Ne(null,null);J(n,22,26,t,2.8,2.2,.4,de.wood,{noedge:!0}),J(n,22,26,t+.4,2.8,2.2,1.5,de.cream2),J(n,26,25,t,2.5,2,2.4,de.cream2),J(n,23,31,t,2.2,1.9,1.5,de.cream2),J(n,40,66,t,7.4,2.4,1.1,de.wood),J(n,41.5,72,t,4.6,1.8,.5,de.rose),J(n,41.5,72,t+.5,4.6,.6,.65,de.rose,{noedge:!0}),J(n,41.5,76,t,4.6,1.8,.5,de.rose),J(n,41.5,76.6,t+.5,4.6,.6,.65,de.rose,{noedge:!0})}()}function kT(){xi("f2"),ao(Ee.x0,Ee.y0,zi.f2,Ee.x1-Ee.x0,Ee.y1-Ee.y0,1,"f2"),ao(Ie.x0,Ie.y0,zi.f2,Ie.x1-Ie.x0,Ie.y1-Ie.y0,1,"f2");const t=zi.f2;(function(){const o=Ne(null,null);rt(o,7,0,t+.08,91.3,4.2,de.zoneCrah),rt(o,10,5,t+.08,85,16.5,de.zoneHall),rt(o,12,24,t+.08,82,10,de.zoneElec),rt(o,.6,5,t+.08,6.4,11,de.zoneCore),rt(o,98.3,5,t+.08,6.4,11,de.zoneCore),rt(o,8,52,t+.08,28,40,de.zoneMech),rt(o,Ie.x0,48,t+.08,6,10,de.zoneMech),rt(o,Ie.x0,86,t+.08,6,10,de.zoneMech),rt(o,30,45,t+.08,10,7,de.zoneCore),rt(o,42,52,t+.08,14,34,de.zoneOffice),rt(o,42,92,t+.08,14,10,de.zoneMeet)})(),et(Ee.x0,Ee.y0,t,Ee.x1-Ee.x0,1.1,Ye,0,-1,!1),et(Ee.x0,Ee.y1-1.1,t,Ee.x1-Ee.x0,1.1,Ye,0,1,!1),et(Ee.x0,1.1,t,1.1,Ee.y1-2.2,Ye,-1,0,!1),et(Ee.x1-1.1,1.1,t,1.1,Ee.y1-2.2,Ye,1,0,!1),et(Ie.x0,Ie.y0,t,Ie.x1-Ie.x0,1.1,Ye,0,-1,!1),et(Ie.x0,Ie.y1-1.1,t,Ie.x1-Ie.x0,1.1,Ye,0,1,!1),et(Ie.x0,Ie.y0+1.1,t,1.1,Ie.y1-Ie.y0-2.2,Ye,-1,0,!1),et(Ie.x1-1.1,Ie.y0+1.1,t,1.1,Ie.y1-Ie.y0-2.2,Ye,1,0,!1),et(7,1.1,t,91.3,.7,Ye*.86,0,0,!0),et(12,22.4,t,82,.7,Ye*.86,0,0,!0),et(7,1.8,t,.7,35,Ye*.86,0,0,!0),et(97.6,1.8,t,.7,35,Ye*.86,0,0,!0),et(40.5,Ie.y0+1.1,t,.7,54,Ye*.86,0,0,!0),function(){const o=Ne("crah","cooling");for(let a=0;a<10;a++){const l=8.6+a*9.1;J(o,l,.8,t,6.4,2.8,Ye*.82,de.blue),J(o,l+.3,.95,t+Ye*.82,5.8,2.5,.55,"#8FA9C0"),dr(o,l+1.7,3.75,t+1.7,1.1),dr(o,l+4.7,3.75,t+1.7,1.1),dr(o,l+1.7,3.75,t+3.9,1.1),dr(o,l+4.7,3.75,t+3.9,1.1)}}();const e=[6.6,9.6,12.6,15.6,18.6],n=13,i=11,r=2.35;(function(){const o=Ne("gpu-rack","it");for(let c=0;c<e.length;c++){const f=e[c];for(const d of[-1,1]){const h=f+d*.75-(d>0?0:1.15);for(let p=0;p<i;p++){const _=n+p*r;J(o,_,h,t,1.9,1.15,2.6,de.rackBody),J(o,_+.15,d>0?h-.06:h+1.15,t+.2,1.6,.06,2.2,de.rackDoor,{noedge:!0}),J(o,_+1.55,d>0?h-.04:h+1.17,t+2.42,.16,.05,.12,"#5FE3A8",{noedge:!0})}J(o,n,f+d*1.55-.15,t+2.95,i*r-.4,.3,.1,de.tray,{noedge:!0})}}const a=Ne("storage","it");for(let c=0;c<4;c++){J(a,72+c%2*3.2,7+Math.floor(c/2)*4.4,t,2.6,2.9,2.6,de.purp);for(let f=0;f<4;f++)J(a,72.15+c%2*3.2,9.75+Math.floor(c/2)*4.4,t+.4+f*.55,2.3,.2,.3,"#CFC8EE")}const l=Ne("network","it");for(let c=0;c<4;c++){J(l,82+c%2*3.2,7+Math.floor(c/2)*4.4,t,2.6,2.9,2.6,de.purp);for(let f=0;f<3;f++)J(l,82.15+c%2*3.2,9.75+Math.floor(c/2)*4.4,t+.35+f*.5,2.3,.2,.22,"#5F51A8",{noedge:!0});J(l,82.15+c%2*3.2,9.75+Math.floor(c/2)*4.4,t+2.15,2.3,.2,.36,"#CFC8EE")}})(),function(){const o=Ne("containment","cooling");for(const a of e)J(o,n-.3,a-.78,t+3.1,i*r,1.56,.12,"#BFD2DE",{op:.28}),J(o,n-.3,a-.78,t+2.6,.1,1.56,.5,"#BFD2DE",{op:.24}),J(o,n-.3+i*r-.1,a-.78,t+2.6,.1,1.56,.5,"#BFD2DE",{op:.24})}(),function(){const o=Ne("cdu","cooling");for(let l=0;l<e.length;l++){const c=42+l*4.6;J(o,c,23,t,3,2.4,2.4,de.cdu),J(o,c+.3,25.3,t+1.8,1.2,.2,.4,"#2E3238"),Gn(o,[c+.8,25.4,t+.9],[c+.8,25.9,t+.9],.24,"#0FA396",{seg:10}),Gn(o,[c+1.8,25.4,t+.9],[c+1.8,25.9,t+.9],.24,"#E2793B",{seg:10})}const a=Ne("cold-plate","cooling");J(a,n+4*r,e[2]-.7,t+2.62,.5,.7,.5,"#0FA396")}(),function(){const o=Ne("ups","power");for(let c=0;c<4;c++){const f=14+c*6.2;J(o,f,25,t,5.2,3.1,2.6,de.yel),J(o,f+.5,28,t+1.9,3.2,.26,.55,"#2E3238"),J(o,f+.8,28.15,t+2.05,1.2,.18,.26,"#57D0A8",{noedge:!0})}const a=Ne("battery","power");for(let c=0;c<4;c++){const f=46+c*6.2;J(a,f,25,t,5.2,3.4,2.3,de.yel);for(let d=0;d<3;d++)J(a,f+.3,28.25,t+.35+d*.72,4.6,.24,.42,"#F6E4AE");J(a,f,28.25,t+2.35,5.2,.2,.2,"#C3542F",{noedge:!0})}const l=Ne("pdu","power");for(let c=0;c<2;c++){const f=88+c*4.4;J(l,f,25,t,3.6,3,2.5,de.yel);for(let d=0;d<3;d++)J(l,f+.4,27.85,t+.5+d*.5,2.8,.18,.32,"#C9A94F",{noedge:!0});Gn(l,[f+1,27.9,t+2.2],[f+1,28.2,t+2.2],.5,"#F6E4AE",{seg:14})}}(),function(){const o=Ne("busway","power");for(const a of[24,52]){J(o,a-.55,5,t+5.1,1.1,16.5,1,de.yel);for(const l of e)J(o,a-.7,l-.7,t+4.6,1.4,1.4,.6,de.yelD),Lt(o,[[a,l,t+4.7],[a,l,t+3.1]],"#EBB410",.2,!1)}}(),function(){const o=Ne("generator","power");function a(f,d){J(o,f,d,t,12,5.2,.9,"#B7A88C",{noedge:!0}),J(o,f+.3,d+.2,t+.9,2.6,4.8,5.4,"#E4B640");for(let h=0;h<4;h++)J(o,f+.15,d+.6+h*1.05,t+1.6,.18,.7,4.2,"#B58A1C",{noedge:!0});J(o,f+3.2,d+.5,t+.9,5,4.2,4.2,de.yel),Gn(o,[f+8.6,d+2.6,t+3],[f+11.4,d+2.6,t+3],1.5,"#EDBE4B",{seg:16}),Tt(o,f+11.4,d+2.6,t+3,.5,.24,"#C9971B"),Gn(o,[f+3.7,d+.9,t+5.8],[f+7.6,d+.9,t+5.8],.55,"#AFB6BD",{seg:12}),Lt(o,[[f+7.6,d+.9,t+5.8],[f+8.4,d+.9,t+5.8],[f+8.4,d+.9,t+7.2]],"#8E8B82",.3,!1),J(o,f+4.8,d+4.8,t+5.3,2,.24,1.2,"#2E3238")}a(10,56),a(23,56),a(10,74),a(23,74);const l=Ne(null,null);for(let f=0;f<6;f++)J(l,8.3,55+f*6,t+1+f%2,.3,4,3,"#C6CDD3",{noedge:!0});const c=Ne("fuel","power");for(const f of[50,88])Tt(c,4.6,f+3,t,1.7,4.6,"#E3D6BB",{seg:16}),Tt(c,4.6,f+3,t+4.6,1.75,.3,"#C9B98A",{seg:16}),Lt(c,[[4.6,f+3,t+1],[9,f+5,t+1]],"#C9B98A",.2,!1)}(),function(){const o=Ne("fire-gas","mgmt");for(let a=0;a<6;a++){const l=31.5+a%3*1.8,c=47+Math.floor(a/3)*2.2;Tt(o,l,c,t,.62,3.2,"#EDBE4B"),Tt(o,l,c,t+3.2,.26,.5,"#8A8577")}J(o,36.8,46.4,t,2,4.6,2.2,"#CBD1D7")}(),function(){const o=Ne(null,null);for(let a=0;a<3;a++)J(o,44,56+a*9,t,8,2.2,1.05,de.wood),J(o,45,56.4+a*9,t+1.1,1.6,.2,1,"#5E7A94"),J(o,48.5,56.4+a*9,t+1.1,1.6,.2,1,"#5E7A94"),J(o,45.5,59+a*9,t,1,1,1.1,"#6B7280",{noedge:!0}),J(o,49,59+a*9,t,1,1,1.1,"#6B7280",{noedge:!0});J(o,45,94.5,t,8,3.4,1.05,de.wood);for(let a=0;a<4;a++)J(o,45.6+a*1.9,93.2,t,.9,.9,1.1,"#6B7280",{noedge:!0}),J(o,45.6+a*1.9,98.3,t,.9,.9,1.1,"#6B7280",{noedge:!0})}()}function zT(){xi("roof"),ao(Ee.x0,Ee.y0,zi.roof,Ee.x1-Ee.x0,Ee.y1-Ee.y0,1,"roof",de.roof,de.roofTop,.8),ao(Ie.x0,Ie.y0,zi.roof,Ie.x1-Ie.x0,Ie.y1-Ie.y0,1,"roof",de.roof,de.roofTop,.62);const t=zi.roof;(function(){const n=Ne(null,null);J(n,Ee.x0,Ee.y0,t,Ee.x1-Ee.x0,.5,1.1,de.roof,{noedge:!0}),J(n,Ee.x0,Ee.y1-.5,t,Ee.x1-Ee.x0,.5,1.1,de.roof,{noedge:!0}),J(n,Ee.x0,Ee.y0,t,.5,Ee.y1-Ee.y0,1.1,de.roof,{noedge:!0}),J(n,Ee.x1-.5,Ee.y0,t,.5,Ee.y1-Ee.y0,1.1,de.roof,{noedge:!0})})(),function(){const n=Ne("cooling-tower","cooling");function i(r,s){J(n,r,s,t,10,8,1.4,"#DCD3C2"),J(n,r+.3,s+.3,t+1.4,9.4,7.4,4.2,de.cream2);for(let o=0;o<4;o++)J(n,r+.6,s+7.5,t+1.8+o*.85,8.8,.22,.34,"#C6B89E",{noedge:!0}),J(n,r+9.5,s+.6,t+1.8+o*.85,.22,6.8,.34,"#BCAE93",{noedge:!0});J(n,r,s,t+5.6,10,8,.7,de.cream),ir(n,r+2.7,s+2.4,t+6.3,1.4),ir(n,r+7.3,s+2.4,t+6.3,1.4),ir(n,r+2.7,s+5.7,t+6.3,1.4),ir(n,r+7.3,s+5.7,t+6.3,1.4),O_(n,r+10.3,s+4,t,6.2)}i(12,7),i(26,7),i(40,7)}(),function(){const n=Ne("dry-cooler","cooling");function i(r,s){J(n,r,s,t,7.4,1.5,.85,de.steel,{noedge:!0});const o=J(n,r+.55,s+.4,t+.55,6.3,.4,3.7,"#E4C7A6");o.rotation.x=-.42;const a=J(n,r+.55,s+4.85,t+.55,6.3,.4,3.7,"#E4C7A6");a.rotation.x=.42,J(n,r+.3,s+.3,t+3.4,6.8,4.9,.42,de.cream2),ir(n,r+2,s+2.7,t+3.85,1.2,"#B08A62"),ir(n,r+5.4,s+2.7,t+3.85,1.2,"#B08A62")}i(62,7),i(72,7),i(82,7)}(),function(){const n=Ne(null,null);J(n,62,22,t,7,5.4,2.6,de.cream2),ir(n,65.5,24.7,t+2.6,1.4),J(n,74,22.5,t,6,4.6,2,de.cream2);for(let i=0;i<3;i++)J(n,74.3,27,t+.4+i*.55,5.4,.2,.22,"#BCAE93",{noedge:!0});for(const i of[60,78])J(n,14,i,t,4,4,1,de.cream2),ir(n,16,i+2,t+1,1.3)}()}function HT(){xi("b1"),function(){const e=Ne("gis","power");Lt(e,[[22,54,2.2],[22,43,2.2],[28,40,2.2],[28,24,2.2],[26,14,2.6]],"#EBB410",.34);const n=Ne(null,null),i=[[-6,96],[-2,96],[-6,100],[-2,100]];for(let r=0;r<4;r++)Gn(n,[i[r][0],i[r][1],0],[-4,98,13],.2,"#8A9AA8",{seg:8,pick:!1});J(n,-6.5,97.4,7.6,5,.5,.42,"#8A9AA8",{noedge:!0})}(),function(){const e=Ne("switchgear","power");Lt(e,[[26,14,2.6],[44,14,2.6],[51,10,3]],"#EBB410",.3,!1),Lt(e,[[56,10,3],[76,30,3],[101.5,30,3],[101.5,30,20.5],[93,27,20.5]],"#EBB410",.34),Lt(e,[[24,8,2.8],[3.6,8,2.8],[3.6,8,11.6],[15,8.5,11.6]],"#EBB410",.3)}(),function(){const e=Ne("fws","cooling");Lt(e,[[17,12,28.6],[17,33,28.6],[96,33,28.6],[96,33,3.6],[86,12,3.9]],"#9CC6E4",.42)}(),function(){const e=Ne("fws","cooling");Lt(e,[[80,6,2.4],[60,2.5,2.4],[9.5,2.5,2.4],[9.5,2.5,21.9],[94,2.5,21.9]],"#3E9CD6",.42),xi("f1"),Lt(e,[[9.5,2.5,12.9],[94,2.5,12.9]],"#3E9CD6",.3);for(const n of[16,39,62,85])Lt(e,[[n,2.5,12.9],[n,2.5,11.2]],"#3E9CD6",.2,!1);xi("f2");for(const n of[16,39,62,85])Lt(e,[[n,2.5,21.9],[n,2.5,20.2]],"#3E9CD6",.2,!1)}(),xi("f2"),function(){const e=Ne("fws","cooling");Lt(e,[[43,26.2,20.7],[60,26.2,20.7],[96.5,26.2,20.7],[96.5,26.2,28.6],[96.5,9,28.6],[90,9,28.6]],"#E2793B",.42)}(),function(){const e=Ne("tcs","cooling"),n=Ne("manifold","cooling"),i=[6.6,9.6,12.6,15.6,18.6];for(let r=0;r<i.length;r++){const s=43.5+r*4.6;Lt(e,[[s,23,20.4],[s,21.6,21.5],[s,i[r],21.5]],"#0FA396",.26),Lt(n,[[s,i[r],21.5],[13.5,i[r],21.5]],"#0FA396",.26,!1)}}(),function(){const e=Ne("busway","power");Lt(e,[[24,24.5,20.8],[24,21.5,23.6],[24,5.5,23.6]],"#EBB410",.28),Lt(e,[[52,24.5,20.8],[52,21.5,23.6],[52,5.5,23.6]],"#EBB410",.28)}(),function(){const e=Ne("generator","power");Lt(e,[[16,56,24.6],[16,44,24.6],[80,44,24.6],[101.5,33,24.6],[101.5,30,20.8]],"#EBB410",.3)}(),xi(null)}const kr=[["cooling-tower",[31,11,34.2]],["dry-cooler",[75.5,9.5,31.5]],["crah",[50,2.2,23.6]],["gpu-rack",[26,12.6,21.4]],["containment",[38,15.6,21.3]],["cold-plate",[22.7,12,20.9]],["manifold",[20,9.6,21.6]],["tcs",[47,20,21.6]],["cdu",[52,24.2,20.4]],["busway",[52,8,23.7]],["pdu",[90,26.5,20.6]],["storage",[74.5,9,20.8]],["network",[84.5,9,20.8]],["mmr",[3.8,9,11.6]],["ups",[24,8.6,11.8]],["battery",[50,10.6,11.6]],["switchgear",[26,12,2.6]],["transformer",[55,7.5,3.4]],["gis",[21,66,3.2]],["fuel",[-9,57,4.2]],["generator",[17,78.6,23]],["fire-gas",[34,48,21.6]],["chiller",[79,6.3,2.6]],["pumps",[90,8.8,2.2]],["water-treatment",[95.7,12,4.4]],["tes",[82,25.5,7]],["fws",[9.5,2.5,17]],["bms",[77,25,12.8]]];function VT(t,e,n){return new k(t-Dr,n,e-Lr)}const GT=t=>t<8?"b1":t<17?"f1":t<26?"f2":"roof";function WT(){const t=_i.useRef(null),e=xt(i=>i.floor),n=xt(i=>i.setFloor);return _i.useEffect(()=>{const i=t.current,r=i.querySelector("canvas"),s=i.querySelector(".leaders"),o=i.querySelector(".selected-leader"),a=i.querySelector(".labels"),l=i.querySelector(".tip3d"),c=new ET({canvas:r,antialias:!0});c.setPixelRatio(Math.min(window.devicePixelRatio||1,2.5)),c.setClearColor(16777215,1),c.outputColorSpace=ni;const f=new wT,d=new Hn(33,1,1,4e3),h=new k(-22,6,-6),p={az:-.62,pol:1.06,dist:315},_={az:-.62,pol:1.06,dist:315,tx:-22,ty:6,tz:-6};function x(){const D=Math.sin(p.pol),z=Math.cos(p.pol);d.position.set(h.x+p.dist*D*Math.sin(p.az),h.y+p.dist*z,h.z+p.dist*D*Math.cos(p.az)),d.lookAt(h),w()}f.add(new AT(16777215,14212578,.95));const m=new zm(16777215,.55);m.position.set(120,180,80),f.add(m);const u=new zm(16777215,.22);u.position.set(-100,80,-120),f.add(u),FT(f);const{groupReg:g,pickables:v,wallsFade:M,flows:P,slabs:R}=pt;(function(){const z=[];for(const H in g)g[H].traverse(j=>{if(!j.isMesh||!j.material||!j.material.color||j.userData.flowPart||j.userData.selectionOutline||z.indexOf(j.material)!==-1)return;z.push(j.material);const T={h:0,s:0,l:0};j.material.color.getHSL(T),T.s>.04&&(T.s=Math.min(1,T.s*1.2)),T.l=Math.max(.08,T.l-(T.l>.78?.095:.065)),j.material.color.setHSL(T.h,T.s,T.l)})})();const A=[],b={};for(let D=0;D<kr.length;D++){const z=kr[D][0],H=rn[z];b[z]=kr[D][1][2];const j=document.createElement("div");j.className="lbl",j.setAttribute("data-label-id",z),j.style.setProperty("--cat",Gr[H.cat].color),j.innerHTML='<div class="lt">'+H.name+'</div><div class="le">'+H.en+"</div>",j.addEventListener("click",L=>{L.stopPropagation(),K(),xt.getState().setSelected(z)}),j.addEventListener("mouseenter",L=>ee(z,L)),j.addEventListener("mousemove",oe),j.addEventListener("mouseleave",K),a.appendChild(j);const T=document.createElementNS("http://www.w3.org/2000/svg","line");T.setAttribute("stroke","#929497"),T.setAttribute("stroke-width","1.6"),T.setAttribute("stroke-dasharray","0.1 7"),T.setAttribute("stroke-linecap","round"),T.setAttribute("stroke-opacity","0.88"),s.appendChild(T);const N=document.createElementNS("http://www.w3.org/2000/svg","circle");N.setAttribute("r","1.25"),N.setAttribute("fill","#929497"),N.setAttribute("stroke","#929497"),N.setAttribute("stroke-opacity","0.88"),s.appendChild(N),A.push({id:z,anchor:VT(kr[D][1][0],kr[D][1][1],kr[D][1][2]),div:j,line:T,dot:N,hidden:!1,sx:0,sy:0,floor:GT(kr[D][1][2])})}let Q=!0,y=null;function w(){i.classList.add("labels-moving"),Q=!0,y&&clearTimeout(y),y=setTimeout(()=>{i.classList.remove("labels-moving"),X(!0)},260)}function X(D){if(i.classList.contains("labels-moving")||!D&&!Q)return;Q=!1;const z=i.clientWidth,H=i.clientHeight;if(!z||!H)return;const j=[],T=Math.max(104,Math.min(140,z*.105)),N=31;for(let W=0;W<A.length;W++){const $=A[W];if($.hidden){$.div.classList.add("hid"),$.line.setAttribute("opacity","0"),$.dot.setAttribute("opacity","0");continue}const Z=$.anchor.clone().project(d);$.sx=(Z.x*.5+.5)*z,$.sy=(-Z.y*.5+.5)*H,$.div.classList.remove("hid"),$.div.style.width=T+"px",$.div.style.maxWidth=T+"px",j.push($)}if(!j.length)return;const L={l:Math.max(18,z*.018)+96,r:z-Math.max(18,z*.018)-20,t:Math.max(16,H*.025)+50,b:H-Math.max(16,H*.025)-40},V=Math.max(30,z*.022),ae=Math.max(26,H*.038),xe=L.r-L.l,ke=Math.max(4,Math.floor((xe+V)/(T+V)));let at=Math.min(ke,Math.ceil(j.length*.34)),gt=Math.min(ke,Math.ceil(j.length*.34)),$e=Math.max(0,j.length-at-gt),Rt=Math.ceil($e/2),dt=$e-Rt;const mn=Math.max(Rt,dt),Nt=L.b-L.t-N*2-ae*2;if(mn>1&&Nt/(mn-1)<N+ae){const W=j.length-(Math.floor(Nt/(N+ae))+1)*2;at=Math.min(ke,Math.ceil(W/2)),gt=Math.min(ke,W-at),$e=Math.max(0,j.length-at-gt),Rt=Math.ceil($e/2),dt=$e-Rt}const je=[];function gn(W,$,Z){if(!W)return;const le=xe-T;for(let me=0;me<W;me++)je.push({x:L.l+(W===1?le/2:le*me/(W-1)),y:$,side:Z})}function ln(W,$,Z){if(!W)return;const le=L.t+N+ae,me=L.b-N*2-ae;for(let ue=0;ue<W;ue++)je.push({x:$,y:W===1?(le+me)/2:le+(me-le)*ue/(W-1),side:Z})}gn(at,L.t,"top"),gn(gt,L.b-N,"bottom"),ln(Rt,L.l,"left"),ln(dt,L.r-T,"right"),function(){const $=L.r-T,Z=L.t,le=L.b-N,me=Math.max(18,(T+V)/4),ue=Math.max(14,(N+ae)/3);for(let Le=L.l;Le<=$+.5;Le+=me)je.push({x:Math.min(Le,$),y:Z,side:"top"}),je.push({x:Math.min(Le,$),y:le,side:"bottom"});je.push({x:$,y:Z,side:"top"}),je.push({x:$,y:le,side:"bottom"});const Pe=L.t+N+ae,De=L.b-N*2-ae;for(let Le=Pe;Le<=De+.5;Le+=ue)je.push({x:L.l,y:Math.min(Le,De),side:"left"}),je.push({x:L.r-T,y:Math.min(Le,De),side:"right"});je.push({x:L.l,y:De,side:"left"}),je.push({x:L.r-T,y:De,side:"right"})}();function di(){const W=[],$=new ho,Z=new k;return f.updateMatrixWorld(!0),d.updateMatrixWorld(!0),f.traverse(le=>{if(!le.isMesh||!le.visible||le.userData.groundSurface||le.userData.selectionOutline||le.userData.flowParticle||($.setFromObject(le),$.isEmpty()))return;let me=1/0,ue=1/0,Pe=-1/0,De=-1/0,Le=!1;for(let vt=0;vt<2;vt++)for(let We=0;We<2;We++)for(let Me=0;Me<2;Me++){if(Z.set(vt?$.max.x:$.min.x,We?$.max.y:$.min.y,Me?$.max.z:$.min.z).project(d),!isFinite(Z.x)||!isFinite(Z.y))continue;const _t=(Z.x*.5+.5)*z,Je=(-Z.y*.5+.5)*H;Le=!0,me=Math.min(me,_t),Pe=Math.max(Pe,_t),ue=Math.min(ue,Je),De=Math.max(De,Je)}!Le||Pe<0||me>z||De<0||ue>H||W.push({l:me-4,r:Pe+4,t:ue-4,b:De+4})}),W}const hi=[z,H,d.position.x.toFixed(3),d.position.y.toFixed(3),d.position.z.toFixed(3),d.quaternion.x.toFixed(5),d.quaternion.y.toFixed(5),d.quaternion.z.toFixed(5),d.quaternion.w.toFixed(5)].join("|");let _n;X._key===hi&&X._rects?_n=X._rects:(_n=di(),X._key=hi,X._rects=_n);function wi(W){const $=W.x-3,Z=W.x+T+3,le=W.y-3,me=W.y+N+3;let ue=0,Pe=0;for(let De=0;De<_n.length;De++){const Le=_n[De],vt=Math.min(Z,Le.r)-Math.max($,Le.l),We=Math.min(me,Le.b)-Math.max(le,Le.t);vt>0&&We>0&&(Pe++,ue=Math.max(ue,vt*We))}return ue?24e4+ue*45+Math.min(Pe,8)*3500:0}for(let W=0;W<je.length;W++)je[W].modelPenalty=wi(je[W]);function Ti(W,$,Z,le){function me(ue,Pe,De){return(De.y-ue.y)*(Pe.x-ue.x)>(Pe.y-ue.y)*(De.x-ue.x)}return me(W,Z,le)!==me($,Z,le)&&me(W,$,Z)!==me(W,$,le)}function ls(W,$,Z){const le={l:Z.x+5,r:Z.x+T,t:Z.y+1,b:Z.y+N-1};if(W.x>le.l&&W.x<le.r&&W.y>le.t&&W.y<le.b)return!0;const me={x:le.l,y:le.t},ue={x:le.r,y:le.t},Pe={x:le.r,y:le.b},De={x:le.l,y:le.b};return Ti(W,$,me,ue)||Ti(W,$,ue,Pe)||Ti(W,$,Pe,De)||Ti(W,$,De,me)}function Ai(W,$){const Z={x:W.x,y:W.y},le={x:W.x,y:W.y+N-2},me={x:$.sx,y:$.sy},ue=(ls(me,Z,W)?1e6:0)+Math.hypot(me.x-Z.x,me.y-Z.y),Pe=(ls(me,le,W)?1e6:0)+Math.hypot(me.x-le.x,me.y-le.y);return ue<=Pe?Z:le}function ya(W,$){return!(W.x+T+V<=$.x||$.x+T+V<=W.x||W.y+N+ae<=$.y||$.y+N+ae<=W.y)}const qi=z/2,E=H/2,F={},O=[];j.sort((W,$)=>Math.hypot($.sx-qi,$.sy-E)-Math.hypot(W.sx-qi,W.sy-E));for(let W=0;W<j.length;W++){const $=j[W];let Z=-1,le=1/0,me=$.sx-qi,ue=$.sy-E;const Pe=Math.max(1,Math.hypot(me,ue));me/=Pe,ue/=Pe;for(let De=0;De<2;De++){for(let Le=0;Le<je.length;Le++){if(F[Le])continue;let vt=!1;for(let Qt=0;Qt<O.length;Qt++)if(ya(je[Le],O[Qt].slot)){vt=!0;break}if(De===0&&vt)continue;const We=Ai(je[Le],$);let Me=We.x-qi,_t=We.y-E;const Je=Math.max(1,Math.hypot(Me,_t));Me/=Je,_t/=Je;let cn=Math.hypot($.sx-We.x,$.sy-We.y)+(1-(me*Me+ue*_t))*1100+(je[Le].modelPenalty||0)+(vt?5e6:0);for(let Qt=0;Qt<O.length;Qt++)Ti({x:$.sx,y:$.sy},We,{x:O[Qt].item.sx,y:O[Qt].item.sy},O[Qt].end)&&(cn+=1e5);cn<le&&(le=cn,Z=Le)}if(Z>=0)break}Z<0||(F[Z]=!0,O.push({item:$,slot:je[Z],end:Ai(je[Z],$)}))}function q(W){let $=0;for(let Z=0;Z<W.length;Z++){const le=W[Z].item,me=Ai(W[Z].slot,le),ue=le.sx-qi,Pe=le.sy-E,De=Math.max(1,Math.hypot(ue,Pe)),Le=me.x-qi,vt=me.y-E,We=Math.max(1,Math.hypot(Le,vt));$+=Math.hypot(le.sx-me.x,le.sy-me.y)+(1-(ue/De*Le/We+Pe/De*vt/We))*700+(W[Z].slot.modelPenalty||0);for(let Me=0;Me<W.length;Me++)Me!==Z&&ls({x:le.sx,y:le.sy},me,W[Me].slot)&&($+=45e3);for(let Me=Z+1;Me<W.length;Me++){const _t=W[Me].item,Je=Ai(W[Me].slot,_t);Ti({x:le.sx,y:le.sy},me,{x:_t.sx,y:_t.sy},Je)&&($+=14e4),ya(W[Z].slot,W[Me].slot)&&($+=8e6)}}return $}let B=q(O);for(let W=0;W<18;W++){let $=-1,Z=-1,le=B;for(let ue=0;ue<O.length-1;ue++)for(let Pe=ue+1;Pe<O.length;Pe++){let De=O[ue].slot;O[ue].slot=O[Pe].slot,O[Pe].slot=De;const Le=q(O);De=O[ue].slot,O[ue].slot=O[Pe].slot,O[Pe].slot=De,Le<le-.5&&(le=Le,$=ue,Z=Pe)}if($<0)break;const me=O[$].slot;O[$].slot=O[Z].slot,O[Z].slot=me,O[$].end=Ai(O[$].slot,O[$].item),O[Z].end=Ai(O[Z].slot,O[Z].item),B=le}const ge=xt.getState().selected;for(let W=0;W<O.length;W++){const $=O[W],Z=$.item,le=$.slot.x,me=$.slot.y;Z.div.style.left=le+"px",Z.div.style.top=me+"px";const ue=Ai($.slot,Z),Pe=ue.x,De=ue.y,Le=Xe(Z,Pe,De,z,H);Z.line.setAttribute("x1",Le.x),Z.line.setAttribute("y1",Le.y),Z.line.setAttribute("x2",Pe),Z.line.setAttribute("y2",De),Z.dot.setAttribute("cx",Le.x),Z.dot.setAttribute("cy",Le.y),Z.line.setAttribute("opacity",Z.id===ge?"1":ge?".6":".78"),Z.dot.setAttribute("opacity",Z.id===ge?"1":ge?".6":".78")}}function Y(){const D=i.clientWidth,z=i.clientHeight,H=xt.getState().selected;for(let j=0;j<A.length;j++){const T=A[j],N=parseFloat(T.line.getAttribute("x2")),L=parseFloat(T.line.getAttribute("y2"));if(!isFinite(N)||!isFinite(L))continue;const V=T.id===H?Xe(T,N,L,D,z):{x:T.sx,y:T.sy};T.line.setAttribute("x1",V.x),T.line.setAttribute("y1",V.y),T.dot.setAttribute("cx",V.x),T.dot.setAttribute("cy",V.y)}}function ee(D,z){const H=rn[D];H&&(l.style.setProperty("--tip-color",Gr[H.cat].color),l.classList.toggle("power-tip",H.cat==="power"),l.innerHTML='<div class="t-name">'+H.name+'</div><div class="t-en">'+H.en+'</div><div class="t-short">'+H.short+"</div>",l.style.display="block",z&&oe(z))}function oe(D){const z=i.getBoundingClientRect(),H=D.clientX-z.left,j=D.clientY-z.top,T=14;let N=H+T,L=j+T;const V=l.getBoundingClientRect();N+V.width>z.width-8&&(N=H-V.width-T),L+V.height>z.height-8&&(L=j-V.height-T),l.style.left=N+"px",l.style.top=L+"px"}function K(){l.style.display="none"}function ce(D,z){const H=g[D];H&&H.traverse(j=>{j.material&&z(j)})}let I=null;function se(D){I!==D&&(I&&ce(I,z=>{z.material.emissive&&!z.userData.flowPart&&z.material.emissive.setHex(0)}),I=D,I&&ce(I,z=>{z.material.emissive&&!z.userData.flowPart&&z.material.emissive.setHex(2443119)}))}let re=[];function ve(){for(let D=0;D<re.length;D++){const z=re[D];z.material.color.copy(z.color),z.emissive&&z.material.emissive.copy(z.emissive),z.hadVC&&(z.material.vertexColors=!0,z.material.needsUpdate=!0)}re=[]}function Fe(D){ve();const z=g[D],H=new ze("#d2d4d6");f.traverse(j=>{if(!j.material||!j.material.color||j.userData.selectionOutline)return;for(let N=j;N;N=N.parent)if(N===z)return;for(let N=0;N<re.length;N++)if(re[N].material===j.material)return;const T={material:j.material,color:j.material.color.clone()};j.material.emissive&&(T.emissive=j.material.emissive.clone()),j.material.vertexColors?(T.hadVC=!0,j.material.vertexColors=!1,j.material.needsUpdate=!0,j.material.color.set("#c4c7ca")):j.material.color.lerp(H,.78),j.material.emissive&&j.material.emissive.setHex(0),re.push(T)})}let Qe=[];function te(){for(let D=0;D<Qe.length;D++){const z=Qe[D];z.parent&&z.parent.remove(z),z.geometry&&z.geometry.dispose(),z.material&&z.material.dispose()}Qe=[]}function he(D,z,H,j,T){const N=new k().subVectors(H,z),L=N.length();if(L<.01)return;const V=new St(new Er(j,j,L,6,1,!1),T.clone());V.position.copy(z).add(H).multiplyScalar(.5),V.quaternion.setFromUnitVectors(new k(0,1,0),N.normalize()),V.userData.selectionOutline=!0,V.renderOrder=80,D.add(V),Qe.push(V)}function Te(D){te();const z=g[D];if(!z)return;const H=[];let j=0;const T=new k;z.traverse(V=>{if(!V.isMesh||!V.geometry||V.userData.flowPart||V.userData.selectionOutline||(V.geometry.computeBoundingBox(),!V.geometry.boundingBox))return;const ae=V.geometry.boundingBox.getSize(T).length();j=Math.max(j,ae),H.push({mesh:V,diag:ae})});const N=Math.max(.06,Math.min(.13,j*.0065)),L=new Ac({color:0,depthTest:!0,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-2,polygonOffsetUnits:-2});for(let V=0;V<H.length;V++){const ae=H[V].mesh,xe=ae.geometry.type||"";if(H[V].diag<j*.26||!/BoxGeometry|CylinderGeometry/.test(xe))continue;const ke=new Ch(ae.geometry,24),at=ke.attributes.position;for(let gt=0;gt<at.count;gt+=2)he(ae,new k().fromBufferAttribute(at,gt),new k().fromBufferAttribute(at,gt+1),N,L);ke.dispose()}L.dispose()}function we(D){if(D.length<3)return D;D.sort((T,N)=>T.x===N.x?T.y-N.y:T.x-N.x);function z(T,N,L){return(N.x-T.x)*(L.y-T.y)-(N.y-T.y)*(L.x-T.x)}const H=[],j=[];for(let T=0;T<D.length;T++){for(;H.length>=2&&z(H[H.length-2],H[H.length-1],D[T])<=0;)H.pop();H.push(D[T])}for(let T=D.length-1;T>=0;T--){for(;j.length>=2&&z(j[j.length-2],j[j.length-1],D[T])<=0;)j.pop();j.push(D[T])}return H.pop(),j.pop(),H.concat(j)}function Xe(D,z,H,j,T){const N=xt.getState().selected;if(D.id!==N||!g[D.id])return{x:D.sx,y:D.sy};const L=[],V=g[D.id];V.updateMatrixWorld(!0),V.traverse(dt=>{if(!dt.isMesh||!dt.geometry||dt.userData.selectionOutline||dt.userData.flowPart)return;dt.geometry.computeBoundingBox();const mn=dt.geometry.boundingBox;if(!mn)return;const Nt=mn.min,je=mn.max,gn=[[Nt.x,Nt.y,Nt.z],[je.x,Nt.y,Nt.z],[Nt.x,je.y,Nt.z],[je.x,je.y,Nt.z],[Nt.x,Nt.y,je.z],[je.x,Nt.y,je.z],[Nt.x,je.y,je.z],[je.x,je.y,je.z]];for(let ln=0;ln<gn.length;ln++){const di=new k(gn[ln][0],gn[ln][1],gn[ln][2]).applyMatrix4(dt.matrixWorld).project(d);L.push({x:(di.x*.5+.5)*j,y:(-di.y*.5+.5)*T})}});const ae=we(L);if(ae.length<3)return{x:D.sx,y:D.sy};let xe=0,ke=0;for(let dt=0;dt<ae.length;dt++)xe+=ae[dt].x,ke+=ae[dt].y;xe/=ae.length,ke/=ae.length;const at=z-xe,gt=H-ke;let $e=1/0,Rt=null;for(let dt=0;dt<ae.length;dt++){const mn=ae[dt],Nt=ae[(dt+1)%ae.length],je=Nt.x-mn.x,gn=Nt.y-mn.y,ln=at*gn-gt*je;if(Math.abs(ln)<1e-4)continue;const di=mn.x-xe,hi=mn.y-ke,_n=(di*gn-hi*je)/ln,wi=(di*gt-hi*at)/ln;_n>0&&wi>=0&&wi<=1&&_n<$e&&($e=_n,Rt={x:xe+at*_n,y:ke+gt*_n})}return Rt||{x:D.sx,y:D.sy}}let Oe=[];function ot(){for(let D=0;D<Oe.length;D++)Oe[D].m.depthTest=Oe[D].dt,Oe[D].obj.renderOrder=Oe[D].ro;Oe=[]}function ct(){const D=xt.getState().selected;for(let z=0;z<A.length;z++){const H=A[z];if(H.hidden){H.div.classList.remove("sel","dim"),H.line.setAttribute("opacity","0"),H.dot.setAttribute("opacity","0"),s.appendChild(H.line),s.appendChild(H.dot);continue}const j=H.id===D;H.div.classList.toggle("sel",j),H.div.classList.toggle("dim",!!D&&!j),H.line.setAttribute("stroke",j?"#000":"#929497"),H.line.setAttribute("stroke-width",j?"1.65":"1.6"),H.dot.setAttribute("fill",j?"#000":"#929497"),H.dot.setAttribute("r",j?"2.24":"1.25"),H.dot.setAttribute("stroke",j?"#000":"#929497"),H.dot.setAttribute("stroke-opacity",j?"1":".88"),H.line.setAttribute("stroke-opacity",j?"1":".88"),H.line.setAttribute("opacity",j?"1":D?".6":".78"),H.dot.setAttribute("opacity",j?"1":D?".6":".78"),(j?o:s).appendChild(H.line),(j?o:s).appendChild(H.dot)}}function tt(){const{filter:D,floor:z}=xt.getState();f.traverse(H=>{if(!H.material)return;const j=H.material.userData&&H.material.userData.baseOp!==void 0?H.material.userData.baseOp:1;let T=!1;for(let L=H;L;L=L.parent)if(L.userData&&L.userData.cat){T=D!=="all"&&L.userData.cat!==D;break}const N=z!=="all"&&H.userData.floor&&H.userData.floor!==z;H.userData._dimmed=T||!!N,H.userData._floorHidden=!!N,H.visible=!N,H.material.transparent=T||j<1,H.material.opacity=T?H.isLineSegments?.03:.06:j});for(let H=0;H<A.length;H++){const j=A[H],T=rn[j.id].cat;j.hidden=D!=="all"&&T!==D||z!=="all"&&j.floor!==z}Q=!0,X(!0),ct(),U()}function U(){const{flowState:D}=xt.getState();for(let z=0;z<P.length;z++){const H=!!D[P[z].key];P[z].enabled=H;for(let j=0;j<P[z].parts.length;j++){const T=P[z].parts[j],N=T.material;if(T.visible=!T.userData._floorHidden,N.userData||(N.userData={}),N.userData.flowBaseColor||(N.userData.flowBaseColor=N.color.clone()),N.color.copy(N.userData.flowBaseColor),H||N.color.lerp(new ze("#c8cacc"),.74),T.userData._dimmed)continue;const L=N.userData.baseOp===void 0?1:N.userData.baseOp;N.transparent=!H||L<1,N.opacity=H?L:Math.min(.58,L*.58),N.needsUpdate=!0}for(let j=0;j<P[z].dots.length;j++)P[z].dots[j].visible=H&&!P[z].dots[j].userData._floorHidden}}let zt=0;const qe={x:0,y:0};let nt=!1;const Be=new PT,ut=new ft;function Ge(D){zt=D.button===2?2:1,nt=!1,qe.x=D.clientX,qe.y=D.clientY}function C(D){if(!zt){ne(D);return}const z=D.clientX-qe.x,H=D.clientY-qe.y;if(Math.abs(z)+Math.abs(H)>3&&(nt=!0),qe.x=D.clientX,qe.y=D.clientY,zt===1)p.az-=z*.0052,p.pol=Math.max(.28,Math.min(1.38,p.pol-H*.0042));else{const j=p.dist*.0011,T=new k().subVectors(d.position,h).cross(new k(0,1,0)).normalize(),N=new k(0,1,0);h.add(T.multiplyScalar(z*j)).add(N.multiplyScalar(H*j))}x()}function S(){zt=0}function G(D){D.preventDefault();const z=Math.max(28,Math.min(560,p.dist*(D.deltaY>0?1.1:1/1.1))),H=z/p.dist,j=r.getBoundingClientRect();ut.x=(D.clientX-j.left)/j.width*2-1,ut.y=-((D.clientY-j.top)/j.height)*2+1,Be.setFromCamera(ut,d);let T=new k;const N=Be.intersectObjects(v,!1);N.length?T.copy(N[0].point):Be.ray.intersectPlane(new or(new k(0,1,0),0),T)||(T=null),T&&h.lerp(T,1-H),p.dist=z,x()}function ie(D){let z=D;for(;z;){if(z.userData&&z.userData.term)return z.userData.term;z=z.parent}return null}function fe(D){const z=r.getBoundingClientRect();ut.x=(D.clientX-z.left)/z.width*2-1,ut.y=-((D.clientY-z.top)/z.height)*2+1,Be.setFromCamera(ut,d);const H=Be.intersectObjects(v,!1),{filter:j,floor:T}=xt.getState();for(let N=0;N<H.length;N++){const L=H[N].object;if(L.userData._dimmed)continue;const V=ie(L);if(V){if(j!=="all"&&rn[V]&&rn[V].cat!==j||T!=="all"&&L.userData.floor&&L.userData.floor!==T)continue;return V}}return null}function ne(D){if(D.target!==r){se(null);return}const z=fe(D);se(z),z?(ee(z,D),r.style.cursor="pointer"):(K(),r.style.cursor=zt?"grabbing":"default")}function Ue(D){if(nt){nt=!1;return}const z=fe(D);xt.getState().setSelected(z||null)}r.addEventListener("mousedown",Ge),window.addEventListener("mousemove",C),window.addEventListener("mouseup",S),r.addEventListener("contextmenu",D=>D.preventDefault()),r.addEventListener("wheel",G,{passive:!1}),r.addEventListener("click",Ue);let ye={selected:null,filter:"all",floor:"all",flowState:xt.getState().flowState,resetTick:0};const Ae=xt.subscribe(D=>{if(D.resetTick!==ye.resetTick&&(p.az=_.az,p.pol=_.pol,p.dist=_.dist,h.set(_.tx,_.ty,_.tz),x()),(D.filter!==ye.filter||D.floor!==ye.floor)&&(tt(),D.selected&&D.filter!=="all"&&rn[D.selected].cat!==D.filter&&D.setSelected(null)),D.flowState!==ye.flowState&&(U(),D.selected&&Fe(D.selected)),D.selected!==ye.selected)if(D.selected){ct(),Y();const z=D.selected;requestAnimationFrame(()=>{xt.getState().selected===z&&(Fe(z),ot(),Te(z),Y())})}else ot(),te(),ve(),ct(),Y();ye={selected:D.selected,filter:D.filter,floor:D.floor,flowState:D.flowState,resetTick:D.resetTick}}),it=new k;let _e=0;function Ce(D){_e=requestAnimationFrame(Ce),it.subVectors(d.position,h),it.y=0,it.normalize();for(let T=0;T<M.length;T++){const N=M[T],L=N.m.userData._dimmed?.06:N.n.dot(it)>.18?.07:.95;N.m.material.transparent=!0,N.m.material.opacity+=(L-N.m.material.opacity)*.18,N.e.material.opacity=N.m.material.opacity>.4?N.e.material.userData.baseOp:0}const z=xt.getState().selected,H=z!=null&&b[z]!==void 0?b[z]:1/0;for(let T=0;T<R.length;T++){const N=R[T];let L=N.baseOp;N.m.userData._dimmed?L=.06:H<N.zTop-1?L=.08:N.floor==="roof"&&p.pol<.62&&(L=.1),N.m.material.transparent=!0,N.m.material.opacity+=(L-N.m.material.opacity)*.15,N.e.material.transparent=!0,N.e.material.opacity=N.m.material.opacity>.4?1:0,N.top.material.opacity=Math.min(N.top.material.userData.baseOp,N.m.material.opacity)}const j=(D||0)*1e-4;for(let T=0;T<P.length;T++){const N=P[T];if(N.enabled)for(let L=0;L<N.dots.length;L++){const V=(j+N.off+N.dots[L].userData.flowU+1)%1*N.tot;let ae=1;for(;ae<N.lens.length&&N.lens[ae]<V;)ae++;const xe=N.vs[ae-1],ke=N.vs[Math.min(ae,N.vs.length-1)],at=(V-N.lens[ae-1])/Math.max(N.lens[ae]-N.lens[ae-1],.001);N.dots[L].position.lerpVectors(xe,ke,Math.min(at,1))}}X(),c.render(f,d)}function He(){const D=i.clientWidth,z=i.clientHeight;!D||!z||(c.setSize(D,z,!1),d.aspect=D/z,d.updateProjectionMatrix(),s.setAttribute("width",D),s.setAttribute("height",z),s.setAttribute("viewBox","0 0 "+D+" "+z),o.setAttribute("width",D),o.setAttribute("height",z),o.setAttribute("viewBox","0 0 "+D+" "+z),Q=!0,w())}const Ve=new ResizeObserver(He);return Ve.observe(i),He(),x(),tt(),Ce(0),window.__AIDC={ctx:pt,scene:f,useAppStore:xt,applyVisibility:tt},()=>{cancelAnimationFrame(_e),Ve.disconnect(),Ae(),window.removeEventListener("mousemove",C),window.removeEventListener("mouseup",S),c.dispose(),a.innerHTML="",s.innerHTML="",o.innerHTML=""}},[]),be.jsxs("div",{ref:t,className:"viewport3d",children:[be.jsx("canvas",{className:"gl"}),be.jsx("svg",{className:"leaders"}),be.jsx("div",{className:"labels"}),be.jsx("svg",{className:"selected-leader","aria-hidden":"true"}),be.jsx("div",{className:"tip3d",role:"tooltip",style:{display:"none"}}),be.jsx("nav",{className:"floor-nav","aria-label":"층 선택",children:Object.entries(yy).map(([i,r])=>be.jsx("button",{className:`floor-chip${e===i?" on":""}`,onClick:()=>n(i),children:r},i))}),be.jsx("div",{className:"scene-copyright",children:"© 2026 SUNJIN Engineering & Architecture. All rights reserved."})]})}function XT(){return be.jsxs("div",{className:"app-shell",children:[be.jsx(dy,{}),be.jsxs("div",{className:"wrap",children:[be.jsx(Sy,{}),be.jsxs("main",{className:"stage",children:[be.jsx(xy,{}),be.jsx(WT,{})]})]})]})}Ou.createRoot(document.getElementById("root")).render(be.jsx(Lo.StrictMode,{children:be.jsx(XT,{})}));
