...
`)+`
`+u);const x=_+m+o,M=_+u+a,P=Rm(r,r.VERTEX_SHADER,x),R=Rm(r,r.FRAGMENT_SHADER,M);r.attachShader(g,P),r.attachShader(g,R),n.index0AttributeName!==void 0?r.bindAttribLocation(g,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(g,0,"position"),r.linkProgram(g);function A(w){if(t.debug.checkShaderErrors){const W=r.getProgramInfoLog(g).trim(),Y=r.getShaderInfoLog(P).trim(),J=r.getShaderInfoLog(R).trim();let ae=!0,Z=!0;if(r.getProgramParameter(g,r.LINK_STATUS)===!1)if(ae=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,g,P,R);else{const ue=Pm(r,P,"vertex"),U=Pm(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(g,r.VALIDATE_STATUS)+`
