...
`)+`
`+u);const v=g+m+o,M=g+u+a,P=wm(r,r.VERTEX_SHADER,v),R=wm(r,r.FRAGMENT_SHADER,M);r.attachShader(x,P),r.attachShader(x,R),n.index0AttributeName!==void 0?r.bindAttribLocation(x,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function T(w){if(t.debug.checkShaderErrors){const W=r.getProgramInfoLog(x).trim(),Y=r.getShaderInfoLog(P).trim(),ee=r.getShaderInfoLog(R).trim();let ae=!0,K=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(ae=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,x,P,R);else{const ce=Tm(r,P,"vertex"),I=Tm(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
